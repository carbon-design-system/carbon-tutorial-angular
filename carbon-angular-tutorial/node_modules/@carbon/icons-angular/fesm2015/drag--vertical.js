...
let DragVerticalComponent = class DragVerticalComponent {
    constructor() {
...
DragVerticalComponent = __decorate([
    Component({
...
let DragVerticalDirective = DragVerticalDirective_1 = class DragVerticalDirective {
...
DragVerticalDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
DragVerticalDirective = DragVerticalDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconDragVertical]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], DragVerticalDirective);
let DragVerticalModule = class DragVerticalModule {
};
DragVerticalModule = __decorate([
    NgModule({
        declarations: [
            DragVerticalComponent,
            DragVerticalDirective,
