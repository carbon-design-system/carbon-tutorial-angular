...
let JoinLeftComponent = class JoinLeftComponent {
    constructor() {
...
let JoinLeftDirective = JoinLeftDirective_1 = class JoinLeftDirective {
...
JoinLeftDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
JoinLeftDirective = JoinLeftDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconJoinLeft]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], JoinLeftDirective);
let JoinLeftModule = class JoinLeftModule {
};
JoinLeftModule = __decorate([
    NgModule({
        declarations: [
            JoinLeftComponent,
            JoinLeftDirective,
