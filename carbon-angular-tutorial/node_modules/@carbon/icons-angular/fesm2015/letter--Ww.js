...
let LetterWwComponent = class LetterWwComponent {
    constructor() {
...
let LetterWwDirective = LetterWwDirective_1 = class LetterWwDirective {
...
LetterWwDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
LetterWwDirective = LetterWwDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconLetterWw]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], LetterWwDirective);
let LetterWwModule = class LetterWwModule {
};
LetterWwModule = __decorate([
    NgModule({
        declarations: [
            LetterWwComponent,
            LetterWwDirective,
