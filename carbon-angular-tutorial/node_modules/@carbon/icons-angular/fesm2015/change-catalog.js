...
let ChangeCatalogComponent = class ChangeCatalogComponent {
    constructor() {
...
ChangeCatalogComponent = __decorate([
    Component({
...
let ChangeCatalogDirective = ChangeCatalogDirective_1 = class ChangeCatalogDirective {
...
ChangeCatalogDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
ChangeCatalogDirective = ChangeCatalogDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconChangeCatalog]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], ChangeCatalogDirective);
let ChangeCatalogModule = class ChangeCatalogModule {
};
ChangeCatalogModule = __decorate([
    NgModule({
        declarations: [
            ChangeCatalogComponent,
            ChangeCatalogDirective,
