...
var DirectionCurveComponent = /** @class */ (function () {
    function DirectionCurveComponent() {
    ...
    return DirectionCurveComponent;
}());
var DirectionCurveDirective = /** @class */ (function () {
    function DirectionCurveDirective(elementRef) {
    ...
    DirectionCurveDirective_1 = DirectionCurveDirective;
    DirectionCurveDirective.prototype.ngAfterViewInit = function () {
    ...
    DirectionCurveDirective.ctorParameters = function () { return [
        { type: ElementRef }
    ]; };
    __decorate([
        Input(),
    ...
    return DirectionCurveDirective;
}());
var DirectionCurveModule = /** @class */ (function () {
    function DirectionCurveModule() {
    }
    ...
    return DirectionCurveModule;
}());

export { DirectionCurveComponent, DirectionCurveDirective, DirectionCurveModule };
