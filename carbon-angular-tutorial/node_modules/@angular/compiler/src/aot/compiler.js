...
(function (factory) {
    ...
    var AotCompiler = /** @class */ (function () {
        ...
        AotCompiler.prototype.findGeneratedFileNames = function (fileName) {
            ...
            file.directives.forEach(function (dirSymbol) {
                ...
                compMeta.template.styleUrls.forEach(function (styleUrl) {
                    ...
                    if (!normalizedUrl) {
                        throw parse_util_1.syntaxError("Couldn't resolve resource " + styleUrl + " relative to " + file.fileName);
                    }
        ...
        AotCompiler.prototype._compileImplFile = function (srcFileUrl, ngModuleByPipeOrDirective, directives, pipes, ngModules, injectables) {
            ...
            directives.forEach(function (dirType) {
                ...
                if (!ngModule) {
                    throw new Error("Internal Error: cannot determine the module for component " + parse_util_1.identifierName(compMeta.type) + "!");
                }
                // compile styles
    ...
    function validateAnalyzedModules(analyzedModules) {
        if (analyzedModules.symbolsMissingModule && analyzedModules.symbolsMissingModule.length) {
            ...
            throw parse_util_1.syntaxError(messages.join('\n'));
        }
