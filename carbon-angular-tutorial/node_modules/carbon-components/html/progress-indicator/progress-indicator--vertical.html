...
<ul data-progress data-progress-current class="bx--progress bx--progress--vertical">
    ...
    <li class="bx--progress-step bx--progress-step--current "  >
      ...
      <p tabindex="0" class="bx--progress-label" aria-describedby="label-tooltipxf7q8ofn957">
            Second Step
      </p>
      <div id="label-tooltipxf7q8ofn957" role="tooltip" data-floating-menu-direction="bottom" class="bx--tooltip" data-avoid-focus-on-open>
        <span class="bx--tooltip__caret"></span>
    ...
    <li class="bx--progress-step bx--progress-step--incomplete "  >
      ...
      <p tabindex="0" class="bx--progress-label" aria-describedby="label-tooltipz9kdd4vj81j">
            Third Step
      </p>
      <div id="label-tooltipz9kdd4vj81j" role="tooltip" data-floating-menu-direction="bottom" class="bx--tooltip" data-avoid-focus-on-open>
        <span class="bx--tooltip__caret"></span>
