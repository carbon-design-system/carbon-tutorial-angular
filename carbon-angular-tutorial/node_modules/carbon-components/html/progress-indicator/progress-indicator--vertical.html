...
<ul data-progress data-progress-current class="bx--progress bx--progress--vertical">
    ...
    <li class="bx--progress-step bx--progress-step--current "  >
      ...
      <p tabindex="0" class="bx--progress-label" aria-describedby="label-tooltipwfv66nxt7">
            Second Step
      </p>
      <div id="label-tooltipwfv66nxt7" role="tooltip" data-floating-menu-direction="bottom" class="bx--tooltip" data-avoid-focus-on-open>
        <span class="bx--tooltip__caret"></span>
    ...
    <li class="bx--progress-step bx--progress-step--incomplete "  >
      ...
      <p tabindex="0" class="bx--progress-label" aria-describedby="label-tooltipcskf68k0jyh">
            Third Step
      </p>
      <div id="label-tooltipcskf68k0jyh" role="tooltip" data-floating-menu-direction="bottom" class="bx--tooltip" data-avoid-focus-on-open>
        <span class="bx--tooltip__caret"></span>
