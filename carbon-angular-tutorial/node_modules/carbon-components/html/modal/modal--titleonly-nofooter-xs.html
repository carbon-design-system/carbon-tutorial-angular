...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-umo2mxsodo">Show
  modal</button>

<div data-modal id="modal-umo2mxsodo" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-umo2mxsodo-label" aria-describedby="modal-umo2mxsodo-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-umo2mxsodo-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-umo2mxsodo-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
