...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-16hum3a9oan">Show
  modal</button>

<div data-modal id="modal-16hum3a9oan" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-16hum3a9oan-label" aria-describedby="modal-16hum3a9oan-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-16hum3a9oan-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-16hum3a9oan-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
