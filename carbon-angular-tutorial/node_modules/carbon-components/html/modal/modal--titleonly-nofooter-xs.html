...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-x3i6hsmit9n">Show
  modal</button>

<div data-modal id="modal-x3i6hsmit9n" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-x3i6hsmit9n-label" aria-describedby="modal-x3i6hsmit9n-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-x3i6hsmit9n-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-x3i6hsmit9n-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
