...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-lqh41r7zyis">Show
  modal</button>

<div data-modal id="modal-lqh41r7zyis" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-lqh41r7zyis-label" aria-describedby="modal-lqh41r7zyis-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-lqh41r7zyis-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-lqh41r7zyis-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
