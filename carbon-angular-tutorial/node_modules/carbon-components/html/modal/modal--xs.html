...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-26ahibhbhw">Show
  modal</button>

<div data-modal id="modal-26ahibhbhw" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-26ahibhbhw-label" aria-describedby="modal-26ahibhbhw-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-26ahibhbhw-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-26ahibhbhw-heading">Modal heading</p>
