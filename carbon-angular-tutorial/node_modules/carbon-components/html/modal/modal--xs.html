...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-62onuo6r6pq">Show
  modal</button>

<div data-modal id="modal-62onuo6r6pq" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-62onuo6r6pq-label" aria-describedby="modal-62onuo6r6pq-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-62onuo6r6pq-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-62onuo6r6pq-heading">Modal heading</p>
