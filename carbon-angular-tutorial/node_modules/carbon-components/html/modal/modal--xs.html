...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ji01sbft7va">Show
  modal</button>

<div data-modal id="modal-ji01sbft7va" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ji01sbft7va-label" aria-describedby="modal-ji01sbft7va-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ji01sbft7va-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ji01sbft7va-heading">Modal heading</p>
