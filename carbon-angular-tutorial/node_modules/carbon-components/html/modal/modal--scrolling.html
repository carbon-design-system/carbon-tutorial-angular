...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-1m15b987b5">Show
  modal</button>

<div data-modal id="modal-1m15b987b5" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-1m15b987b5-label" aria-describedby="modal-1m15b987b5-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-1m15b987b5-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-1m15b987b5-heading">Modal heading</p>
