...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-wdo3ucudv4">Show
  modal</button>

<div data-modal id="modal-wdo3ucudv4" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-wdo3ucudv4-label" aria-describedby="modal-wdo3ucudv4-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-wdo3ucudv4-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-wdo3ucudv4-heading">Modal heading</p>
