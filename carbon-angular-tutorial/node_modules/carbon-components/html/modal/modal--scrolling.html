...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-b9vmp4j5k4k">Show
  modal</button>

<div data-modal id="modal-b9vmp4j5k4k" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-b9vmp4j5k4k-label" aria-describedby="modal-b9vmp4j5k4k-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-b9vmp4j5k4k-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-b9vmp4j5k4k-heading">Modal heading</p>
