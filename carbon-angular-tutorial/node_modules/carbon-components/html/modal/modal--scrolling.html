...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-274llj3d7en">Show
  modal</button>

<div data-modal id="modal-274llj3d7en" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-274llj3d7en-label" aria-describedby="modal-274llj3d7en-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-274llj3d7en-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-274llj3d7en-heading">Modal heading</p>
