...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-b7cu4dqudy4">Show
  modal</button>

<div data-modal id="modal-b7cu4dqudy4" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-b7cu4dqudy4-label" aria-describedby="modal-b7cu4dqudy4-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-b7cu4dqudy4-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-b7cu4dqudy4-heading">Modal heading</p>
