...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-apaumyyowpl">Show
  modal</button>

<div data-modal id="modal-apaumyyowpl" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-apaumyyowpl-label" aria-describedby="modal-apaumyyowpl-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-apaumyyowpl-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-apaumyyowpl-heading">Modal heading</p>
