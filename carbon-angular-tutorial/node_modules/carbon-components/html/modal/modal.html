...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-4zr58oswryn">Show
  modal</button>

<div data-modal id="modal-4zr58oswryn" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-4zr58oswryn-label" aria-describedby="modal-4zr58oswryn-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-4zr58oswryn-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-4zr58oswryn-heading">Modal heading</p>
