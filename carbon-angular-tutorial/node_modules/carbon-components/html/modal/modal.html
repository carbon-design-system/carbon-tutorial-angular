...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-cktletxow6">Show
  modal</button>

<div data-modal id="modal-cktletxow6" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-cktletxow6-label" aria-describedby="modal-cktletxow6-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-cktletxow6-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-cktletxow6-heading">Modal heading</p>
