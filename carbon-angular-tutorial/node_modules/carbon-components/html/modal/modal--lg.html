...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-9lp8k3qsult">Show
  modal</button>

<div data-modal id="modal-9lp8k3qsult" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-9lp8k3qsult-label" aria-describedby="modal-9lp8k3qsult-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-9lp8k3qsult-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-9lp8k3qsult-heading">Modal heading</p>
