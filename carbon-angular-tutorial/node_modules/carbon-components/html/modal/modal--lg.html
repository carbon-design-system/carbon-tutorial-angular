...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ap3s08u5vwf">Show
  modal</button>

<div data-modal id="modal-ap3s08u5vwf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ap3s08u5vwf-label" aria-describedby="modal-ap3s08u5vwf-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ap3s08u5vwf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ap3s08u5vwf-heading">Modal heading</p>
