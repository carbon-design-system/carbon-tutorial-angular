...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-qbk06vcs8i">Show
  modal</button>

<div data-modal id="modal-qbk06vcs8i" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-qbk06vcs8i-label" aria-describedby="modal-qbk06vcs8i-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-qbk06vcs8i-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-qbk06vcs8i-heading">Modal heading</p>
