...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-9q8jd5wzvhp">Show
  modal</button>

<div data-modal id="modal-9q8jd5wzvhp" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-9q8jd5wzvhp-label" aria-describedby="modal-9q8jd5wzvhp-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-9q8jd5wzvhp-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-9q8jd5wzvhp-heading">Modal heading</p>
