...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-966fmovu6ce">Show
  modal</button>

<div data-modal id="modal-966fmovu6ce" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-966fmovu6ce-label" aria-describedby="modal-966fmovu6ce-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-966fmovu6ce-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-966fmovu6ce-heading">Modal heading</p>
