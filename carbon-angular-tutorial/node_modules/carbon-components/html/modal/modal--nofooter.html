...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-6zd0c6klikq">Show
  modal</button>

<div data-modal id="modal-6zd0c6klikq" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-6zd0c6klikq-label" aria-describedby="modal-6zd0c6klikq-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-6zd0c6klikq-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-6zd0c6klikq-heading">Modal heading</p>
