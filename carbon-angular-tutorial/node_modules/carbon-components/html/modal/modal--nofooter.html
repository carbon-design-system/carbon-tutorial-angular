...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-j4k2f7e3jgo">Show
  modal</button>

<div data-modal id="modal-j4k2f7e3jgo" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-j4k2f7e3jgo-label" aria-describedby="modal-j4k2f7e3jgo-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-j4k2f7e3jgo-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-j4k2f7e3jgo-heading">Modal heading</p>
