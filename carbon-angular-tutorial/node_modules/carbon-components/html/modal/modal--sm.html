...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-7a4crv50bdr">Show
  modal</button>

<div data-modal id="modal-7a4crv50bdr" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-7a4crv50bdr-label" aria-describedby="modal-7a4crv50bdr-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-7a4crv50bdr-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-7a4crv50bdr-heading">Modal heading</p>
