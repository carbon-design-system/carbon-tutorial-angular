...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-hgbsv3gezuu">Show
  modal</button>

<div data-modal id="modal-hgbsv3gezuu" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-hgbsv3gezuu-label" aria-describedby="modal-hgbsv3gezuu-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-hgbsv3gezuu-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-hgbsv3gezuu-heading">Modal heading</p>
