...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-vn463x7s7r">Show
  modal</button>

<div data-modal id="modal-vn463x7s7r" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-vn463x7s7r-label" aria-describedby="modal-vn463x7s7r-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-vn463x7s7r-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-vn463x7s7r-heading">Modal heading</p>
