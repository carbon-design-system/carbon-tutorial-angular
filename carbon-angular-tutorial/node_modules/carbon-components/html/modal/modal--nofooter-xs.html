...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rfeepzraekk">Show
  modal</button>

<div data-modal id="modal-rfeepzraekk" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rfeepzraekk-label" aria-describedby="modal-rfeepzraekk-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rfeepzraekk-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rfeepzraekk-heading">Modal heading</p>
