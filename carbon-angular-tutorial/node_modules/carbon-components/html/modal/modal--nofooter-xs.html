...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-hzh3g3t0mdp">Show
  modal</button>

<div data-modal id="modal-hzh3g3t0mdp" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-hzh3g3t0mdp-label" aria-describedby="modal-hzh3g3t0mdp-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-hzh3g3t0mdp-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-hzh3g3t0mdp-heading">Modal heading</p>
