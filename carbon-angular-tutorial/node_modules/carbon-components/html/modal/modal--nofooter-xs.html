...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-fhayndzx1wl">Show
  modal</button>

<div data-modal id="modal-fhayndzx1wl" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-fhayndzx1wl-label" aria-describedby="modal-fhayndzx1wl-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-fhayndzx1wl-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-fhayndzx1wl-heading">Modal heading</p>
