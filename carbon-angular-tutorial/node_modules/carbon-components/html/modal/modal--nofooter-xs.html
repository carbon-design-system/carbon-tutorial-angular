...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-kmicfg75uz">Show
  modal</button>

<div data-modal id="modal-kmicfg75uz" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-kmicfg75uz-label" aria-describedby="modal-kmicfg75uz-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-kmicfg75uz-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-kmicfg75uz-heading">Modal heading</p>
