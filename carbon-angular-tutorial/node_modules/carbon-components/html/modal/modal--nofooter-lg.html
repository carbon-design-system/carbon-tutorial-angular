...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-zddax0rmem">Show
  modal</button>

<div data-modal id="modal-zddax0rmem" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-zddax0rmem-label" aria-describedby="modal-zddax0rmem-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-zddax0rmem-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-zddax0rmem-heading">Modal heading</p>
