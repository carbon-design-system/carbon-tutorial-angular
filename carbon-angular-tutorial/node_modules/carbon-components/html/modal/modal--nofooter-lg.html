...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-gif7f7vyprd">Show
  modal</button>

<div data-modal id="modal-gif7f7vyprd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-gif7f7vyprd-label" aria-describedby="modal-gif7f7vyprd-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-gif7f7vyprd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-gif7f7vyprd-heading">Modal heading</p>
