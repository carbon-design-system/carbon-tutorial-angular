...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-athq526mj7f">Show
  modal</button>

<div data-modal id="modal-athq526mj7f" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-athq526mj7f-label" aria-describedby="modal-athq526mj7f-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-athq526mj7f-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-athq526mj7f-heading">Modal heading</p>
