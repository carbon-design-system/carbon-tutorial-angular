...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ssvuidcmf28">Show
  modal</button>

<div data-modal id="modal-ssvuidcmf28" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ssvuidcmf28-label" aria-describedby="modal-ssvuidcmf28-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ssvuidcmf28-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ssvuidcmf28-heading">Modal heading</p>
