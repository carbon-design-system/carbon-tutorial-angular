...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-jxkcmpls82p">Show
  modal</button>

<div data-modal id="modal-jxkcmpls82p" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-jxkcmpls82p-label" aria-describedby="modal-jxkcmpls82p-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jxkcmpls82p-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jxkcmpls82p-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
