...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-a64oefpymku">Show
  modal</button>

<div data-modal id="modal-a64oefpymku" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-a64oefpymku-label" aria-describedby="modal-a64oefpymku-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-a64oefpymku-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-a64oefpymku-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
