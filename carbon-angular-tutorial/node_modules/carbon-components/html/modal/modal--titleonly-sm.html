...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-oqwp681qhnf">Show
  modal</button>

<div data-modal id="modal-oqwp681qhnf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-oqwp681qhnf-label" aria-describedby="modal-oqwp681qhnf-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-oqwp681qhnf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-oqwp681qhnf-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
