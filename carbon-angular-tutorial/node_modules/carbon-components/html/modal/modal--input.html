...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-0z2p7s1txo9">Show
  modal</button>

<div data-modal id="modal-0z2p7s1txo9" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-0z2p7s1txo9-label" aria-describedby="modal-0z2p7s1txo9-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-0z2p7s1txo9-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-0z2p7s1txo9-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-0z2p7s1txo9" class="bx--label">Text Input label</label>
        <input id="text-input-0z2p7s1txo9" type="text" class="bx--text-input" placeholder="Optional placeholder text"
