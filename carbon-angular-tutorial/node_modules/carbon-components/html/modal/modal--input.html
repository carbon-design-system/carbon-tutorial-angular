...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-mfgd2cpyfgs">Show
  modal</button>

<div data-modal id="modal-mfgd2cpyfgs" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-mfgd2cpyfgs-label" aria-describedby="modal-mfgd2cpyfgs-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mfgd2cpyfgs-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mfgd2cpyfgs-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-mfgd2cpyfgs" class="bx--label">Text Input label</label>
        <input id="text-input-mfgd2cpyfgs" type="text" class="bx--text-input" placeholder="Optional placeholder text"
