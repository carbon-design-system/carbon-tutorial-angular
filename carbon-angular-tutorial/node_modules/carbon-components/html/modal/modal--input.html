...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ca4zgtdklvs">Show
  modal</button>

<div data-modal id="modal-ca4zgtdklvs" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ca4zgtdklvs-label" aria-describedby="modal-ca4zgtdklvs-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ca4zgtdklvs-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ca4zgtdklvs-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-ca4zgtdklvs" class="bx--label">Text Input label</label>
        <input id="text-input-ca4zgtdklvs" type="text" class="bx--text-input" placeholder="Optional placeholder text"
