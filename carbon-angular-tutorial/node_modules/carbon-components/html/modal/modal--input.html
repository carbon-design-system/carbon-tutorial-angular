...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-o8hogfvn2rr">Show
  modal</button>

<div data-modal id="modal-o8hogfvn2rr" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-o8hogfvn2rr-label" aria-describedby="modal-o8hogfvn2rr-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-o8hogfvn2rr-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-o8hogfvn2rr-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-o8hogfvn2rr" class="bx--label">Text Input label</label>
        <input id="text-input-o8hogfvn2rr" type="text" class="bx--text-input" placeholder="Optional placeholder text"
