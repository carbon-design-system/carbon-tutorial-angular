...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-kozi669ljh">Show
  modal</button>

<div data-modal id="modal-kozi669ljh" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-kozi669ljh-label" aria-describedby="modal-kozi669ljh-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-kozi669ljh-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-kozi669ljh-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
