...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-b45v13nsvoi">Show
  modal</button>

<div data-modal id="modal-b45v13nsvoi" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-b45v13nsvoi-label" aria-describedby="modal-b45v13nsvoi-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-b45v13nsvoi-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-b45v13nsvoi-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
