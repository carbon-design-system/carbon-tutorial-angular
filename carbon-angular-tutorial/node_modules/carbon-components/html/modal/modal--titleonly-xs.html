...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-gyvsd7w6j4t">Show
  modal</button>

<div data-modal id="modal-gyvsd7w6j4t" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-gyvsd7w6j4t-label" aria-describedby="modal-gyvsd7w6j4t-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-gyvsd7w6j4t-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-gyvsd7w6j4t-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
