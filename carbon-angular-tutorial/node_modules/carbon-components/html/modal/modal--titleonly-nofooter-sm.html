...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ncggq2pwwwc">Show
  modal</button>

<div data-modal id="modal-ncggq2pwwwc" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ncggq2pwwwc-label" aria-describedby="modal-ncggq2pwwwc-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ncggq2pwwwc-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ncggq2pwwwc-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
