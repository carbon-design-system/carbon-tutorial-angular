...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-awpn249hbg">Show
  modal</button>

<div data-modal id="modal-awpn249hbg" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-awpn249hbg-label" aria-describedby="modal-awpn249hbg-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-awpn249hbg-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-awpn249hbg-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
