...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-qfiatpumxz">Show
  modal</button>

<div data-modal id="modal-qfiatpumxz" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-qfiatpumxz-label" aria-describedby="modal-qfiatpumxz-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-qfiatpumxz-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-qfiatpumxz-heading">Modal heading</p>
