...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-cs8o5ssr8y">Show
  modal</button>

<div data-modal id="modal-cs8o5ssr8y" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-cs8o5ssr8y-label" aria-describedby="modal-cs8o5ssr8y-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-cs8o5ssr8y-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-cs8o5ssr8y-heading">Modal heading</p>
