...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-5n9c0480sqy">Show
  modal</button>

<div data-modal id="modal-5n9c0480sqy" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-5n9c0480sqy-label" aria-describedby="modal-5n9c0480sqy-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-5n9c0480sqy-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-5n9c0480sqy-heading">Modal heading</p>
