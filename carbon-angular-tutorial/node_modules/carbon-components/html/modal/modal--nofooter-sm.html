...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-knbz7972we">Show
  modal</button>

<div data-modal id="modal-knbz7972we" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-knbz7972we-label" aria-describedby="modal-knbz7972we-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-knbz7972we-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-knbz7972we-heading">Modal heading</p>
