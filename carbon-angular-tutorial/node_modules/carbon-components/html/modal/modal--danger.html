...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-djeeodce4">Show
  modal</button>

<div data-modal id="modal-djeeodce4" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-djeeodce4-label" aria-describedby="modal-djeeodce4-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-djeeodce4-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-djeeodce4-heading">Modal heading</p>
