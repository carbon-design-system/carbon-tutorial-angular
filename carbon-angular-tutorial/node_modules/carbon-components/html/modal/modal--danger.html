...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-jjy60kh9hch">Show
  modal</button>

<div data-modal id="modal-jjy60kh9hch" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-jjy60kh9hch-label" aria-describedby="modal-jjy60kh9hch-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jjy60kh9hch-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jjy60kh9hch-heading">Modal heading</p>
