...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-8izvoed9ebf">Show
  modal</button>

<div data-modal id="modal-8izvoed9ebf" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-8izvoed9ebf-label" aria-describedby="modal-8izvoed9ebf-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-8izvoed9ebf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-8izvoed9ebf-heading">Modal heading</p>
