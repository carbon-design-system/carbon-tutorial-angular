/**
 *
 * carbon-angular v0.0.0 | carbon-components-angular-button.umd.js
 *
...
(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('carbon-components-angular/button', ['exports', '@angular/core', '@angular/common'], factory) :
    (factory((global['carbon-components-angular'] = global['carbon-components-angular'] || {}, global['carbon-components-angular'].button = {}),global.ng.core,global.ng.common));
    ...
    var Button = /** @class */ (function () {
        ...
        Button.propDecorators = {
            ibmButton: [{ type: core.Input }],
            size: [{ type: core.Input }],
            assistiveTextPlacement: [{ type: core.Input }],
            assistiveTextAlignment: [{ type: core.Input }],
            skeleton: [{ type: core.HostBinding, args: ["class.bx--skeleton",] }, { type: core.Input }],
            iconOnly: [{ type: core.HostBinding, args: ["class.bx--btn--icon-only",] }, { type: core.Input }],
            isExpressive: [{ type: core.HostBinding, args: ["class.bx--btn--expressive",] }, { type: core.Input }],
            baseClass: [{ type: core.HostBinding, args: ["class.bx--btn",] }],
            primaryButton: [{ type: core.HostBinding, args: ["class.bx--btn--primary",] }],
            secondaryButton: [{ type: core.HostBinding, args: ["class.bx--btn--secondary",] }],
            tertiaryButton: [{ type: core.HostBinding, args: ["class.bx--btn--tertiary",] }],
            ghostButton: [{ type: core.HostBinding, args: ["class.bx--btn--ghost",] }],
            dangerButton: [{ type: core.HostBinding, args: ["class.bx--btn--danger",] }],
            dangerTertiary: [{ type: core.HostBinding, args: ["class.bx--btn--danger--tertiary",] }],
            dangerGhost: [{ type: core.HostBinding, args: ["class.bx--btn--danger--ghost",] }],
            smallSize: [{ type: core.HostBinding, args: ["class.bx--btn--sm",] }],
            largeSize: [{ type: core.HostBinding, args: ["class.bx--btn--lg",] }],
            extraLargeSize: [{ type: core.HostBinding, args: ["class.bx--btn--xl",] }],
            fieldSize: [{ type: core.HostBinding, args: ["class.bx--btn--field",] }],
            toolbarAction: [{ type: core.HostBinding, args: ["class.bx--toolbar-action",] }],
            overflowMenu: [{ type: core.HostBinding, args: ["class.bx--overflow-menu",] }],
            hasAssistiveText: [{ type: core.HostBinding, args: ["class.bx--tooltip__trigger",] }, { type: core.HostBinding, args: ["class.bx--tooltip--a11y",] }, { type: core.Input }],
            isAssistiveTextCenterAligned: [{ type: core.HostBinding, args: ["class.bx--tooltip--align-center",] }],
            isAssistiveTextStartAligned: [{ type: core.HostBinding, args: ["class.bx--tooltip--align-start",] }],
            isAssistiveTextEndAligned: [{ type: core.HostBinding, args: ["class.bx--tooltip--align-end",] }],
            isAssistiveTextTopPositioned: [{ type: core.HostBinding, args: ["class.bx--tooltip--top",] }],
            isAssistiveTextBottomPositioned: [{ type: core.HostBinding, args: ["class.bx--tooltip--bottom",] }],
            isAssistiveTextLeftPositioned: [{ type: core.HostBinding, args: ["class.bx--tooltip--left",] }],
            isAssistiveTextRightPositioned: [{ type: core.HostBinding, args: ["class.bx--tooltip--right",] }]
        };
        return Button;
    }());
    ...
    var ButtonSet = /** @class */ (function () {
        ...
        ButtonSet.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-button-set",
                        template: "<ng-content></ng-content>"
                    }] }
        ];
        ButtonSet.propDecorators = {
            buttonSetClass: [{ type: core.HostBinding, args: ["class.bx--btn-set",] }]
        };
        return ButtonSet;
    }());
...
//# sourceMappingURL=carbon-components-angular-button.umd.js.map