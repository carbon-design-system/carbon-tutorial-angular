...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/platform-browser'), require('@angular/router'), require('@angular/core'), require('@angular/common'), require('carbon-components-angular/dialog')) :
    typeof define === 'function' && define.amd ? define('carbon-components-angular/breadcrumb', ['exports', '@angular/platform-browser', '@angular/router', '@angular/core', '@angular/common', 'carbon-components-angular/dialog'], factory) :
    (factory((global['carbon-components-angular'] = global['carbon-components-angular'] || {}, global['carbon-components-angular'].breadcrumb = {}),global.ng.platformBrowser,global.ng.router,global.ng.core,global.ng.common,global['carbon-components-angular'].dialog));
}(this, (function (exports,platformBrowser,router,core,common,dialog) { 'use strict';
    ...
    var Breadcrumb = /** @class */ (function () {
        function Breadcrumb(domSanitizer, router$$1) {
            this.domSanitizer = domSanitizer;
            this.router = router$$1;
