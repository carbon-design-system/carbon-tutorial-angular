...
function NumberComponent_label_2_ng_container_1_Template(rf, ctx) { if (rf & 1) {
...
function NumberComponent_label_2_2_Template(rf, ctx) { if (rf & 1) {
...
function NumberComponent_label_2_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementStart(0, "label", 11);
    ɵngcc0.ɵɵtemplate(1, NumberComponent_label_2_ng_container_1_Template, 2, 1, "ng-container", 12);
    ɵngcc0.ɵɵtemplate(2, NumberComponent_label_2_2_Template, 1, 1, undefined, 12);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function NumberComponent_div_7_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function NumberComponent_div_7_Template_button_click_1_listener() { ɵngcc0.ɵɵrestoreView(_r12); const ctx_r11 = ɵngcc0.ɵɵnextContext(); return ctx_r11.onDecrement(); });
    ...
    ɵngcc0.ɵɵlistener("click", function NumberComponent_div_7_Template_button_click_5_listener() { ɵngcc0.ɵɵrestoreView(_r12); const ctx_r13 = ɵngcc0.ɵɵnextContext(); return ctx_r13.onIncrement(); });
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("aria-label", ɵngcc0.ɵɵpipeBind1(2, 2, ctx_r4.getDecrementLabel()));
    ɵngcc0.ɵɵadvance(4);
    ɵngcc0.ɵɵattribute("aria-label", ɵngcc0.ɵɵpipeBind1(6, 4, ctx_r4.getIncrementLabel()));
} }
...
NumberComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: NumberComponent, selectors: [["ibm-number"]], hostVars: 2, hostBindings: function NumberComponent_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { theme: "theme", disabled: "disabled", skeleton: "skeleton", invalid: "invalid", id: "id", size: "size", min: "min", max: "max", step: "step", warn: "warn", value: "value", decrementLabel: "decrementLabel", incrementLabel: "incrementLabel", required: "required", label: "label", helperText: "helperText", invalidText: "invalidText", precision: "precision", warnText: "warnText", ariaLabel: "ariaLabel" }, outputs: { change: "change" }, features: [ɵngcc0.ɵɵProvidersFeature([
            {
                provide: NG_VALUE_ACCESSOR,
                useExisting: NumberComponent,
                multi: true
            }
        ])], decls: 11, vars: 28, consts: [["data-numberinput", "", 1, "bx--number", 3, "ngClass"], ["class", "bx--label bx--skeleton", 4, "ngIf"], ["class", "bx--label", 3, "for", 4, "ngIf"], [1, "bx--number__input-wrapper", 3, "ngClass"], ["type", "number", 3, "id", "value", "disabled", "required", "input"], ["ibmIcon", "warning--filled", "size", "16", "class", "bx--number__invalid", 4, "ngIf"], ["ibmIcon", "warning--alt--filled", "size", "16", "class", "bx--number__invalid bx--number__invalid--warning", 4, "ngIf"], ["class", "bx--number__controls", 4, "ngIf"], ["class", "bx--form__helper-text", 4, "ngIf"], ["class", "bx--form-requirement", 4, "ngIf"], [1, "bx--label", "bx--skeleton"], [1, "bx--label", 3, "for"], [4, "ngIf"], [3, "ngTemplateOutlet"], ["ibmIcon", "warning--filled", "size", "16", 1, "bx--number__invalid"], ["ibmIcon", "warning--alt--filled", "size", "16", 1, "bx--number__invalid", "bx--number__invalid--warning"], [1, "bx--number__controls"], ["type", "button", "aria-live", "polite", "aria-atomic", "true", 1, "bx--number__control-btn", "down-icon", 3, "click"], ["ibmIcon", "subtract", "size", "16"], [1, "bx--number__rule-divider"], ["type", "button", "aria-live", "polite", "aria-atomic", "true", 1, "bx--number__control-btn", "up-icon", 3, "click"], ["ibmIcon", "add", "size", "16"], [1, "bx--form__helper-text"], [1, "bx--form-requirement"]], template: function NumberComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵtemplate(7, NumberComponent_div_7_Template, 9, 6, "div", 7);
        ɵngcc0.ɵɵelementEnd();
        ...
        ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction6(19, _c0, ctx.theme === "light", !ctx.label, ctx.helperText, ctx.skeleton, ctx.size === "sm", ctx.size === "xl"));
        ...
        ɵngcc0.ɵɵproperty("ngIf", !ctx.skeleton && ctx.label);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(26, _c1, ctx.warn));
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("id", ctx.id)("value", ctx.value)("disabled", ctx.disabled)("required", ctx.required);
        ɵngcc0.ɵɵattribute("min", ctx.min)("max", ctx.max)("step", ctx.step)("aria-label", ctx.ariaLabel);
        ɵngcc0.ɵɵadvance(1);
    ...
    } }, directives: [ɵngcc2.NgClass, ɵngcc2.NgIf, ɵngcc2.NgTemplateOutlet, ɵngcc3.IconDirective], pipes: [ɵngcc2.AsyncPipe], encapsulation: 2 });
/**
...
NumberModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: NumberModule });
NumberModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[
            FormsModule,
            CommonModule,
            I18nModule,
            IconModule
