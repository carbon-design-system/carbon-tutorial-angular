(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('path'), require('pretty-bytes'), require('parse5'), require('css-select'), require('parse5-htmlparser2-tree-adapter'), require('postcss'), require('chalk')) :
  typeof define === 'function' && define.amd ? define(['path', 'pretty-bytes', 'parse5', 'css-select', 'parse5-htmlparser2-tree-adapter', 'postcss', 'chalk'], factory) :
  (global = global || self, global.critters = factory(global.path, global.prettyBytes, global.parse5, global.cssSelect, global.parse5Htmlparser2TreeAdapter, global.postcss, global.chalk));
}(this, (function (path, prettyBytes, parse5, select, treeAdapter, postcss, chalk) {
  ...
  treeAdapter = treeAdapter && Object.prototype.hasOwnProperty.call(treeAdapter, 'default') ? treeAdapter['default'] : treeAdapter;
  ...
  function hasNestedRules(rule) {
    return rule.nodes && rule.nodes.length && rule.nodes.every(n => n.type === 'rule') && rule.name !== 'keyframes';
