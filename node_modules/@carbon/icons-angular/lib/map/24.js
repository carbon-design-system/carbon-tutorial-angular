...
var Map24 = /** @class */ (function () {
    function Map24() {
        this.focusable = false;
    }
    Map24.decorators = [
        { type: Component, args: [{
                    selector: "ibm-icon-map24",
                    template: "\n    <svg\n      ibmIconMap24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                },] },
    ];
    Map24.propDecorators = {
...
export { Map24 };
var Map24Directive = /** @class */ (function () {
    function Map24Directive(elementRef) {
        this.elementRef = elementRef;
        this.isFocusable = false;
    }
    Map24Directive.prototype.ngAfterViewInit = function () {
        ...
        if (attributes.title) {
            ...
            Map24Directive.titleIdCounter++;
            title.setAttribute("id", "map24-" + Map24Directive.titleIdCounter);
            svg.appendChild(title);
            svg.setAttribute("aria-labelledby", "map24-" + Map24Directive.titleIdCounter);
        }
    };
    Map24Directive.titleIdCounter = 0;
    Map24Directive.decorators = [
        { type: Directive, args: [{
                    selector: "[ibmIconMap24]"
                },] },
    ];
    /** @nocollapse */
    Map24Directive.ctorParameters = function () { return [
        { type: ElementRef }
    ]; };
    Map24Directive.propDecorators = {
        ariaLabel: [{ type: Input }],
        ariaLabelledby: [{ type: Input }],
        ariaHidden: [{ type: Input }],
        title: [{ type: Input }],
    ...
    return Map24Directive;
}());
export { Map24Directive };
var Map24Module = /** @class */ (function () {
    function Map24Module() {
    }
    Map24Module.decorators = [
        { type: NgModule, args: [{
                    declarations: [
                        Map24,
                        Map24Directive
