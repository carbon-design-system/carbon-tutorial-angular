...
var Watson24 = /** @class */ (function () {
    function Watson24() {
        this.focusable = false;
    }
    Watson24.decorators = [
        { type: Component, args: [{
                    selector: "ibm-icon-watson24",
                    template: "\n    <svg\n      ibmIconWatson24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                },] },
    ];
    Watson24.propDecorators = {
...
var Watson24Directive = /** @class */ (function () {
    ...
    Watson24Directive.prototype.ngAfterViewInit = function () {
        ...
        if (attributes.title) {
            ...
            Watson24Directive.titleIdCounter++;
            title.setAttribute("id", "watson24-" + Watson24Directive.titleIdCounter);
            svg.appendChild(title);
            svg.setAttribute("aria-labelledby", "watson24-" + Watson24Directive.titleIdCounter);
        }
    };
    Watson24Directive.titleIdCounter = 0;
    Watson24Directive.decorators = [
        { type: Directive, args: [{
                    selector: "[ibmIconWatson24]"
                },] },
    ];
    /** @nocollapse */
    Watson24Directive.ctorParameters = function () { return [
        { type: ElementRef }
    ]; };
    Watson24Directive.propDecorators = {
        ariaLabel: [{ type: Input }],
        ariaLabelledby: [{ type: Input }],
        ariaHidden: [{ type: Input }],
        title: [{ type: Input }],
    ...
    return Watson24Directive;
}());
export { Watson24Directive };
var Watson24Module = /** @class */ (function () {
    function Watson24Module() {
    }
    Watson24Module.decorators = [
        { type: NgModule, args: [{
                    declarations: [
                        Watson24,
                        Watson24Directive
    ...
    return Watson24Module;
}());
export { Watson24Module };
