...
var Tree24 = /** @class */ (function () {
    function Tree24() {
        this.focusable = false;
    }
    Tree24.decorators = [
        { type: Component, args: [{
                    selector: "ibm-icon-tree24",
                    template: "\n    <svg\n      ibmIconTree24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                },] },
    ];
    Tree24.propDecorators = {
...
export { Tree24 };
var Tree24Directive = /** @class */ (function () {
    function Tree24Directive(elementRef) {
        this.elementRef = elementRef;
        this.isFocusable = false;
    }
    Tree24Directive.prototype.ngAfterViewInit = function () {
        ...
        if (attributes.title) {
            ...
            Tree24Directive.titleIdCounter++;
            title.setAttribute("id", "tree24-" + Tree24Directive.titleIdCounter);
            svg.appendChild(title);
            svg.setAttribute("aria-labelledby", "tree24-" + Tree24Directive.titleIdCounter);
        }
    };
    Tree24Directive.titleIdCounter = 0;
    Tree24Directive.decorators = [
        { type: Directive, args: [{
                    selector: "[ibmIconTree24]"
                },] },
    ];
    /** @nocollapse */
    Tree24Directive.ctorParameters = function () { return [
        { type: ElementRef }
    ]; };
    Tree24Directive.propDecorators = {
        ariaLabel: [{ type: Input }],
        ariaLabelledby: [{ type: Input }],
        ariaHidden: [{ type: Input }],
        title: [{ type: Input }],
    ...
    return Tree24Directive;
}());
export { Tree24Directive };
var Tree24Module = /** @class */ (function () {
    function Tree24Module() {
    }
    Tree24Module.decorators = [
        { type: NgModule, args: [{
                    declarations: [
                        Tree24,
                        Tree24Directive
