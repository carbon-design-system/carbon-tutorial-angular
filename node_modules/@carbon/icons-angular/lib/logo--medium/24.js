...
var LogoMedium24 = /** @class */ (function () {
    function LogoMedium24() {
        this.focusable = false;
    }
    LogoMedium24.decorators = [
        { type: Component, args: [{
                    selector: "ibm-icon-logo-medium24",
                    template: "\n    <svg\n      ibmIconLogoMedium24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                },] },
    ];
    LogoMedium24.propDecorators = {
...
export { LogoMedium24 };
var LogoMedium24Directive = /** @class */ (function () {
    function LogoMedium24Directive(elementRef) {
        this.elementRef = elementRef;
        this.isFocusable = false;
    }
    LogoMedium24Directive.prototype.ngAfterViewInit = function () {
        ...
        if (attributes.title) {
            ...
            LogoMedium24Directive.titleIdCounter++;
            title.setAttribute("id", "logo-medium24-" + LogoMedium24Directive.titleIdCounter);
            svg.appendChild(title);
            svg.setAttribute("aria-labelledby", "logo-medium24-" + LogoMedium24Directive.titleIdCounter);
        }
    };
    LogoMedium24Directive.titleIdCounter = 0;
    LogoMedium24Directive.decorators = [
        { type: Directive, args: [{
                    selector: "[ibmIconLogoMedium24]"
                },] },
    ];
    /** @nocollapse */
    LogoMedium24Directive.ctorParameters = function () { return [
        { type: ElementRef }
    ]; };
    LogoMedium24Directive.propDecorators = {
        ariaLabel: [{ type: Input }],
        ariaLabelledby: [{ type: Input }],
        ariaHidden: [{ type: Input }],
        title: [{ type: Input }],
    ...
    return LogoMedium24Directive;
}());
export { LogoMedium24Directive };
var LogoMedium24Module = /** @class */ (function () {
    function LogoMedium24Module() {
    }
    LogoMedium24Module.decorators = [
        { type: NgModule, args: [{
                    declarations: [
                        LogoMedium24,
                        LogoMedium24Directive
                    ],
                    exports: [
                        LogoMedium24,
                        LogoMedium24Directive
    ...
    return LogoMedium24Module;
}());
export { LogoMedium24Module };
