...
var MeterComponent = /** @class */ (function () {
...
var MeterDirective = /** @class */ (function () {
    function MeterDirective(elementRef) {
    ...
    MeterDirective_1 = MeterDirective;
    MeterDirective.prototype.ngAfterViewInit = function () {
    ...
    MeterDirective.ctorParameters = function () { return [
        { type: ElementRef }
    ]; };
    __decorate([
        Input(),
    ...
    return MeterDirective;
}());
var MeterModule = /** @class */ (function () {
...
export { MeterComponent, MeterDirective, MeterModule };
