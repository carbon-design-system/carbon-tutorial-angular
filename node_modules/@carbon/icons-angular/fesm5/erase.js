...
var EraseComponent = /** @class */ (function () {
...
var EraseDirective = /** @class */ (function () {
    function EraseDirective(elementRef) {
    ...
    EraseDirective_1 = EraseDirective;
    EraseDirective.prototype.ngAfterViewInit = function () {
    ...
    EraseDirective.ctorParameters = function () { return [
        { type: ElementRef }
    ]; };
    __decorate([
        Input(),
    ...
    return EraseDirective;
}());
var EraseModule = /** @class */ (function () {
