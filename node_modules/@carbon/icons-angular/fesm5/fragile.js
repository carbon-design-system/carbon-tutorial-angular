...
var FragileComponent = /** @class */ (function () {
    function FragileComponent() {
...
var FragileDirective = /** @class */ (function () {
    function FragileDirective(elementRef) {
    ...
    FragileDirective_1 = FragileDirective;
    FragileDirective.prototype.ngAfterViewInit = function () {
    ...
    FragileDirective.ctorParameters = function () { return [
        { type: ElementRef }
    ]; };
    __decorate([
        Input(),
    ...
    return FragileDirective;
}());
var FragileModule = /** @class */ (function () {
    function FragileModule() {
    }
    ...
    return FragileModule;
}());

export { FragileComponent, FragileDirective, FragileModule };
