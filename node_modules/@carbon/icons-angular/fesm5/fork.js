...
var ForkDirective = /** @class */ (function () {
    function ForkDirective(elementRef) {
    ...
    ForkDirective_1 = ForkDirective;
    ForkDirective.prototype.ngAfterViewInit = function () {
    ...
    ForkDirective.ctorParameters = function () { return [
        { type: ElementRef }
    ]; };
    __decorate([
        Input(),
...
export { ForkComponent, ForkDirective, ForkModule };
