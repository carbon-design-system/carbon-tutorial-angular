...
var BatteryQuarterComponent = /** @class */ (function () {
    function BatteryQuarterComponent() {
    ...
    return BatteryQuarterComponent;
}());
var BatteryQuarterDirective = /** @class */ (function () {
    function BatteryQuarterDirective(elementRef) {
    ...
    BatteryQuarterDirective_1 = BatteryQuarterDirective;
    BatteryQuarterDirective.prototype.ngAfterViewInit = function () {
    ...
    BatteryQuarterDirective.ctorParameters = function () { return [
        { type: ElementRef }
    ]; };
    __decorate([
        Input(),
    ...
    return BatteryQuarterDirective;
}());
var BatteryQuarterModule = /** @class */ (function () {
    function BatteryQuarterModule() {
    }
    ...
    return BatteryQuarterModule;
}());

export { BatteryQuarterComponent, BatteryQuarterDirective, BatteryQuarterModule };
