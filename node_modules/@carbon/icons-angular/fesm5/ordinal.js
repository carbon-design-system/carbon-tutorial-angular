...
var OrdinalComponent = /** @class */ (function () {
    ...
    return OrdinalComponent;
}());
var OrdinalDirective = /** @class */ (function () {
    function OrdinalDirective(elementRef) {
    ...
    OrdinalDirective_1 = OrdinalDirective;
    OrdinalDirective.prototype.ngAfterViewInit = function () {
    ...
    OrdinalDirective.ctorParameters = function () { return [
        { type: ElementRef }
    ]; };
    __decorate([
        Input(),
    ...
    return OrdinalDirective;
}());
var OrdinalModule = /** @class */ (function () {
    function OrdinalModule() {
    }
    ...
    return OrdinalModule;
}());

export { OrdinalComponent, OrdinalDirective, OrdinalModule };
