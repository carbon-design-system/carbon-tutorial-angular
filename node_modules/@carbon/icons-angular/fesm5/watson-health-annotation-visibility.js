...
var WatsonHealthAnnotationVisibilityComponent = /** @class */ (function () {
    ...
    WatsonHealthAnnotationVisibilityComponent = __decorate([
        Component({
...
var WatsonHealthAnnotationVisibilityDirective = /** @class */ (function () {
    ...
    WatsonHealthAnnotationVisibilityDirective = WatsonHealthAnnotationVisibilityDirective_1 = __decorate([
        Directive({
...
var WatsonHealthAnnotationVisibilityModule = /** @class */ (function () {
    ...
    WatsonHealthAnnotationVisibilityModule = __decorate([
        NgModule({
            declarations: [
                WatsonHealthAnnotationVisibilityComponent,
                WatsonHealthAnnotationVisibilityDirective,
    ...
    ], WatsonHealthAnnotationVisibilityModule);
