...
var DeploymentPolicyComponent = /** @class */ (function () {
    function DeploymentPolicyComponent() {
    ...
    return DeploymentPolicyComponent;
}());
var DeploymentPolicyDirective = /** @class */ (function () {
    function DeploymentPolicyDirective(elementRef) {
    ...
    DeploymentPolicyDirective_1 = DeploymentPolicyDirective;
    DeploymentPolicyDirective.prototype.ngAfterViewInit = function () {
    ...
    DeploymentPolicyDirective.ctorParameters = function () { return [
        { type: ElementRef }
    ]; };
    __decorate([
        Input(),
    ...
    return DeploymentPolicyDirective;
}());
var DeploymentPolicyModule = /** @class */ (function () {
    function DeploymentPolicyModule() {
    }
