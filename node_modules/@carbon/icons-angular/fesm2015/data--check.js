...
let DataCheckComponent = class DataCheckComponent {
    constructor() {
...
let DataCheckDirective = DataCheckDirective_1 = class DataCheckDirective {
...
DataCheckDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
DataCheckDirective = DataCheckDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconDataCheck]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], DataCheckDirective);
let DataCheckModule = class DataCheckModule {
};
DataCheckModule = __decorate([
    NgModule({
        declarations: [
            DataCheckComponent,
            DataCheckDirective,
