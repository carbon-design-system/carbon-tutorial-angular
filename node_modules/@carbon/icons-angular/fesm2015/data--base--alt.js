...
let DataBaseAltComponent = class DataBaseAltComponent {
    constructor() {
...
DataBaseAltComponent = __decorate([
    Component({
...
let DataBaseAltDirective = DataBaseAltDirective_1 = class DataBaseAltDirective {
...
DataBaseAltDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
DataBaseAltDirective = DataBaseAltDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconDataBaseAlt]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], DataBaseAltDirective);
let DataBaseAltModule = class DataBaseAltModule {
};
DataBaseAltModule = __decorate([
    NgModule({
        declarations: [
            DataBaseAltComponent,
            DataBaseAltDirective,
