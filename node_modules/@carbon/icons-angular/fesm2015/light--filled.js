...
let LightFilledComponent = class LightFilledComponent {
    constructor() {
...
LightFilledComponent = __decorate([
    Component({
...
let LightFilledDirective = LightFilledDirective_1 = class LightFilledDirective {
...
LightFilledDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
LightFilledDirective = LightFilledDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconLightFilled]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], LightFilledDirective);
let LightFilledModule = class LightFilledModule {
};
LightFilledModule = __decorate([
    NgModule({
        declarations: [
            LightFilledComponent,
            LightFilledDirective,
