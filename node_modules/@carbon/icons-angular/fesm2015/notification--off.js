...
let NotificationOffComponent = class NotificationOffComponent {
    constructor() {
...
NotificationOffComponent = __decorate([
    Component({
...
let NotificationOffDirective = NotificationOffDirective_1 = class NotificationOffDirective {
...
NotificationOffDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
NotificationOffDirective = NotificationOffDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconNotificationOff]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], NotificationOffDirective);
let NotificationOffModule = class NotificationOffModule {
};
NotificationOffModule = __decorate([
    NgModule({
        declarations: [
            NotificationOffComponent,
            NotificationOffDirective,
