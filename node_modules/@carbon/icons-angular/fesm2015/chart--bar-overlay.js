...
let ChartBarOverlayComponent = class ChartBarOverlayComponent {
    constructor() {
...
ChartBarOverlayComponent = __decorate([
    Component({
...
let ChartBarOverlayDirective = ChartBarOverlayDirective_1 = class ChartBarOverlayDirective {
...
ChartBarOverlayDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
ChartBarOverlayDirective = ChartBarOverlayDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconChartBarOverlay]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], ChartBarOverlayDirective);
let ChartBarOverlayModule = class ChartBarOverlayModule {
};
ChartBarOverlayModule = __decorate([
    NgModule({
        declarations: [
            ChartBarOverlayComponent,
            ChartBarOverlayDirective,
