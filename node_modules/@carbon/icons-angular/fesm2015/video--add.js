...
let VideoAddComponent = class VideoAddComponent {
    constructor() {
...
let VideoAddDirective = VideoAddDirective_1 = class VideoAddDirective {
...
VideoAddDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
VideoAddDirective = VideoAddDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconVideoAdd]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], VideoAddDirective);
let VideoAddModule = class VideoAddModule {
};
VideoAddModule = __decorate([
    NgModule({
        declarations: [
            VideoAddComponent,
            VideoAddDirective,
