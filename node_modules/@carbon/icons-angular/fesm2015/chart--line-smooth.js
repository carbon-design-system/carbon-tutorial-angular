...
let ChartLineSmoothComponent = class ChartLineSmoothComponent {
    constructor() {
...
ChartLineSmoothComponent = __decorate([
    Component({
...
let ChartLineSmoothDirective = ChartLineSmoothDirective_1 = class ChartLineSmoothDirective {
...
ChartLineSmoothDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
ChartLineSmoothDirective = ChartLineSmoothDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconChartLineSmooth]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], ChartLineSmoothDirective);
let ChartLineSmoothModule = class ChartLineSmoothModule {
};
ChartLineSmoothModule = __decorate([
    NgModule({
        declarations: [
            ChartLineSmoothComponent,
            ChartLineSmoothDirective,
