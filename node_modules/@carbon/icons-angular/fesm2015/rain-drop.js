...
let RainDropDirective = RainDropDirective_1 = class RainDropDirective {
...
RainDropDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
RainDropDirective = RainDropDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconRainDrop]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], RainDropDirective);
let RainDropModule = class RainDropModule {
};
RainDropModule = __decorate([
    NgModule({
        declarations: [
            RainDropComponent,
            RainDropDirective,
