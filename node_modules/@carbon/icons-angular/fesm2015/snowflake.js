...
let SnowflakeComponent = class SnowflakeComponent {
    constructor() {
...
let SnowflakeDirective = SnowflakeDirective_1 = class SnowflakeDirective {
...
SnowflakeDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
SnowflakeDirective = SnowflakeDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconSnowflake]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], SnowflakeDirective);
let SnowflakeModule = class SnowflakeModule {
};
SnowflakeModule = __decorate([
    NgModule({
        declarations: [
            SnowflakeComponent,
            SnowflakeDirective,
