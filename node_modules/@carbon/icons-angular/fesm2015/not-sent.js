...
let NotSentComponent = class NotSentComponent {
    constructor() {
...
let NotSentDirective = NotSentDirective_1 = class NotSentDirective {
...
NotSentDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
NotSentDirective = NotSentDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconNotSent]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], NotSentDirective);
let NotSentModule = class NotSentModule {
};
NotSentModule = __decorate([
    NgModule({
        declarations: [
            NotSentComponent,
            NotSentDirective,
