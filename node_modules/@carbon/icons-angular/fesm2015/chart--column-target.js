...
let ChartColumnTargetComponent = class ChartColumnTargetComponent {
    constructor() {
...
ChartColumnTargetComponent = __decorate([
    Component({
...
let ChartColumnTargetDirective = ChartColumnTargetDirective_1 = class ChartColumnTargetDirective {
...
ChartColumnTargetDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
ChartColumnTargetDirective = ChartColumnTargetDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconChartColumnTarget]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], ChartColumnTargetDirective);
let ChartColumnTargetModule = class ChartColumnTargetModule {
};
ChartColumnTargetModule = __decorate([
    NgModule({
        declarations: [
            ChartColumnTargetComponent,
            ChartColumnTargetDirective,
