...
let LetterMmComponent = class LetterMmComponent {
    constructor() {
...
let LetterMmDirective = LetterMmDirective_1 = class LetterMmDirective {
...
LetterMmDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
LetterMmDirective = LetterMmDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconLetterMm]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], LetterMmDirective);
let LetterMmModule = class LetterMmModule {
};
LetterMmModule = __decorate([
    NgModule({
        declarations: [
            LetterMmComponent,
            LetterMmDirective,
