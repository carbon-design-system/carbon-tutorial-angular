...
let ZAxisComponent = class ZAxisComponent {
    constructor() {
...
let ZAxisDirective = ZAxisDirective_1 = class ZAxisDirective {
...
ZAxisDirective = ZAxisDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconZAxis]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], ZAxisDirective);
let ZAxisModule = class ZAxisModule {
};
ZAxisModule = __decorate([
    NgModule({
        declarations: [
            ZAxisComponent,
            ZAxisDirective,
