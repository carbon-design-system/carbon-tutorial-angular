...
let PedestrianComponent = class PedestrianComponent {
    constructor() {
...
PedestrianComponent = __decorate([
    Component({
...
let PedestrianDirective = PedestrianDirective_1 = class PedestrianDirective {
...
PedestrianDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
PedestrianDirective = PedestrianDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconPedestrian]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], PedestrianDirective);
let PedestrianModule = class PedestrianModule {
};
PedestrianModule = __decorate([
    NgModule({
        declarations: [
            PedestrianComponent,
            PedestrianDirective,
