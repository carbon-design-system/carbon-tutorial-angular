...
let CheckboxUndeterminateFilledComponent = class CheckboxUndeterminateFilledComponent {
    constructor() {
...
CheckboxUndeterminateFilledComponent = __decorate([
    Component({
...
let CheckboxUndeterminateFilledDirective = CheckboxUndeterminateFilledDirective_1 = class CheckboxUndeterminateFilledDirective {
...
CheckboxUndeterminateFilledDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
CheckboxUndeterminateFilledDirective = CheckboxUndeterminateFilledDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconCheckboxUndeterminateFilled]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], CheckboxUndeterminateFilledDirective);
let CheckboxUndeterminateFilledModule = class CheckboxUndeterminateFilledModule {
};
CheckboxUndeterminateFilledModule = __decorate([
    NgModule({
        declarations: [
            CheckboxUndeterminateFilledComponent,
            CheckboxUndeterminateFilledDirective,
...
], CheckboxUndeterminateFilledModule);
