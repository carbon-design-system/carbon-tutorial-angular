...
let FaceWinkFilledComponent = class FaceWinkFilledComponent {
    constructor() {
...
FaceWinkFilledComponent = __decorate([
    Component({
...
let FaceWinkFilledDirective = FaceWinkFilledDirective_1 = class FaceWinkFilledDirective {
...
FaceWinkFilledDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
FaceWinkFilledDirective = FaceWinkFilledDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconFaceWinkFilled]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], FaceWinkFilledDirective);
let FaceWinkFilledModule = class FaceWinkFilledModule {
};
FaceWinkFilledModule = __decorate([
    NgModule({
        declarations: [
            FaceWinkFilledComponent,
            FaceWinkFilledDirective,
