...
let PresentationFileComponent = class PresentationFileComponent {
    constructor() {
...
PresentationFileComponent = __decorate([
    Component({
...
let PresentationFileDirective = PresentationFileDirective_1 = class PresentationFileDirective {
...
PresentationFileDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
PresentationFileDirective = PresentationFileDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconPresentationFile]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], PresentationFileDirective);
let PresentationFileModule = class PresentationFileModule {
};
PresentationFileModule = __decorate([
    NgModule({
        declarations: [
            PresentationFileComponent,
            PresentationFileDirective,
