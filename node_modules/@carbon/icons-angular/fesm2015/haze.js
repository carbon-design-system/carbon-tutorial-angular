...
var HazeDirective_1;
let HazeComponent = class HazeComponent {
    constructor() {
...
let HazeDirective = HazeDirective_1 = class HazeDirective {
...
HazeDirective = HazeDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconHaze]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], HazeDirective);
let HazeModule = class HazeModule {
};
HazeModule = __decorate([
    NgModule({
        declarations: [
            HazeComponent,
            HazeDirective,
