...
let DecisionTreeComponent = class DecisionTreeComponent {
    constructor() {
...
DecisionTreeComponent = __decorate([
    Component({
...
let DecisionTreeDirective = DecisionTreeDirective_1 = class DecisionTreeDirective {
...
DecisionTreeDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
DecisionTreeDirective = DecisionTreeDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconDecisionTree]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], DecisionTreeDirective);
let DecisionTreeModule = class DecisionTreeModule {
};
DecisionTreeModule = __decorate([
    NgModule({
        declarations: [
            DecisionTreeComponent,
            DecisionTreeDirective,
