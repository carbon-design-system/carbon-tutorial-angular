...
let SunsetDirective = SunsetDirective_1 = class SunsetDirective {
...
SunsetDirective.ctorParameters = () => [
    { type: ElementRef }
];
__decorate([
    Input(),
...
SunsetDirective = SunsetDirective_1 = __decorate([
    Directive({
        selector: "[ibmIconSunset]"
    }),
    __metadata("design:paramtypes", [ElementRef])
], SunsetDirective);
let SunsetModule = class SunsetModule {
};
SunsetModule = __decorate([
    NgModule({
        declarations: [
            SunsetComponent,
            SunsetDirective,
