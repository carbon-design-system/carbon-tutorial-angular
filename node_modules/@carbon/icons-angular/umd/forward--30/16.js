(function (global, factory) {
    ...
    var Forward_3016 = /** @class */ (function () {
        function Forward_3016() {
            this.focusable = false;
        }
        Forward_3016.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-forward-3016",
                        template: "\n    <svg\n      ibmIconForward_3016\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Forward_3016.propDecorators = {
    ...
    var Forward_3016Directive = /** @class */ (function () {
        function Forward_3016Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Forward_3016Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Forward_3016Directive.titleIdCounter++;
                title.setAttribute("id", "forward-3016-" + Forward_3016Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "forward-3016-" + Forward_3016Directive.titleIdCounter);
            }
        };
        Forward_3016Directive.titleIdCounter = 0;
        Forward_3016Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconForward_3016]"
                    },] },
        ];
        /** @nocollapse */
        Forward_3016Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Forward_3016Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Forward_3016Directive;
    }());
    var Forward_3016Module = /** @class */ (function () {
        function Forward_3016Module() {
        }
        Forward_3016Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            Forward_3016,
                            Forward_3016Directive
                        ],
                        exports: [
                            Forward_3016,
                            Forward_3016Directive
        ...
        return Forward_3016Module;
    }());

    exports.Forward_3016 = Forward_3016;
    exports.Forward_3016Directive = Forward_3016Directive;
    exports.Forward_3016Module = Forward_3016Module;
