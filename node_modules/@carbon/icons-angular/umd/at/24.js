(function (global, factory) {
    ...
    var At24 = /** @class */ (function () {
        function At24() {
            this.focusable = false;
        }
        At24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-at24",
    ...
    var At24Directive = /** @class */ (function () {
        function At24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        At24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                At24Directive.titleIdCounter++;
                title.setAttribute("id", "at24-" + At24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "at24-" + At24Directive.titleIdCounter);
            }
        };
        At24Directive.titleIdCounter = 0;
        At24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconAt24]"
                    },] },
        ];
        /** @nocollapse */
        At24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        At24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return At24Directive;
    }());
    var At24Module = /** @class */ (function () {
        function At24Module() {
        }
        At24Module.decorators = [
    ...
    exports.At24 = At24;
    exports.At24Directive = At24Directive;
    exports.At24Module = At24Module;
