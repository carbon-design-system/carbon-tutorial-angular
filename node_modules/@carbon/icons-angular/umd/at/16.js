(function (global, factory) {
    ...
    var At16 = /** @class */ (function () {
        function At16() {
            this.focusable = false;
        }
        At16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-at16",
    ...
    var At16Directive = /** @class */ (function () {
        function At16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        At16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                At16Directive.titleIdCounter++;
                title.setAttribute("id", "at16-" + At16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "at16-" + At16Directive.titleIdCounter);
            }
        };
        At16Directive.titleIdCounter = 0;
        At16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconAt16]"
                    },] },
        ];
        /** @nocollapse */
        At16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        At16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return At16Directive;
    }());
    var At16Module = /** @class */ (function () {
        function At16Module() {
        }
        At16Module.decorators = [
    ...
    exports.At16 = At16;
    exports.At16Directive = At16Directive;
    exports.At16Module = At16Module;
