(function (global, factory) {
    ...
    var Stamp24 = /** @class */ (function () {
        function Stamp24() {
            this.focusable = false;
        }
        Stamp24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-stamp24",
                        template: "\n    <svg\n      ibmIconStamp24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Stamp24.propDecorators = {
    ...
    var Stamp24Directive = /** @class */ (function () {
        function Stamp24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Stamp24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Stamp24Directive.titleIdCounter++;
                title.setAttribute("id", "stamp24-" + Stamp24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "stamp24-" + Stamp24Directive.titleIdCounter);
            }
        };
        Stamp24Directive.titleIdCounter = 0;
        Stamp24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconStamp24]"
                    },] },
        ];
        /** @nocollapse */
        Stamp24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Stamp24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Stamp24Directive;
    }());
    var Stamp24Module = /** @class */ (function () {
        function Stamp24Module() {
        }
        Stamp24Module.decorators = [
        ...
        return Stamp24Module;
    }());

    exports.Stamp24 = Stamp24;
    exports.Stamp24Directive = Stamp24Directive;
    exports.Stamp24Module = Stamp24Module;
