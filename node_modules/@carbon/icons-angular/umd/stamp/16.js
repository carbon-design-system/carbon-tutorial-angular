(function (global, factory) {
    ...
    var Stamp16 = /** @class */ (function () {
        function Stamp16() {
            this.focusable = false;
        }
        Stamp16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-stamp16",
                        template: "\n    <svg\n      ibmIconStamp16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Stamp16.propDecorators = {
    ...
    var Stamp16Directive = /** @class */ (function () {
        function Stamp16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Stamp16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Stamp16Directive.titleIdCounter++;
                title.setAttribute("id", "stamp16-" + Stamp16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "stamp16-" + Stamp16Directive.titleIdCounter);
            }
        };
        Stamp16Directive.titleIdCounter = 0;
        Stamp16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconStamp16]"
                    },] },
        ];
        /** @nocollapse */
        Stamp16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Stamp16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Stamp16Directive;
    }());
    var Stamp16Module = /** @class */ (function () {
        function Stamp16Module() {
        }
        Stamp16Module.decorators = [
        ...
        return Stamp16Module;
    }());

    exports.Stamp16 = Stamp16;
    exports.Stamp16Directive = Stamp16Directive;
    exports.Stamp16Module = Stamp16Module;
