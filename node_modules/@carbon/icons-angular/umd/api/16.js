(function (global, factory) {
    ...
    var Api16 = /** @class */ (function () {
        function Api16() {
            this.focusable = false;
        }
        Api16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-api16",
                        template: "\n    <svg\n      ibmIconApi16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Api16.propDecorators = {
    ...
    var Api16Directive = /** @class */ (function () {
        function Api16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Api16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Api16Directive.titleIdCounter++;
                title.setAttribute("id", "api16-" + Api16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "api16-" + Api16Directive.titleIdCounter);
            }
        };
        Api16Directive.titleIdCounter = 0;
        Api16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconApi16]"
                    },] },
        ];
        /** @nocollapse */
        Api16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Api16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Api16Directive;
    }());
    var Api16Module = /** @class */ (function () {
        function Api16Module() {
        }
        Api16Module.decorators = [
    ...
    exports.Api16 = Api16;
    exports.Api16Directive = Api16Directive;
    exports.Api16Module = Api16Module;
