(function (global, factory) {
    ...
    var Network_224 = /** @class */ (function () {
        function Network_224() {
            this.focusable = false;
        }
        Network_224.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-network-224",
                        template: "\n    <svg\n      ibmIconNetwork_224\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Network_224.propDecorators = {
    ...
    var Network_224Directive = /** @class */ (function () {
        function Network_224Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Network_224Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Network_224Directive.titleIdCounter++;
                title.setAttribute("id", "network-224-" + Network_224Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "network-224-" + Network_224Directive.titleIdCounter);
            }
        };
        Network_224Directive.titleIdCounter = 0;
        Network_224Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconNetwork_224]"
                    },] },
        ];
        /** @nocollapse */
        Network_224Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Network_224Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Network_224Directive;
    }());
    var Network_224Module = /** @class */ (function () {
        function Network_224Module() {
        }
        Network_224Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            Network_224,
                            Network_224Directive
                        ],
                        exports: [
                            Network_224,
                            Network_224Directive
        ...
        return Network_224Module;
    }());

    exports.Network_224 = Network_224;
    exports.Network_224Directive = Network_224Directive;
    exports.Network_224Module = Network_224Module;
