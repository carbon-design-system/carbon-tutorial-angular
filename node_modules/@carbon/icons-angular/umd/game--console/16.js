(function (global, factory) {
    ...
    var GameConsole16 = /** @class */ (function () {
        function GameConsole16() {
            this.focusable = false;
        }
        GameConsole16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-game-console16",
                        template: "\n    <svg\n      ibmIconGameConsole16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        GameConsole16.propDecorators = {
        ...
        return GameConsole16;
    }());
    var GameConsole16Directive = /** @class */ (function () {
        function GameConsole16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        GameConsole16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                GameConsole16Directive.titleIdCounter++;
                title.setAttribute("id", "game-console16-" + GameConsole16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "game-console16-" + GameConsole16Directive.titleIdCounter);
            }
        };
        GameConsole16Directive.titleIdCounter = 0;
        GameConsole16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconGameConsole16]"
                    },] },
        ];
        /** @nocollapse */
        GameConsole16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        GameConsole16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return GameConsole16Directive;
    }());
    var GameConsole16Module = /** @class */ (function () {
        function GameConsole16Module() {
        }
        GameConsole16Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            GameConsole16,
                            GameConsole16Directive
                        ],
                        exports: [
                            GameConsole16,
                            GameConsole16Directive
        ...
        return GameConsole16Module;
    }());

    exports.GameConsole16 = GameConsole16;
    exports.GameConsole16Directive = GameConsole16Directive;
    exports.GameConsole16Module = GameConsole16Module;
