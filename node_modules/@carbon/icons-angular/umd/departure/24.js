(function (global, factory) {
    ...
    var Departure24 = /** @class */ (function () {
        function Departure24() {
            this.focusable = false;
        }
        Departure24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-departure24",
                        template: "\n    <svg\n      ibmIconDeparture24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Departure24.propDecorators = {
    ...
    var Departure24Directive = /** @class */ (function () {
        ...
        Departure24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Departure24Directive.titleIdCounter++;
                title.setAttribute("id", "departure24-" + Departure24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "departure24-" + Departure24Directive.titleIdCounter);
            }
        };
        Departure24Directive.titleIdCounter = 0;
        Departure24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconDeparture24]"
                    },] },
        ];
        /** @nocollapse */
        Departure24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Departure24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Departure24Directive;
    }());
    var Departure24Module = /** @class */ (function () {
        function Departure24Module() {
        }
        Departure24Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            Departure24,
                            Departure24Directive
                        ],
                        exports: [
                            Departure24,
                            Departure24Directive
        ...
        return Departure24Module;
    }());

    exports.Departure24 = Departure24;
    exports.Departure24Directive = Departure24Directive;
    exports.Departure24Module = Departure24Module;
