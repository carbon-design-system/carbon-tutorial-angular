(function (global, factory) {
    ...
    var Corn24 = /** @class */ (function () {
        function Corn24() {
            this.focusable = false;
        }
        Corn24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-corn24",
                        template: "\n    <svg\n      ibmIconCorn24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Corn24.propDecorators = {
    ...
    var Corn24Directive = /** @class */ (function () {
        function Corn24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Corn24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Corn24Directive.titleIdCounter++;
                title.setAttribute("id", "corn24-" + Corn24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "corn24-" + Corn24Directive.titleIdCounter);
            }
        };
        Corn24Directive.titleIdCounter = 0;
        Corn24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconCorn24]"
                    },] },
        ];
        /** @nocollapse */
        Corn24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Corn24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Corn24Directive;
    }());
    var Corn24Module = /** @class */ (function () {
        function Corn24Module() {
        }
        Corn24Module.decorators = [
    ...
    exports.Corn24Directive = Corn24Directive;
    exports.Corn24Module = Corn24Module;
