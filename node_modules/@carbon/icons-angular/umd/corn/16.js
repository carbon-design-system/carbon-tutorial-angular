(function (global, factory) {
    ...
    var Corn16 = /** @class */ (function () {
        function Corn16() {
            this.focusable = false;
        }
        Corn16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-corn16",
                        template: "\n    <svg\n      ibmIconCorn16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Corn16.propDecorators = {
    ...
    var Corn16Directive = /** @class */ (function () {
        function Corn16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Corn16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Corn16Directive.titleIdCounter++;
                title.setAttribute("id", "corn16-" + Corn16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "corn16-" + Corn16Directive.titleIdCounter);
            }
        };
        Corn16Directive.titleIdCounter = 0;
        Corn16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconCorn16]"
                    },] },
        ];
        /** @nocollapse */
        Corn16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Corn16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Corn16Directive;
    }());
    var Corn16Module = /** @class */ (function () {
        function Corn16Module() {
        }
        Corn16Module.decorators = [
    ...
    exports.Corn16Directive = Corn16Directive;
    exports.Corn16Module = Corn16Module;
