(function (global, factory) {
    ...
    var LogoMedium32 = /** @class */ (function () {
        function LogoMedium32() {
            this.focusable = false;
        }
        LogoMedium32.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-logo-medium32",
                        template: "\n    <svg\n      ibmIconLogoMedium32\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        LogoMedium32.propDecorators = {
    ...
    var LogoMedium32Directive = /** @class */ (function () {
        ...
        LogoMedium32Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                LogoMedium32Directive.titleIdCounter++;
                title.setAttribute("id", "logo-medium32-" + LogoMedium32Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "logo-medium32-" + LogoMedium32Directive.titleIdCounter);
            }
        };
        LogoMedium32Directive.titleIdCounter = 0;
        LogoMedium32Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconLogoMedium32]"
                    },] },
        ];
        /** @nocollapse */
        LogoMedium32Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        LogoMedium32Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return LogoMedium32Directive;
    }());
    var LogoMedium32Module = /** @class */ (function () {
        function LogoMedium32Module() {
        }
        LogoMedium32Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            LogoMedium32,
                            LogoMedium32Directive
                        ],
                        exports: [
                            LogoMedium32,
                            LogoMedium32Directive
        ...
        return LogoMedium32Module;
    }());

    exports.LogoMedium32 = LogoMedium32;
    exports.LogoMedium32Directive = LogoMedium32Directive;
    exports.LogoMedium32Module = LogoMedium32Module;
