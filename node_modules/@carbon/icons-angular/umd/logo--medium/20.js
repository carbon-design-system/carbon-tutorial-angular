(function (global, factory) {
    ...
    var LogoMedium20 = /** @class */ (function () {
        function LogoMedium20() {
            this.focusable = false;
        }
        LogoMedium20.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-logo-medium20",
                        template: "\n    <svg\n      ibmIconLogoMedium20\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        LogoMedium20.propDecorators = {
    ...
    var LogoMedium20Directive = /** @class */ (function () {
        ...
        LogoMedium20Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                LogoMedium20Directive.titleIdCounter++;
                title.setAttribute("id", "logo-medium20-" + LogoMedium20Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "logo-medium20-" + LogoMedium20Directive.titleIdCounter);
            }
        };
        LogoMedium20Directive.titleIdCounter = 0;
        LogoMedium20Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconLogoMedium20]"
                    },] },
        ];
        /** @nocollapse */
        LogoMedium20Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        LogoMedium20Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return LogoMedium20Directive;
    }());
    var LogoMedium20Module = /** @class */ (function () {
        function LogoMedium20Module() {
        }
        LogoMedium20Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            LogoMedium20,
                            LogoMedium20Directive
                        ],
                        exports: [
                            LogoMedium20,
                            LogoMedium20Directive
        ...
        return LogoMedium20Module;
    }());

    exports.LogoMedium20 = LogoMedium20;
    exports.LogoMedium20Directive = LogoMedium20Directive;
    exports.LogoMedium20Module = LogoMedium20Module;
