(function (global, factory) {
    ...
    var LogoMedium16 = /** @class */ (function () {
        function LogoMedium16() {
            this.focusable = false;
        }
        LogoMedium16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-logo-medium16",
                        template: "\n    <svg\n      ibmIconLogoMedium16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        LogoMedium16.propDecorators = {
    ...
    var LogoMedium16Directive = /** @class */ (function () {
        function LogoMedium16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        LogoMedium16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                LogoMedium16Directive.titleIdCounter++;
                title.setAttribute("id", "logo-medium16-" + LogoMedium16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "logo-medium16-" + LogoMedium16Directive.titleIdCounter);
            }
        };
        LogoMedium16Directive.titleIdCounter = 0;
        LogoMedium16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconLogoMedium16]"
                    },] },
        ];
        /** @nocollapse */
        LogoMedium16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        LogoMedium16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return LogoMedium16Directive;
    }());
    var LogoMedium16Module = /** @class */ (function () {
        function LogoMedium16Module() {
        }
        LogoMedium16Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            LogoMedium16,
                            LogoMedium16Directive
                        ],
                        exports: [
                            LogoMedium16,
                            LogoMedium16Directive
        ...
        return LogoMedium16Module;
    }());

    exports.LogoMedium16 = LogoMedium16;
    exports.LogoMedium16Directive = LogoMedium16Directive;
    exports.LogoMedium16Module = LogoMedium16Module;
