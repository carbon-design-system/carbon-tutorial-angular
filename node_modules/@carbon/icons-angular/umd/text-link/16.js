(function (global, factory) {
    ...
    var TextLink16 = /** @class */ (function () {
        function TextLink16() {
            this.focusable = false;
        }
        TextLink16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-text-link16",
                        template: "\n    <svg\n      ibmIconTextLink16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        TextLink16.propDecorators = {
    ...
    var TextLink16Directive = /** @class */ (function () {
        function TextLink16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        TextLink16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                TextLink16Directive.titleIdCounter++;
                title.setAttribute("id", "text-link16-" + TextLink16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "text-link16-" + TextLink16Directive.titleIdCounter);
            }
        };
        TextLink16Directive.titleIdCounter = 0;
        TextLink16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconTextLink16]"
                    },] },
        ];
        /** @nocollapse */
        TextLink16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        TextLink16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return TextLink16Directive;
    }());
    var TextLink16Module = /** @class */ (function () {
        function TextLink16Module() {
        }
        TextLink16Module.decorators = [
        ...
        return TextLink16Module;
    }());

    exports.TextLink16 = TextLink16;
    exports.TextLink16Directive = TextLink16Directive;
    exports.TextLink16Module = TextLink16Module;
