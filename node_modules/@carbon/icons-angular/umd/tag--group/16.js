(function (global, factory) {
    ...
    var TagGroup16 = /** @class */ (function () {
        function TagGroup16() {
            this.focusable = false;
        }
        TagGroup16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-tag-group16",
                        template: "\n    <svg\n      ibmIconTagGroup16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        TagGroup16.propDecorators = {
    ...
    var TagGroup16Directive = /** @class */ (function () {
        function TagGroup16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        TagGroup16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                TagGroup16Directive.titleIdCounter++;
                title.setAttribute("id", "tag-group16-" + TagGroup16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "tag-group16-" + TagGroup16Directive.titleIdCounter);
            }
        };
        TagGroup16Directive.titleIdCounter = 0;
        TagGroup16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconTagGroup16]"
                    },] },
        ];
        /** @nocollapse */
        TagGroup16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        TagGroup16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return TagGroup16Directive;
    }());
    var TagGroup16Module = /** @class */ (function () {
        function TagGroup16Module() {
        }
        TagGroup16Module.decorators = [
        ...
        return TagGroup16Module;
    }());

    exports.TagGroup16 = TagGroup16;
    exports.TagGroup16Directive = TagGroup16Directive;
    exports.TagGroup16Module = TagGroup16Module;
