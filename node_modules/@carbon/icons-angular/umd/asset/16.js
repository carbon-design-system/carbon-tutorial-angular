(function (global, factory) {
    ...
    var Asset16 = /** @class */ (function () {
        function Asset16() {
            this.focusable = false;
        }
        Asset16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-asset16",
                        template: "\n    <svg\n      ibmIconAsset16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Asset16.propDecorators = {
    ...
    var Asset16Directive = /** @class */ (function () {
        function Asset16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Asset16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Asset16Directive.titleIdCounter++;
                title.setAttribute("id", "asset16-" + Asset16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "asset16-" + Asset16Directive.titleIdCounter);
            }
        };
        Asset16Directive.titleIdCounter = 0;
        Asset16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconAsset16]"
                    },] },
        ];
        /** @nocollapse */
        Asset16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Asset16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Asset16Directive;
    }());
    var Asset16Module = /** @class */ (function () {
        function Asset16Module() {
        }
        Asset16Module.decorators = [
        ...
        return Asset16Module;
    }());

    exports.Asset16 = Asset16;
    exports.Asset16Directive = Asset16Directive;
    exports.Asset16Module = Asset16Module;
