(function (global, factory) {
    ...
    var Asset32 = /** @class */ (function () {
        function Asset32() {
            this.focusable = false;
        }
        Asset32.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-asset32",
                        template: "\n    <svg\n      ibmIconAsset32\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Asset32.propDecorators = {
    ...
    var Asset32Directive = /** @class */ (function () {
        ...
        Asset32Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Asset32Directive.titleIdCounter++;
                title.setAttribute("id", "asset32-" + Asset32Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "asset32-" + Asset32Directive.titleIdCounter);
            }
        };
        Asset32Directive.titleIdCounter = 0;
        Asset32Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconAsset32]"
                    },] },
        ];
        /** @nocollapse */
        Asset32Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Asset32Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Asset32Directive;
    }());
    var Asset32Module = /** @class */ (function () {
        function Asset32Module() {
        }
        Asset32Module.decorators = [
        ...
        return Asset32Module;
    }());

    exports.Asset32 = Asset32;
    exports.Asset32Directive = Asset32Directive;
    exports.Asset32Module = Asset32Module;
