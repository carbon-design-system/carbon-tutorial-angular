(function (global, factory) {
    ...
    var LogoInstagram24 = /** @class */ (function () {
        function LogoInstagram24() {
            this.focusable = false;
        }
        LogoInstagram24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-logo-instagram24",
                        template: "\n    <svg\n      ibmIconLogoInstagram24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        LogoInstagram24.propDecorators = {
        ...
        return LogoInstagram24;
    }());
    var LogoInstagram24Directive = /** @class */ (function () {
        function LogoInstagram24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        LogoInstagram24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                LogoInstagram24Directive.titleIdCounter++;
                title.setAttribute("id", "logo-instagram24-" + LogoInstagram24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "logo-instagram24-" + LogoInstagram24Directive.titleIdCounter);
            }
        };
        LogoInstagram24Directive.titleIdCounter = 0;
        LogoInstagram24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconLogoInstagram24]"
                    },] },
        ];
        /** @nocollapse */
        LogoInstagram24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        LogoInstagram24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return LogoInstagram24Directive;
    }());
    var LogoInstagram24Module = /** @class */ (function () {
        function LogoInstagram24Module() {
        }
        LogoInstagram24Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            LogoInstagram24,
                            LogoInstagram24Directive
                        ],
                        exports: [
                            LogoInstagram24,
                            LogoInstagram24Directive
        ...
        return LogoInstagram24Module;
    }());

    exports.LogoInstagram24 = LogoInstagram24;
    exports.LogoInstagram24Directive = LogoInstagram24Directive;
    exports.LogoInstagram24Module = LogoInstagram24Module;
