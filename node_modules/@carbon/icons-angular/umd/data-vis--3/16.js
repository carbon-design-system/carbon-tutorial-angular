(function (global, factory) {
    ...
    var DataVis_316 = /** @class */ (function () {
        function DataVis_316() {
            this.focusable = false;
        }
        DataVis_316.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-data-vis-316",
                        template: "\n    <svg\n      ibmIconDataVis_316\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        DataVis_316.propDecorators = {
    ...
    var DataVis_316Directive = /** @class */ (function () {
        function DataVis_316Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        DataVis_316Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                DataVis_316Directive.titleIdCounter++;
                title.setAttribute("id", "data-vis-316-" + DataVis_316Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "data-vis-316-" + DataVis_316Directive.titleIdCounter);
            }
        };
        DataVis_316Directive.titleIdCounter = 0;
        DataVis_316Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconDataVis_316]"
                    },] },
        ];
        /** @nocollapse */
        DataVis_316Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        DataVis_316Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return DataVis_316Directive;
    }());
    var DataVis_316Module = /** @class */ (function () {
        function DataVis_316Module() {
        }
        DataVis_316Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            DataVis_316,
                            DataVis_316Directive
                        ],
                        exports: [
                            DataVis_316,
                            DataVis_316Directive
        ...
        return DataVis_316Module;
    }());

    exports.DataVis_316 = DataVis_316;
    exports.DataVis_316Directive = DataVis_316Directive;
    exports.DataVis_316Module = DataVis_316Module;
