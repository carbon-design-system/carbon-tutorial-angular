(function (global, factory) {
    ...
    var Image24 = /** @class */ (function () {
        function Image24() {
            this.focusable = false;
        }
        Image24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-image24",
                        template: "\n    <svg\n      ibmIconImage24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Image24.propDecorators = {
    ...
    var Image24Directive = /** @class */ (function () {
        function Image24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Image24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Image24Directive.titleIdCounter++;
                title.setAttribute("id", "image24-" + Image24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "image24-" + Image24Directive.titleIdCounter);
            }
        };
        Image24Directive.titleIdCounter = 0;
        Image24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconImage24]"
                    },] },
        ];
        /** @nocollapse */
        Image24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Image24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Image24Directive;
    }());
    var Image24Module = /** @class */ (function () {
        function Image24Module() {
        }
        Image24Module.decorators = [
        ...
        return Image24Module;
    }());

    exports.Image24 = Image24;
    exports.Image24Directive = Image24Directive;
    exports.Image24Module = Image24Module;
