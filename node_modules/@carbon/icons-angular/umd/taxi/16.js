(function (global, factory) {
    ...
    var Taxi16 = /** @class */ (function () {
        function Taxi16() {
            this.focusable = false;
        }
        Taxi16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-taxi16",
                        template: "\n    <svg\n      ibmIconTaxi16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Taxi16.propDecorators = {
    ...
    var Taxi16Directive = /** @class */ (function () {
        function Taxi16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Taxi16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Taxi16Directive.titleIdCounter++;
                title.setAttribute("id", "taxi16-" + Taxi16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "taxi16-" + Taxi16Directive.titleIdCounter);
            }
        };
        Taxi16Directive.titleIdCounter = 0;
        Taxi16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconTaxi16]"
                    },] },
        ];
        /** @nocollapse */
        Taxi16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Taxi16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Taxi16Directive;
    }());
    var Taxi16Module = /** @class */ (function () {
        function Taxi16Module() {
        }
        Taxi16Module.decorators = [
    ...
    exports.Taxi16Directive = Taxi16Directive;
    exports.Taxi16Module = Taxi16Module;
