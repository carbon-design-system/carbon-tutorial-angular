(function (global, factory) {
    ...
    var Wikis24 = /** @class */ (function () {
        function Wikis24() {
            this.focusable = false;
        }
        Wikis24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-wikis24",
                        template: "\n    <svg\n      ibmIconWikis24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Wikis24.propDecorators = {
    ...
    var Wikis24Directive = /** @class */ (function () {
        function Wikis24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Wikis24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Wikis24Directive.titleIdCounter++;
                title.setAttribute("id", "wikis24-" + Wikis24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "wikis24-" + Wikis24Directive.titleIdCounter);
            }
        };
        Wikis24Directive.titleIdCounter = 0;
        Wikis24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconWikis24]"
                    },] },
        ];
        /** @nocollapse */
        Wikis24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Wikis24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Wikis24Directive;
    }());
    var Wikis24Module = /** @class */ (function () {
        function Wikis24Module() {
        }
        Wikis24Module.decorators = [
        ...
        return Wikis24Module;
    }());

    exports.Wikis24 = Wikis24;
    exports.Wikis24Directive = Wikis24Directive;
    exports.Wikis24Module = Wikis24Module;
