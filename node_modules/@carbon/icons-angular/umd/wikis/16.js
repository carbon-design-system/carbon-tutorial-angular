(function (global, factory) {
    ...
    var Wikis16 = /** @class */ (function () {
        function Wikis16() {
            this.focusable = false;
        }
        Wikis16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-wikis16",
                        template: "\n    <svg\n      ibmIconWikis16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Wikis16.propDecorators = {
    ...
    var Wikis16Directive = /** @class */ (function () {
        function Wikis16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Wikis16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Wikis16Directive.titleIdCounter++;
                title.setAttribute("id", "wikis16-" + Wikis16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "wikis16-" + Wikis16Directive.titleIdCounter);
            }
        };
        Wikis16Directive.titleIdCounter = 0;
        Wikis16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconWikis16]"
                    },] },
        ];
        /** @nocollapse */
        Wikis16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Wikis16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Wikis16Directive;
    }());
    var Wikis16Module = /** @class */ (function () {
        function Wikis16Module() {
        }
        Wikis16Module.decorators = [
        ...
        return Wikis16Module;
    }());

    exports.Wikis16 = Wikis16;
    exports.Wikis16Directive = Wikis16Directive;
    exports.Wikis16Module = Wikis16Module;
