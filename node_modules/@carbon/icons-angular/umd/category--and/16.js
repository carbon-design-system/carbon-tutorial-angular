(function (global, factory) {
    ...
    var CategoryAnd16 = /** @class */ (function () {
        function CategoryAnd16() {
            this.focusable = false;
        }
        CategoryAnd16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-category-and16",
                        template: "\n    <svg\n      ibmIconCategoryAnd16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        CategoryAnd16.propDecorators = {
        ...
        return CategoryAnd16;
    }());
    var CategoryAnd16Directive = /** @class */ (function () {
        function CategoryAnd16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        CategoryAnd16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                CategoryAnd16Directive.titleIdCounter++;
                title.setAttribute("id", "category-and16-" + CategoryAnd16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "category-and16-" + CategoryAnd16Directive.titleIdCounter);
            }
        };
        CategoryAnd16Directive.titleIdCounter = 0;
        CategoryAnd16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconCategoryAnd16]"
                    },] },
        ];
        /** @nocollapse */
        CategoryAnd16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        CategoryAnd16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return CategoryAnd16Directive;
    }());
    var CategoryAnd16Module = /** @class */ (function () {
        function CategoryAnd16Module() {
        }
        CategoryAnd16Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            CategoryAnd16,
                            CategoryAnd16Directive
                        ],
                        exports: [
                            CategoryAnd16,
                            CategoryAnd16Directive
        ...
        return CategoryAnd16Module;
    }());

    exports.CategoryAnd16 = CategoryAnd16;
    exports.CategoryAnd16Directive = CategoryAnd16Directive;
    exports.CategoryAnd16Module = CategoryAnd16Module;
