(function (global, factory) {
    ...
    var Pills16 = /** @class */ (function () {
        function Pills16() {
            this.focusable = false;
        }
        Pills16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-pills16",
                        template: "\n    <svg\n      ibmIconPills16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Pills16.propDecorators = {
    ...
    var Pills16Directive = /** @class */ (function () {
        function Pills16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Pills16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Pills16Directive.titleIdCounter++;
                title.setAttribute("id", "pills16-" + Pills16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "pills16-" + Pills16Directive.titleIdCounter);
            }
        };
        Pills16Directive.titleIdCounter = 0;
        Pills16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconPills16]"
                    },] },
        ];
        /** @nocollapse */
        Pills16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Pills16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Pills16Directive;
    }());
    var Pills16Module = /** @class */ (function () {
        function Pills16Module() {
        }
        Pills16Module.decorators = [
        ...
        return Pills16Module;
    }());

    exports.Pills16 = Pills16;
    exports.Pills16Directive = Pills16Directive;
    exports.Pills16Module = Pills16Module;
