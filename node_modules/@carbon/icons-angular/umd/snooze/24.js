(function (global, factory) {
    ...
    var Snooze24 = /** @class */ (function () {
        function Snooze24() {
            this.focusable = false;
        }
        Snooze24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-snooze24",
                        template: "\n    <svg\n      ibmIconSnooze24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Snooze24.propDecorators = {
    ...
    var Snooze24Directive = /** @class */ (function () {
        function Snooze24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Snooze24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Snooze24Directive.titleIdCounter++;
                title.setAttribute("id", "snooze24-" + Snooze24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "snooze24-" + Snooze24Directive.titleIdCounter);
            }
        };
        Snooze24Directive.titleIdCounter = 0;
        Snooze24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconSnooze24]"
                    },] },
        ];
        /** @nocollapse */
        Snooze24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Snooze24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Snooze24Directive;
    }());
    var Snooze24Module = /** @class */ (function () {
        function Snooze24Module() {
        }
        Snooze24Module.decorators = [
        ...
        return Snooze24Module;
    }());

    exports.Snooze24 = Snooze24;
    exports.Snooze24Directive = Snooze24Directive;
    exports.Snooze24Module = Snooze24Module;
