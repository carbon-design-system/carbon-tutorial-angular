(function (global, factory) {
    ...
    var LogoVmware16 = /** @class */ (function () {
        function LogoVmware16() {
            this.focusable = false;
        }
        LogoVmware16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-logo-vmware16",
                        template: "\n    <svg\n      ibmIconLogoVmware16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        LogoVmware16.propDecorators = {
    ...
    var LogoVmware16Directive = /** @class */ (function () {
        function LogoVmware16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        LogoVmware16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                LogoVmware16Directive.titleIdCounter++;
                title.setAttribute("id", "logo-vmware16-" + LogoVmware16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "logo-vmware16-" + LogoVmware16Directive.titleIdCounter);
            }
        };
        LogoVmware16Directive.titleIdCounter = 0;
        LogoVmware16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconLogoVmware16]"
                    },] },
        ];
        /** @nocollapse */
        LogoVmware16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        LogoVmware16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return LogoVmware16Directive;
    }());
    var LogoVmware16Module = /** @class */ (function () {
        function LogoVmware16Module() {
        }
        LogoVmware16Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            LogoVmware16,
                            LogoVmware16Directive
                        ],
                        exports: [
                            LogoVmware16,
                            LogoVmware16Directive
        ...
        return LogoVmware16Module;
    }());

    exports.LogoVmware16 = LogoVmware16;
    exports.LogoVmware16Directive = LogoVmware16Directive;
    exports.LogoVmware16Module = LogoVmware16Module;
