(function (global, factory) {
    ...
    var LogoVmware24 = /** @class */ (function () {
        function LogoVmware24() {
            this.focusable = false;
        }
        LogoVmware24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-logo-vmware24",
                        template: "\n    <svg\n      ibmIconLogoVmware24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        LogoVmware24.propDecorators = {
    ...
    var LogoVmware24Directive = /** @class */ (function () {
        function LogoVmware24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        LogoVmware24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                LogoVmware24Directive.titleIdCounter++;
                title.setAttribute("id", "logo-vmware24-" + LogoVmware24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "logo-vmware24-" + LogoVmware24Directive.titleIdCounter);
            }
        };
        LogoVmware24Directive.titleIdCounter = 0;
        LogoVmware24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconLogoVmware24]"
                    },] },
        ];
        /** @nocollapse */
        LogoVmware24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        LogoVmware24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return LogoVmware24Directive;
    }());
    var LogoVmware24Module = /** @class */ (function () {
        function LogoVmware24Module() {
        }
        LogoVmware24Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            LogoVmware24,
                            LogoVmware24Directive
                        ],
                        exports: [
                            LogoVmware24,
                            LogoVmware24Directive
        ...
        return LogoVmware24Module;
    }());

    exports.LogoVmware24 = LogoVmware24;
    exports.LogoVmware24Directive = LogoVmware24Directive;
    exports.LogoVmware24Module = LogoVmware24Module;
