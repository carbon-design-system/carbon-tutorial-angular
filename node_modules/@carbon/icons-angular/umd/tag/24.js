(function (global, factory) {
    ...
    var Tag24 = /** @class */ (function () {
        function Tag24() {
            this.focusable = false;
        }
        Tag24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-tag24",
                        template: "\n    <svg\n      ibmIconTag24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Tag24.propDecorators = {
    ...
    var Tag24Directive = /** @class */ (function () {
        function Tag24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Tag24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Tag24Directive.titleIdCounter++;
                title.setAttribute("id", "tag24-" + Tag24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "tag24-" + Tag24Directive.titleIdCounter);
            }
        };
        Tag24Directive.titleIdCounter = 0;
        Tag24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconTag24]"
                    },] },
        ];
        /** @nocollapse */
        Tag24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Tag24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Tag24Directive;
    }());
    var Tag24Module = /** @class */ (function () {
        function Tag24Module() {
        }
        Tag24Module.decorators = [
    ...
    exports.Tag24 = Tag24;
    exports.Tag24Directive = Tag24Directive;
    exports.Tag24Module = Tag24Module;
