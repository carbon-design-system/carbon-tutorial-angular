(function (global, factory) {
    ...
    var Sprout24 = /** @class */ (function () {
        function Sprout24() {
            this.focusable = false;
        }
        Sprout24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-sprout24",
                        template: "\n    <svg\n      ibmIconSprout24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Sprout24.propDecorators = {
    ...
    var Sprout24Directive = /** @class */ (function () {
        function Sprout24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Sprout24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Sprout24Directive.titleIdCounter++;
                title.setAttribute("id", "sprout24-" + Sprout24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "sprout24-" + Sprout24Directive.titleIdCounter);
            }
        };
        Sprout24Directive.titleIdCounter = 0;
        Sprout24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconSprout24]"
                    },] },
        ];
        /** @nocollapse */
        Sprout24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Sprout24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Sprout24Directive;
    }());
    var Sprout24Module = /** @class */ (function () {
        function Sprout24Module() {
        }
        Sprout24Module.decorators = [
        ...
        return Sprout24Module;
    }());

    exports.Sprout24 = Sprout24;
    exports.Sprout24Directive = Sprout24Directive;
    exports.Sprout24Module = Sprout24Module;
