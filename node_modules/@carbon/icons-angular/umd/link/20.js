(function (global, factory) {
    ...
    var Link20 = /** @class */ (function () {
        function Link20() {
            this.focusable = false;
        }
        Link20.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-link20",
                        template: "\n    <svg\n      ibmIconLink20\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Link20.propDecorators = {
    ...
    var Link20Directive = /** @class */ (function () {
        function Link20Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Link20Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Link20Directive.titleIdCounter++;
                title.setAttribute("id", "link20-" + Link20Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "link20-" + Link20Directive.titleIdCounter);
            }
        };
        Link20Directive.titleIdCounter = 0;
        Link20Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconLink20]"
                    },] },
        ];
        /** @nocollapse */
        Link20Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Link20Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Link20Directive;
    }());
    var Link20Module = /** @class */ (function () {
        function Link20Module() {
        }
        Link20Module.decorators = [
    ...
    exports.Link20Directive = Link20Directive;
    exports.Link20Module = Link20Module;
