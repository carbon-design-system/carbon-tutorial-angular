(function (global, factory) {
    ...
    var Categories24 = /** @class */ (function () {
        function Categories24() {
            this.focusable = false;
        }
        Categories24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-categories24",
                        template: "\n    <svg\n      ibmIconCategories24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Categories24.propDecorators = {
    ...
    var Categories24Directive = /** @class */ (function () {
        ...
        Categories24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Categories24Directive.titleIdCounter++;
                title.setAttribute("id", "categories24-" + Categories24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "categories24-" + Categories24Directive.titleIdCounter);
            }
        };
        Categories24Directive.titleIdCounter = 0;
        Categories24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconCategories24]"
                    },] },
        ];
        /** @nocollapse */
        Categories24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Categories24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Categories24Directive;
    }());
    var Categories24Module = /** @class */ (function () {
        function Categories24Module() {
        }
        Categories24Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            Categories24,
                            Categories24Directive
                        ],
                        exports: [
                            Categories24,
                            Categories24Directive
        ...
        return Categories24Module;
    }());

    exports.Categories24 = Categories24;
    exports.Categories24Directive = Categories24Directive;
    exports.Categories24Module = Categories24Module;
