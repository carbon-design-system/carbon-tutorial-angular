(function (global, factory) {
    ...
    var VirtualMachine16 = /** @class */ (function () {
        function VirtualMachine16() {
            this.focusable = false;
        }
        VirtualMachine16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-virtual-machine16",
                        template: "\n    <svg\n      ibmIconVirtualMachine16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        VirtualMachine16.propDecorators = {
    ...
    var VirtualMachine16Directive = /** @class */ (function () {
        function VirtualMachine16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        VirtualMachine16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                VirtualMachine16Directive.titleIdCounter++;
                title.setAttribute("id", "virtual-machine16-" + VirtualMachine16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "virtual-machine16-" + VirtualMachine16Directive.titleIdCounter);
            }
        };
        VirtualMachine16Directive.titleIdCounter = 0;
        VirtualMachine16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconVirtualMachine16]"
                    },] },
        ];
        /** @nocollapse */
        VirtualMachine16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        VirtualMachine16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return VirtualMachine16Directive;
    }());
    var VirtualMachine16Module = /** @class */ (function () {
        function VirtualMachine16Module() {
        }
        VirtualMachine16Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            VirtualMachine16,
                            VirtualMachine16Directive
                        ],
                        exports: [
                            VirtualMachine16,
                            VirtualMachine16Directive
        ...
        return VirtualMachine16Module;
    }());

    exports.VirtualMachine16 = VirtualMachine16;
    exports.VirtualMachine16Directive = VirtualMachine16Directive;
    exports.VirtualMachine16Module = VirtualMachine16Module;
