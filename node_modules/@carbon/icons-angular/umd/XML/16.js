(function (global, factory) {
    ...
    var Xml16 = /** @class */ (function () {
        function Xml16() {
            this.focusable = false;
        }
        Xml16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-xml16",
                        template: "\n    <svg\n      ibmIconXml16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Xml16.propDecorators = {
    ...
    var Xml16Directive = /** @class */ (function () {
        function Xml16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Xml16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Xml16Directive.titleIdCounter++;
                title.setAttribute("id", "xml16-" + Xml16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "xml16-" + Xml16Directive.titleIdCounter);
            }
        };
        Xml16Directive.titleIdCounter = 0;
        Xml16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconXml16]"
                    },] },
        ];
        /** @nocollapse */
        Xml16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Xml16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Xml16Directive;
    }());
    var Xml16Module = /** @class */ (function () {
        function Xml16Module() {
        }
        Xml16Module.decorators = [
    ...
    exports.Xml16 = Xml16;
    exports.Xml16Directive = Xml16Directive;
    exports.Xml16Module = Xml16Module;
