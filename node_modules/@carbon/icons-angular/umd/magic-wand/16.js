(function (global, factory) {
    ...
    var MagicWand16 = /** @class */ (function () {
        function MagicWand16() {
            this.focusable = false;
        }
        MagicWand16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-magic-wand16",
                        template: "\n    <svg\n      ibmIconMagicWand16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        MagicWand16.propDecorators = {
    ...
    var MagicWand16Directive = /** @class */ (function () {
        function MagicWand16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        MagicWand16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                MagicWand16Directive.titleIdCounter++;
                title.setAttribute("id", "magic-wand16-" + MagicWand16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "magic-wand16-" + MagicWand16Directive.titleIdCounter);
            }
        };
        MagicWand16Directive.titleIdCounter = 0;
        MagicWand16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconMagicWand16]"
                    },] },
        ];
        /** @nocollapse */
        MagicWand16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        MagicWand16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return MagicWand16Directive;
    }());
    var MagicWand16Module = /** @class */ (function () {
        function MagicWand16Module() {
        }
        MagicWand16Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            MagicWand16,
                            MagicWand16Directive
                        ],
                        exports: [
                            MagicWand16,
                            MagicWand16Directive
        ...
        return MagicWand16Module;
    }());

    exports.MagicWand16 = MagicWand16;
    exports.MagicWand16Directive = MagicWand16Directive;
    exports.MagicWand16Module = MagicWand16Module;
