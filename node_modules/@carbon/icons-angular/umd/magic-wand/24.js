(function (global, factory) {
    ...
    var MagicWand24 = /** @class */ (function () {
        function MagicWand24() {
            this.focusable = false;
        }
        MagicWand24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-magic-wand24",
                        template: "\n    <svg\n      ibmIconMagicWand24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        MagicWand24.propDecorators = {
    ...
    var MagicWand24Directive = /** @class */ (function () {
        function MagicWand24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        MagicWand24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                MagicWand24Directive.titleIdCounter++;
                title.setAttribute("id", "magic-wand24-" + MagicWand24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "magic-wand24-" + MagicWand24Directive.titleIdCounter);
            }
        };
        MagicWand24Directive.titleIdCounter = 0;
        MagicWand24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconMagicWand24]"
                    },] },
        ];
        /** @nocollapse */
        MagicWand24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        MagicWand24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return MagicWand24Directive;
    }());
    var MagicWand24Module = /** @class */ (function () {
        function MagicWand24Module() {
        }
        MagicWand24Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            MagicWand24,
                            MagicWand24Directive
                        ],
                        exports: [
                            MagicWand24,
                            MagicWand24Directive
        ...
        return MagicWand24Module;
    }());

    exports.MagicWand24 = MagicWand24;
    exports.MagicWand24Directive = MagicWand24Directive;
    exports.MagicWand24Module = MagicWand24Module;
