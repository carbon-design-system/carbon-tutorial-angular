(function (global, factory) {
    ...
    var UnknownFilled16 = /** @class */ (function () {
        function UnknownFilled16() {
            this.focusable = false;
        }
        UnknownFilled16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-unknown-filled16",
                        template: "\n    <svg\n      ibmIconUnknownFilled16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        UnknownFilled16.propDecorators = {
        ...
        return UnknownFilled16;
    }());
    var UnknownFilled16Directive = /** @class */ (function () {
        function UnknownFilled16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        UnknownFilled16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                UnknownFilled16Directive.titleIdCounter++;
                title.setAttribute("id", "unknown-filled16-" + UnknownFilled16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "unknown-filled16-" + UnknownFilled16Directive.titleIdCounter);
            }
        };
        UnknownFilled16Directive.titleIdCounter = 0;
        UnknownFilled16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconUnknownFilled16]"
                    },] },
        ];
        /** @nocollapse */
        UnknownFilled16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        UnknownFilled16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return UnknownFilled16Directive;
    }());
    var UnknownFilled16Module = /** @class */ (function () {
        function UnknownFilled16Module() {
        }
        UnknownFilled16Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            UnknownFilled16,
                            UnknownFilled16Directive
                        ],
                        exports: [
                            UnknownFilled16,
                            UnknownFilled16Directive
        ...
        return UnknownFilled16Module;
    }());

    exports.UnknownFilled16 = UnknownFilled16;
    exports.UnknownFilled16Directive = UnknownFilled16Directive;
    exports.UnknownFilled16Module = UnknownFilled16Module;
