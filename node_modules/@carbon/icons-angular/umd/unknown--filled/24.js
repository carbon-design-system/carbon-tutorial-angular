(function (global, factory) {
    ...
    var UnknownFilled24 = /** @class */ (function () {
        function UnknownFilled24() {
            this.focusable = false;
        }
        UnknownFilled24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-unknown-filled24",
                        template: "\n    <svg\n      ibmIconUnknownFilled24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        UnknownFilled24.propDecorators = {
        ...
        return UnknownFilled24;
    }());
    var UnknownFilled24Directive = /** @class */ (function () {
        function UnknownFilled24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        UnknownFilled24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                UnknownFilled24Directive.titleIdCounter++;
                title.setAttribute("id", "unknown-filled24-" + UnknownFilled24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "unknown-filled24-" + UnknownFilled24Directive.titleIdCounter);
            }
        };
        UnknownFilled24Directive.titleIdCounter = 0;
        UnknownFilled24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconUnknownFilled24]"
                    },] },
        ];
        /** @nocollapse */
        UnknownFilled24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        UnknownFilled24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return UnknownFilled24Directive;
    }());
    var UnknownFilled24Module = /** @class */ (function () {
        function UnknownFilled24Module() {
        }
        UnknownFilled24Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            UnknownFilled24,
                            UnknownFilled24Directive
                        ],
                        exports: [
                            UnknownFilled24,
                            UnknownFilled24Directive
        ...
        return UnknownFilled24Module;
    }());

    exports.UnknownFilled24 = UnknownFilled24;
    exports.UnknownFilled24Directive = UnknownFilled24Directive;
    exports.UnknownFilled24Module = UnknownFilled24Module;
