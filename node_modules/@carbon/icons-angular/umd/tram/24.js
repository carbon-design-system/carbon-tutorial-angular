(function (global, factory) {
    ...
    var Tram24 = /** @class */ (function () {
        function Tram24() {
            this.focusable = false;
        }
        Tram24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-tram24",
                        template: "\n    <svg\n      ibmIconTram24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Tram24.propDecorators = {
    ...
    var Tram24Directive = /** @class */ (function () {
        function Tram24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Tram24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Tram24Directive.titleIdCounter++;
                title.setAttribute("id", "tram24-" + Tram24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "tram24-" + Tram24Directive.titleIdCounter);
            }
        };
        Tram24Directive.titleIdCounter = 0;
        Tram24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconTram24]"
                    },] },
        ];
        /** @nocollapse */
        Tram24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Tram24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Tram24Directive;
    }());
    var Tram24Module = /** @class */ (function () {
        function Tram24Module() {
        }
        Tram24Module.decorators = [
    ...
    exports.Tram24Directive = Tram24Directive;
    exports.Tram24Module = Tram24Module;
