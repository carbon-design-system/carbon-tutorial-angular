(function (global, factory) {
    ...
    var Tram16 = /** @class */ (function () {
        function Tram16() {
            this.focusable = false;
        }
        Tram16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-tram16",
                        template: "\n    <svg\n      ibmIconTram16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Tram16.propDecorators = {
    ...
    var Tram16Directive = /** @class */ (function () {
        function Tram16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Tram16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Tram16Directive.titleIdCounter++;
                title.setAttribute("id", "tram16-" + Tram16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "tram16-" + Tram16Directive.titleIdCounter);
            }
        };
        Tram16Directive.titleIdCounter = 0;
        Tram16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconTram16]"
                    },] },
        ];
        /** @nocollapse */
        Tram16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Tram16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Tram16Directive;
    }());
    var Tram16Module = /** @class */ (function () {
        function Tram16Module() {
        }
        Tram16Module.decorators = [
    ...
    exports.Tram16Directive = Tram16Directive;
    exports.Tram16Module = Tram16Module;
