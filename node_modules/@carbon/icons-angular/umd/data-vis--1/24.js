(function (global, factory) {
    ...
    var DataVis_124 = /** @class */ (function () {
        function DataVis_124() {
            this.focusable = false;
        }
        DataVis_124.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-data-vis-124",
                        template: "\n    <svg\n      ibmIconDataVis_124\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        DataVis_124.propDecorators = {
    ...
    var DataVis_124Directive = /** @class */ (function () {
        ...
        DataVis_124Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                DataVis_124Directive.titleIdCounter++;
                title.setAttribute("id", "data-vis-124-" + DataVis_124Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "data-vis-124-" + DataVis_124Directive.titleIdCounter);
            }
        };
        DataVis_124Directive.titleIdCounter = 0;
        DataVis_124Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconDataVis_124]"
                    },] },
        ];
        /** @nocollapse */
        DataVis_124Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        DataVis_124Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return DataVis_124Directive;
    }());
    var DataVis_124Module = /** @class */ (function () {
        function DataVis_124Module() {
        }
        DataVis_124Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            DataVis_124,
                            DataVis_124Directive
                        ],
                        exports: [
                            DataVis_124,
                            DataVis_124Directive
        ...
        return DataVis_124Module;
    }());

    exports.DataVis_124 = DataVis_124;
    exports.DataVis_124Directive = DataVis_124Directive;
    exports.DataVis_124Module = DataVis_124Module;
