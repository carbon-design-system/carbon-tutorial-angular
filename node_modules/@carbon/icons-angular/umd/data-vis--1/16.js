(function (global, factory) {
    ...
    var DataVis_116 = /** @class */ (function () {
        function DataVis_116() {
            this.focusable = false;
        }
        DataVis_116.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-data-vis-116",
                        template: "\n    <svg\n      ibmIconDataVis_116\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        DataVis_116.propDecorators = {
    ...
    var DataVis_116Directive = /** @class */ (function () {
        function DataVis_116Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        DataVis_116Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                DataVis_116Directive.titleIdCounter++;
                title.setAttribute("id", "data-vis-116-" + DataVis_116Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "data-vis-116-" + DataVis_116Directive.titleIdCounter);
            }
        };
        DataVis_116Directive.titleIdCounter = 0;
        DataVis_116Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconDataVis_116]"
                    },] },
        ];
        /** @nocollapse */
        DataVis_116Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        DataVis_116Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return DataVis_116Directive;
    }());
    var DataVis_116Module = /** @class */ (function () {
        function DataVis_116Module() {
        }
        DataVis_116Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            DataVis_116,
                            DataVis_116Directive
                        ],
                        exports: [
                            DataVis_116,
                            DataVis_116Directive
        ...
        return DataVis_116Module;
    }());

    exports.DataVis_116 = DataVis_116;
    exports.DataVis_116Directive = DataVis_116Directive;
    exports.DataVis_116Module = DataVis_116Module;
