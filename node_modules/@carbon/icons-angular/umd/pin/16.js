(function (global, factory) {
    ...
    var Pin16 = /** @class */ (function () {
        function Pin16() {
            this.focusable = false;
        }
        Pin16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-pin16",
                        template: "\n    <svg\n      ibmIconPin16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Pin16.propDecorators = {
    ...
    var Pin16Directive = /** @class */ (function () {
        function Pin16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Pin16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Pin16Directive.titleIdCounter++;
                title.setAttribute("id", "pin16-" + Pin16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "pin16-" + Pin16Directive.titleIdCounter);
            }
        };
        Pin16Directive.titleIdCounter = 0;
        Pin16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconPin16]"
                    },] },
        ];
        /** @nocollapse */
        Pin16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Pin16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Pin16Directive;
    }());
    var Pin16Module = /** @class */ (function () {
        function Pin16Module() {
        }
        Pin16Module.decorators = [
    ...
    exports.Pin16 = Pin16;
    exports.Pin16Directive = Pin16Directive;
    exports.Pin16Module = Pin16Module;
