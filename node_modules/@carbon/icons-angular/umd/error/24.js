(function (global, factory) {
    ...
    var Error24 = /** @class */ (function () {
        function Error24() {
            this.focusable = false;
        }
        Error24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-error24",
                        template: "\n    <svg\n      ibmIconError24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Error24.propDecorators = {
    ...
    var Error24Directive = /** @class */ (function () {
        function Error24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Error24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Error24Directive.titleIdCounter++;
                title.setAttribute("id", "error24-" + Error24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "error24-" + Error24Directive.titleIdCounter);
            }
        };
        Error24Directive.titleIdCounter = 0;
        Error24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconError24]"
                    },] },
        ];
        /** @nocollapse */
        Error24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Error24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Error24Directive;
    }());
    var Error24Module = /** @class */ (function () {
        function Error24Module() {
        }
        Error24Module.decorators = [
        ...
        return Error24Module;
    }());

    exports.Error24 = Error24;
    exports.Error24Directive = Error24Directive;
    exports.Error24Module = Error24Module;
