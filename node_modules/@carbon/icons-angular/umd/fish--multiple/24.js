(function (global, factory) {
    ...
    var FishMultiple24 = /** @class */ (function () {
        function FishMultiple24() {
            this.focusable = false;
        }
        FishMultiple24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-fish-multiple24",
                        template: "\n    <svg\n      ibmIconFishMultiple24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        FishMultiple24.propDecorators = {
        ...
        return FishMultiple24;
    }());
    var FishMultiple24Directive = /** @class */ (function () {
        function FishMultiple24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        FishMultiple24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                FishMultiple24Directive.titleIdCounter++;
                title.setAttribute("id", "fish-multiple24-" + FishMultiple24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "fish-multiple24-" + FishMultiple24Directive.titleIdCounter);
            }
        };
        FishMultiple24Directive.titleIdCounter = 0;
        FishMultiple24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconFishMultiple24]"
                    },] },
        ];
        /** @nocollapse */
        FishMultiple24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        FishMultiple24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return FishMultiple24Directive;
    }());
    var FishMultiple24Module = /** @class */ (function () {
        function FishMultiple24Module() {
        }
        FishMultiple24Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            FishMultiple24,
                            FishMultiple24Directive
                        ],
                        exports: [
                            FishMultiple24,
                            FishMultiple24Directive
        ...
        return FishMultiple24Module;
    }());

    exports.FishMultiple24 = FishMultiple24;
    exports.FishMultiple24Directive = FishMultiple24Directive;
    exports.FishMultiple24Module = FishMultiple24Module;
