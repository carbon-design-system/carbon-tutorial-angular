(function (global, factory) {
    ...
    var Nominal16 = /** @class */ (function () {
        function Nominal16() {
            this.focusable = false;
        }
        Nominal16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-nominal16",
                        template: "\n    <svg\n      ibmIconNominal16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Nominal16.propDecorators = {
    ...
    var Nominal16Directive = /** @class */ (function () {
        function Nominal16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Nominal16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Nominal16Directive.titleIdCounter++;
                title.setAttribute("id", "nominal16-" + Nominal16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "nominal16-" + Nominal16Directive.titleIdCounter);
            }
        };
        Nominal16Directive.titleIdCounter = 0;
        Nominal16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconNominal16]"
                    },] },
        ];
        /** @nocollapse */
        Nominal16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Nominal16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Nominal16Directive;
    }());
    var Nominal16Module = /** @class */ (function () {
        function Nominal16Module() {
        }
        Nominal16Module.decorators = [
        ...
        return Nominal16Module;
    }());

    exports.Nominal16 = Nominal16;
    exports.Nominal16Directive = Nominal16Directive;
    exports.Nominal16Module = Nominal16Module;
