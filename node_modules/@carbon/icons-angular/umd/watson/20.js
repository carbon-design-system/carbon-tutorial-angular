(function (global, factory) {
    ...
    var Watson20 = /** @class */ (function () {
        function Watson20() {
            this.focusable = false;
        }
        Watson20.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-watson20",
                        template: "\n    <svg\n      ibmIconWatson20\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Watson20.propDecorators = {
    ...
    var Watson20Directive = /** @class */ (function () {
        ...
        Watson20Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Watson20Directive.titleIdCounter++;
                title.setAttribute("id", "watson20-" + Watson20Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "watson20-" + Watson20Directive.titleIdCounter);
            }
        };
        Watson20Directive.titleIdCounter = 0;
        Watson20Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconWatson20]"
                    },] },
        ];
        /** @nocollapse */
        Watson20Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Watson20Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Watson20Directive;
    }());
    var Watson20Module = /** @class */ (function () {
        function Watson20Module() {
        }
        Watson20Module.decorators = [
        ...
        return Watson20Module;
    }());

    exports.Watson20 = Watson20;
    exports.Watson20Directive = Watson20Directive;
    exports.Watson20Module = Watson20Module;
