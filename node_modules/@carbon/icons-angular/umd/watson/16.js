(function (global, factory) {
    ...
    var Watson16 = /** @class */ (function () {
        function Watson16() {
            this.focusable = false;
        }
        Watson16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-watson16",
                        template: "\n    <svg\n      ibmIconWatson16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Watson16.propDecorators = {
    ...
    var Watson16Directive = /** @class */ (function () {
        function Watson16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Watson16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Watson16Directive.titleIdCounter++;
                title.setAttribute("id", "watson16-" + Watson16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "watson16-" + Watson16Directive.titleIdCounter);
            }
        };
        Watson16Directive.titleIdCounter = 0;
        Watson16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconWatson16]"
                    },] },
        ];
        /** @nocollapse */
        Watson16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Watson16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Watson16Directive;
    }());
    var Watson16Module = /** @class */ (function () {
        function Watson16Module() {
        }
        Watson16Module.decorators = [
        ...
        return Watson16Module;
    }());

    exports.Watson16 = Watson16;
    exports.Watson16Directive = Watson16Directive;
    exports.Watson16Module = Watson16Module;
