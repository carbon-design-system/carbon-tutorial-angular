(function (global, factory) {
    ...
    var Fade24 = /** @class */ (function () {
        function Fade24() {
            this.focusable = false;
        }
        Fade24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-fade24",
                        template: "\n    <svg\n      ibmIconFade24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Fade24.propDecorators = {
    ...
    var Fade24Directive = /** @class */ (function () {
        function Fade24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Fade24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Fade24Directive.titleIdCounter++;
                title.setAttribute("id", "fade24-" + Fade24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "fade24-" + Fade24Directive.titleIdCounter);
            }
        };
        Fade24Directive.titleIdCounter = 0;
        Fade24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconFade24]"
                    },] },
        ];
        /** @nocollapse */
        Fade24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Fade24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Fade24Directive;
    }());
    var Fade24Module = /** @class */ (function () {
        function Fade24Module() {
        }
        Fade24Module.decorators = [
    ...
    exports.Fade24Directive = Fade24Directive;
    exports.Fade24Module = Fade24Module;
