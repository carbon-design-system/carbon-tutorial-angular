(function (global, factory) {
    ...
    var IbmCloud16 = /** @class */ (function () {
        function IbmCloud16() {
            this.focusable = false;
        }
        IbmCloud16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-ibm-cloud16",
                        template: "\n    <svg\n      ibmIconIbmCloud16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        IbmCloud16.propDecorators = {
    ...
    var IbmCloud16Directive = /** @class */ (function () {
        ...
        IbmCloud16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                IbmCloud16Directive.titleIdCounter++;
                title.setAttribute("id", "ibm-cloud16-" + IbmCloud16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "ibm-cloud16-" + IbmCloud16Directive.titleIdCounter);
            }
        };
        IbmCloud16Directive.titleIdCounter = 0;
        IbmCloud16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconIbmCloud16]"
                    },] },
        ];
        /** @nocollapse */
        IbmCloud16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        IbmCloud16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return IbmCloud16Directive;
    }());
    var IbmCloud16Module = /** @class */ (function () {
        function IbmCloud16Module() {
        }
        IbmCloud16Module.decorators = [
        ...
        return IbmCloud16Module;
    }());

    exports.IbmCloud16 = IbmCloud16;
    exports.IbmCloud16Directive = IbmCloud16Directive;
    exports.IbmCloud16Module = IbmCloud16Module;
