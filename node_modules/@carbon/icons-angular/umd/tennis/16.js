(function (global, factory) {
    ...
    var Tennis16 = /** @class */ (function () {
        function Tennis16() {
            this.focusable = false;
        }
        Tennis16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-tennis16",
                        template: "\n    <svg\n      ibmIconTennis16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Tennis16.propDecorators = {
    ...
    var Tennis16Directive = /** @class */ (function () {
        function Tennis16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Tennis16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Tennis16Directive.titleIdCounter++;
                title.setAttribute("id", "tennis16-" + Tennis16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "tennis16-" + Tennis16Directive.titleIdCounter);
            }
        };
        Tennis16Directive.titleIdCounter = 0;
        Tennis16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconTennis16]"
                    },] },
        ];
        /** @nocollapse */
        Tennis16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Tennis16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Tennis16Directive;
    }());
    var Tennis16Module = /** @class */ (function () {
        function Tennis16Module() {
        }
        Tennis16Module.decorators = [
        ...
        return Tennis16Module;
    }());

    exports.Tennis16 = Tennis16;
    exports.Tennis16Directive = Tennis16Directive;
    exports.Tennis16Module = Tennis16Module;
