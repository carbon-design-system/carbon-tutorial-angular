(function (global, factory) {
    ...
    var Tennis24 = /** @class */ (function () {
        function Tennis24() {
            this.focusable = false;
        }
        Tennis24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-tennis24",
                        template: "\n    <svg\n      ibmIconTennis24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Tennis24.propDecorators = {
    ...
    var Tennis24Directive = /** @class */ (function () {
        function Tennis24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Tennis24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Tennis24Directive.titleIdCounter++;
                title.setAttribute("id", "tennis24-" + Tennis24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "tennis24-" + Tennis24Directive.titleIdCounter);
            }
        };
        Tennis24Directive.titleIdCounter = 0;
        Tennis24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconTennis24]"
                    },] },
        ];
        /** @nocollapse */
        Tennis24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Tennis24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Tennis24Directive;
    }());
    var Tennis24Module = /** @class */ (function () {
        function Tennis24Module() {
        }
        Tennis24Module.decorators = [
        ...
        return Tennis24Module;
    }());

    exports.Tennis24 = Tennis24;
    exports.Tennis24Directive = Tennis24Directive;
    exports.Tennis24Module = Tennis24Module;
