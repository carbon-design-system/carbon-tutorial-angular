(function (global, factory) {
    ...
    var Favorite24 = /** @class */ (function () {
        function Favorite24() {
            this.focusable = false;
        }
        Favorite24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-favorite24",
                        template: "\n    <svg\n      ibmIconFavorite24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Favorite24.propDecorators = {
    ...
    var Favorite24Directive = /** @class */ (function () {
        function Favorite24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Favorite24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Favorite24Directive.titleIdCounter++;
                title.setAttribute("id", "favorite24-" + Favorite24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "favorite24-" + Favorite24Directive.titleIdCounter);
            }
        };
        Favorite24Directive.titleIdCounter = 0;
        Favorite24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconFavorite24]"
                    },] },
        ];
        /** @nocollapse */
        Favorite24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Favorite24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Favorite24Directive;
    }());
    var Favorite24Module = /** @class */ (function () {
        function Favorite24Module() {
        }
        Favorite24Module.decorators = [
        ...
        return Favorite24Module;
    }());

    exports.Favorite24 = Favorite24;
    exports.Favorite24Directive = Favorite24Directive;
    exports.Favorite24Module = Favorite24Module;
