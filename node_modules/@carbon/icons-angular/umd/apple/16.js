(function (global, factory) {
    ...
    var Apple16 = /** @class */ (function () {
        function Apple16() {
            this.focusable = false;
        }
        Apple16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-apple16",
                        template: "\n    <svg\n      ibmIconApple16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Apple16.propDecorators = {
    ...
    var Apple16Directive = /** @class */ (function () {
        function Apple16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Apple16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Apple16Directive.titleIdCounter++;
                title.setAttribute("id", "apple16-" + Apple16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "apple16-" + Apple16Directive.titleIdCounter);
            }
        };
        Apple16Directive.titleIdCounter = 0;
        Apple16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconApple16]"
                    },] },
        ];
        /** @nocollapse */
        Apple16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Apple16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Apple16Directive;
    }());
    var Apple16Module = /** @class */ (function () {
        function Apple16Module() {
        }
        Apple16Module.decorators = [
        ...
        return Apple16Module;
    }());

    exports.Apple16 = Apple16;
    exports.Apple16Directive = Apple16Directive;
    exports.Apple16Module = Apple16Module;
