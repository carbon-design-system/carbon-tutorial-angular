(function (global, factory) {
    ...
    var Apple24 = /** @class */ (function () {
        function Apple24() {
            this.focusable = false;
        }
        Apple24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-apple24",
                        template: "\n    <svg\n      ibmIconApple24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Apple24.propDecorators = {
    ...
    var Apple24Directive = /** @class */ (function () {
        function Apple24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Apple24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Apple24Directive.titleIdCounter++;
                title.setAttribute("id", "apple24-" + Apple24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "apple24-" + Apple24Directive.titleIdCounter);
            }
        };
        Apple24Directive.titleIdCounter = 0;
        Apple24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconApple24]"
                    },] },
        ];
        /** @nocollapse */
        Apple24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Apple24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Apple24Directive;
    }());
    var Apple24Module = /** @class */ (function () {
        function Apple24Module() {
        }
        Apple24Module.decorators = [
        ...
        return Apple24Module;
    }());

    exports.Apple24 = Apple24;
    exports.Apple24Directive = Apple24Directive;
    exports.Apple24Module = Apple24Module;
