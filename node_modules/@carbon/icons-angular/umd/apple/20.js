(function (global, factory) {
    ...
    var Apple20 = /** @class */ (function () {
        function Apple20() {
            this.focusable = false;
        }
        Apple20.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-apple20",
                        template: "\n    <svg\n      ibmIconApple20\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Apple20.propDecorators = {
    ...
    var Apple20Directive = /** @class */ (function () {
        function Apple20Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Apple20Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Apple20Directive.titleIdCounter++;
                title.setAttribute("id", "apple20-" + Apple20Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "apple20-" + Apple20Directive.titleIdCounter);
            }
        };
        Apple20Directive.titleIdCounter = 0;
        Apple20Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconApple20]"
                    },] },
        ];
        /** @nocollapse */
        Apple20Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Apple20Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Apple20Directive;
    }());
    var Apple20Module = /** @class */ (function () {
        function Apple20Module() {
        }
        Apple20Module.decorators = [
        ...
        return Apple20Module;
    }());

    exports.Apple20 = Apple20;
    exports.Apple20Directive = Apple20Directive;
    exports.Apple20Module = Apple20Module;
