(function (global, factory) {
    ...
    var Bicycle24 = /** @class */ (function () {
        function Bicycle24() {
            this.focusable = false;
        }
        Bicycle24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-bicycle24",
                        template: "\n    <svg\n      ibmIconBicycle24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Bicycle24.propDecorators = {
    ...
    var Bicycle24Directive = /** @class */ (function () {
        function Bicycle24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Bicycle24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Bicycle24Directive.titleIdCounter++;
                title.setAttribute("id", "bicycle24-" + Bicycle24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "bicycle24-" + Bicycle24Directive.titleIdCounter);
            }
        };
        Bicycle24Directive.titleIdCounter = 0;
        Bicycle24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconBicycle24]"
                    },] },
        ];
        /** @nocollapse */
        Bicycle24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Bicycle24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Bicycle24Directive;
    }());
    var Bicycle24Module = /** @class */ (function () {
        function Bicycle24Module() {
        }
        Bicycle24Module.decorators = [
        ...
        return Bicycle24Module;
    }());

    exports.Bicycle24 = Bicycle24;
    exports.Bicycle24Directive = Bicycle24Directive;
    exports.Bicycle24Module = Bicycle24Module;
