(function (global, factory) {
    ...
    var Bicycle32 = /** @class */ (function () {
        function Bicycle32() {
            this.focusable = false;
        }
        Bicycle32.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-bicycle32",
                        template: "\n    <svg\n      ibmIconBicycle32\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Bicycle32.propDecorators = {
    ...
    var Bicycle32Directive = /** @class */ (function () {
        ...
        Bicycle32Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Bicycle32Directive.titleIdCounter++;
                title.setAttribute("id", "bicycle32-" + Bicycle32Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "bicycle32-" + Bicycle32Directive.titleIdCounter);
            }
        };
        Bicycle32Directive.titleIdCounter = 0;
        Bicycle32Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconBicycle32]"
                    },] },
        ];
        /** @nocollapse */
        Bicycle32Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Bicycle32Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Bicycle32Directive;
    }());
    var Bicycle32Module = /** @class */ (function () {
        function Bicycle32Module() {
        }
        Bicycle32Module.decorators = [
        ...
        return Bicycle32Module;
    }());

    exports.Bicycle32 = Bicycle32;
    exports.Bicycle32Directive = Bicycle32Directive;
    exports.Bicycle32Module = Bicycle32Module;
