(function (global, factory) {
    ...
    var Tree32 = /** @class */ (function () {
        function Tree32() {
            this.focusable = false;
        }
        Tree32.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-tree32",
                        template: "\n    <svg\n      ibmIconTree32\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Tree32.propDecorators = {
    ...
    var Tree32Directive = /** @class */ (function () {
        ...
        Tree32Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Tree32Directive.titleIdCounter++;
                title.setAttribute("id", "tree32-" + Tree32Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "tree32-" + Tree32Directive.titleIdCounter);
            }
        };
        Tree32Directive.titleIdCounter = 0;
        Tree32Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconTree32]"
                    },] },
        ];
        /** @nocollapse */
        Tree32Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Tree32Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Tree32Directive;
    }());
    var Tree32Module = /** @class */ (function () {
        function Tree32Module() {
        }
        Tree32Module.decorators = [
    ...
    exports.Tree32Directive = Tree32Directive;
    exports.Tree32Module = Tree32Module;
