(function (global, factory) {
    ...
    var Tree20 = /** @class */ (function () {
        function Tree20() {
            this.focusable = false;
        }
        Tree20.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-tree20",
                        template: "\n    <svg\n      ibmIconTree20\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Tree20.propDecorators = {
    ...
    var Tree20Directive = /** @class */ (function () {
        ...
        Tree20Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Tree20Directive.titleIdCounter++;
                title.setAttribute("id", "tree20-" + Tree20Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "tree20-" + Tree20Directive.titleIdCounter);
            }
        };
        Tree20Directive.titleIdCounter = 0;
        Tree20Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconTree20]"
                    },] },
        ];
        /** @nocollapse */
        Tree20Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Tree20Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Tree20Directive;
    }());
    var Tree20Module = /** @class */ (function () {
        function Tree20Module() {
        }
        Tree20Module.decorators = [
    ...
    exports.Tree20Directive = Tree20Directive;
    exports.Tree20Module = Tree20Module;
