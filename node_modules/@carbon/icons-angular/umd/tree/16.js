(function (global, factory) {
    ...
    var Tree16 = /** @class */ (function () {
        function Tree16() {
            this.focusable = false;
        }
        Tree16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-tree16",
                        template: "\n    <svg\n      ibmIconTree16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Tree16.propDecorators = {
    ...
    var Tree16Directive = /** @class */ (function () {
        function Tree16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Tree16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Tree16Directive.titleIdCounter++;
                title.setAttribute("id", "tree16-" + Tree16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "tree16-" + Tree16Directive.titleIdCounter);
            }
        };
        Tree16Directive.titleIdCounter = 0;
        Tree16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconTree16]"
                    },] },
        ];
        /** @nocollapse */
        Tree16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Tree16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Tree16Directive;
    }());
    var Tree16Module = /** @class */ (function () {
        function Tree16Module() {
        }
        Tree16Module.decorators = [
    ...
    exports.Tree16Directive = Tree16Directive;
    exports.Tree16Module = Tree16Module;
