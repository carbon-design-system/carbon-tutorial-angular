(function (global, factory) {
    ...
    var PartlyCloudy16 = /** @class */ (function () {
        function PartlyCloudy16() {
            this.focusable = false;
        }
        PartlyCloudy16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-partly-cloudy16",
                        template: "\n    <svg\n      ibmIconPartlyCloudy16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        PartlyCloudy16.propDecorators = {
        ...
        return PartlyCloudy16;
    }());
    var PartlyCloudy16Directive = /** @class */ (function () {
        function PartlyCloudy16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        PartlyCloudy16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                PartlyCloudy16Directive.titleIdCounter++;
                title.setAttribute("id", "partly-cloudy16-" + PartlyCloudy16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "partly-cloudy16-" + PartlyCloudy16Directive.titleIdCounter);
            }
        };
        PartlyCloudy16Directive.titleIdCounter = 0;
        PartlyCloudy16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconPartlyCloudy16]"
                    },] },
        ];
        /** @nocollapse */
        PartlyCloudy16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        PartlyCloudy16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return PartlyCloudy16Directive;
    }());
    var PartlyCloudy16Module = /** @class */ (function () {
        function PartlyCloudy16Module() {
        }
        PartlyCloudy16Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            PartlyCloudy16,
                            PartlyCloudy16Directive
                        ],
                        exports: [
                            PartlyCloudy16,
                            PartlyCloudy16Directive
        ...
        return PartlyCloudy16Module;
    }());

    exports.PartlyCloudy16 = PartlyCloudy16;
    exports.PartlyCloudy16Directive = PartlyCloudy16Directive;
    exports.PartlyCloudy16Module = PartlyCloudy16Module;
