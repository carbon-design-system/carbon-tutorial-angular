(function (global, factory) {
    ...
    var Cut16 = /** @class */ (function () {
        function Cut16() {
            this.focusable = false;
        }
        Cut16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-cut16",
                        template: "\n    <svg\n      ibmIconCut16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Cut16.propDecorators = {
    ...
    var Cut16Directive = /** @class */ (function () {
        function Cut16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Cut16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Cut16Directive.titleIdCounter++;
                title.setAttribute("id", "cut16-" + Cut16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "cut16-" + Cut16Directive.titleIdCounter);
            }
        };
        Cut16Directive.titleIdCounter = 0;
        Cut16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconCut16]"
                    },] },
        ];
        /** @nocollapse */
        Cut16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Cut16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Cut16Directive;
    }());
    var Cut16Module = /** @class */ (function () {
        function Cut16Module() {
        }
        Cut16Module.decorators = [
    ...
    exports.Cut16 = Cut16;
    exports.Cut16Directive = Cut16Directive;
    exports.Cut16Module = Cut16Module;
