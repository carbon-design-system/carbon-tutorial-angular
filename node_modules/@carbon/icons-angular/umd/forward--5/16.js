(function (global, factory) {
    ...
    var Forward_516 = /** @class */ (function () {
        function Forward_516() {
            this.focusable = false;
        }
        Forward_516.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-forward-516",
                        template: "\n    <svg\n      ibmIconForward_516\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Forward_516.propDecorators = {
    ...
    var Forward_516Directive = /** @class */ (function () {
        function Forward_516Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Forward_516Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Forward_516Directive.titleIdCounter++;
                title.setAttribute("id", "forward-516-" + Forward_516Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "forward-516-" + Forward_516Directive.titleIdCounter);
            }
        };
        Forward_516Directive.titleIdCounter = 0;
        Forward_516Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconForward_516]"
                    },] },
        ];
        /** @nocollapse */
        Forward_516Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Forward_516Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Forward_516Directive;
    }());
    var Forward_516Module = /** @class */ (function () {
        function Forward_516Module() {
        }
        Forward_516Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            Forward_516,
                            Forward_516Directive
                        ],
                        exports: [
                            Forward_516,
                            Forward_516Directive
        ...
        return Forward_516Module;
    }());

    exports.Forward_516 = Forward_516;
    exports.Forward_516Directive = Forward_516Directive;
    exports.Forward_516Module = Forward_516Module;
