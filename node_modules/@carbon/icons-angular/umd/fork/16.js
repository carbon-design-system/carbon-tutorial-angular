(function (global, factory) {
    ...
    var Fork16 = /** @class */ (function () {
        function Fork16() {
            this.focusable = false;
        }
        Fork16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-fork16",
                        template: "\n    <svg\n      ibmIconFork16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Fork16.propDecorators = {
    ...
    var Fork16Directive = /** @class */ (function () {
        function Fork16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Fork16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Fork16Directive.titleIdCounter++;
                title.setAttribute("id", "fork16-" + Fork16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "fork16-" + Fork16Directive.titleIdCounter);
            }
        };
        Fork16Directive.titleIdCounter = 0;
        Fork16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconFork16]"
                    },] },
        ];
        /** @nocollapse */
        Fork16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Fork16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Fork16Directive;
    }());
    var Fork16Module = /** @class */ (function () {
        function Fork16Module() {
        }
        Fork16Module.decorators = [
    ...
    exports.Fork16Directive = Fork16Directive;
    exports.Fork16Module = Fork16Module;
