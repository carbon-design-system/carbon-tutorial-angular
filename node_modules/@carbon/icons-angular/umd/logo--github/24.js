(function (global, factory) {
    ...
    var LogoGithub24 = /** @class */ (function () {
        function LogoGithub24() {
            this.focusable = false;
        }
        LogoGithub24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-logo-github24",
                        template: "\n    <svg\n      ibmIconLogoGithub24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        LogoGithub24.propDecorators = {
    ...
    var LogoGithub24Directive = /** @class */ (function () {
        function LogoGithub24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        LogoGithub24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                LogoGithub24Directive.titleIdCounter++;
                title.setAttribute("id", "logo-github24-" + LogoGithub24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "logo-github24-" + LogoGithub24Directive.titleIdCounter);
            }
        };
        LogoGithub24Directive.titleIdCounter = 0;
        LogoGithub24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconLogoGithub24]"
                    },] },
        ];
        /** @nocollapse */
        LogoGithub24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        LogoGithub24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return LogoGithub24Directive;
    }());
    var LogoGithub24Module = /** @class */ (function () {
        function LogoGithub24Module() {
        }
        LogoGithub24Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            LogoGithub24,
                            LogoGithub24Directive
                        ],
                        exports: [
                            LogoGithub24,
                            LogoGithub24Directive
        ...
        return LogoGithub24Module;
    }());

    exports.LogoGithub24 = LogoGithub24;
    exports.LogoGithub24Directive = LogoGithub24Directive;
    exports.LogoGithub24Module = LogoGithub24Module;
