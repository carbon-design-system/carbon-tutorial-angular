(function (global, factory) {
    ...
    var LogoSnapchat16 = /** @class */ (function () {
        function LogoSnapchat16() {
            this.focusable = false;
        }
        LogoSnapchat16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-logo-snapchat16",
                        template: "\n    <svg\n      ibmIconLogoSnapchat16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        LogoSnapchat16.propDecorators = {
        ...
        return LogoSnapchat16;
    }());
    var LogoSnapchat16Directive = /** @class */ (function () {
        function LogoSnapchat16Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        LogoSnapchat16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                LogoSnapchat16Directive.titleIdCounter++;
                title.setAttribute("id", "logo-snapchat16-" + LogoSnapchat16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "logo-snapchat16-" + LogoSnapchat16Directive.titleIdCounter);
            }
        };
        LogoSnapchat16Directive.titleIdCounter = 0;
        LogoSnapchat16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconLogoSnapchat16]"
                    },] },
        ];
        /** @nocollapse */
        LogoSnapchat16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        LogoSnapchat16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return LogoSnapchat16Directive;
    }());
    var LogoSnapchat16Module = /** @class */ (function () {
        function LogoSnapchat16Module() {
        }
        LogoSnapchat16Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            LogoSnapchat16,
                            LogoSnapchat16Directive
                        ],
                        exports: [
                            LogoSnapchat16,
                            LogoSnapchat16Directive
        ...
        return LogoSnapchat16Module;
    }());

    exports.LogoSnapchat16 = LogoSnapchat16;
    exports.LogoSnapchat16Directive = LogoSnapchat16Directive;
    exports.LogoSnapchat16Module = LogoSnapchat16Module;
