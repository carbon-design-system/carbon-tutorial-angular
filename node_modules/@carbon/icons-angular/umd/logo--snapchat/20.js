(function (global, factory) {
    ...
    var LogoSnapchat20 = /** @class */ (function () {
        function LogoSnapchat20() {
            this.focusable = false;
        }
        LogoSnapchat20.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-logo-snapchat20",
                        template: "\n    <svg\n      ibmIconLogoSnapchat20\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        LogoSnapchat20.propDecorators = {
        ...
        return LogoSnapchat20;
    }());
    var LogoSnapchat20Directive = /** @class */ (function () {
        function LogoSnapchat20Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        LogoSnapchat20Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                LogoSnapchat20Directive.titleIdCounter++;
                title.setAttribute("id", "logo-snapchat20-" + LogoSnapchat20Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "logo-snapchat20-" + LogoSnapchat20Directive.titleIdCounter);
            }
        };
        LogoSnapchat20Directive.titleIdCounter = 0;
        LogoSnapchat20Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconLogoSnapchat20]"
                    },] },
        ];
        /** @nocollapse */
        LogoSnapchat20Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        LogoSnapchat20Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return LogoSnapchat20Directive;
    }());
    var LogoSnapchat20Module = /** @class */ (function () {
        function LogoSnapchat20Module() {
        }
        LogoSnapchat20Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            LogoSnapchat20,
                            LogoSnapchat20Directive
                        ],
                        exports: [
                            LogoSnapchat20,
                            LogoSnapchat20Directive
        ...
        return LogoSnapchat20Module;
    }());

    exports.LogoSnapchat20 = LogoSnapchat20;
    exports.LogoSnapchat20Directive = LogoSnapchat20Directive;
    exports.LogoSnapchat20Module = LogoSnapchat20Module;
