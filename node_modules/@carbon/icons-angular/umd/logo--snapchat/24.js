(function (global, factory) {
    ...
    var LogoSnapchat24 = /** @class */ (function () {
        function LogoSnapchat24() {
            this.focusable = false;
        }
        LogoSnapchat24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-logo-snapchat24",
                        template: "\n    <svg\n      ibmIconLogoSnapchat24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        LogoSnapchat24.propDecorators = {
        ...
        return LogoSnapchat24;
    }());
    var LogoSnapchat24Directive = /** @class */ (function () {
        function LogoSnapchat24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        LogoSnapchat24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                LogoSnapchat24Directive.titleIdCounter++;
                title.setAttribute("id", "logo-snapchat24-" + LogoSnapchat24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "logo-snapchat24-" + LogoSnapchat24Directive.titleIdCounter);
            }
        };
        LogoSnapchat24Directive.titleIdCounter = 0;
        LogoSnapchat24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconLogoSnapchat24]"
                    },] },
        ];
        /** @nocollapse */
        LogoSnapchat24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        LogoSnapchat24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return LogoSnapchat24Directive;
    }());
    var LogoSnapchat24Module = /** @class */ (function () {
        function LogoSnapchat24Module() {
        }
        LogoSnapchat24Module.decorators = [
            { type: core.NgModule, args: [{
                        declarations: [
                            LogoSnapchat24,
                            LogoSnapchat24Directive
                        ],
                        exports: [
                            LogoSnapchat24,
                            LogoSnapchat24Directive
        ...
        return LogoSnapchat24Module;
    }());

    exports.LogoSnapchat24 = LogoSnapchat24;
    exports.LogoSnapchat24Directive = LogoSnapchat24Directive;
    exports.LogoSnapchat24Module = LogoSnapchat24Module;
