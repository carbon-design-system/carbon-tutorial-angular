(function (global, factory) {
    ...
    var ViewOff16 = /** @class */ (function () {
        function ViewOff16() {
            this.focusable = false;
        }
        ViewOff16.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-view-off16",
                        template: "\n    <svg\n      ibmIconViewOff16\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        ViewOff16.propDecorators = {
    ...
    var ViewOff16Directive = /** @class */ (function () {
        ...
        ViewOff16Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                ViewOff16Directive.titleIdCounter++;
                title.setAttribute("id", "view-off16-" + ViewOff16Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "view-off16-" + ViewOff16Directive.titleIdCounter);
            }
        };
        ViewOff16Directive.titleIdCounter = 0;
        ViewOff16Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconViewOff16]"
                    },] },
        ];
        /** @nocollapse */
        ViewOff16Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        ViewOff16Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return ViewOff16Directive;
    }());
    var ViewOff16Module = /** @class */ (function () {
        function ViewOff16Module() {
        }
        ViewOff16Module.decorators = [
        ...
        return ViewOff16Module;
    }());

    exports.ViewOff16 = ViewOff16;
    exports.ViewOff16Directive = ViewOff16Directive;
    exports.ViewOff16Module = ViewOff16Module;
