(function (global, factory) {
    ...
    var Video24 = /** @class */ (function () {
        function Video24() {
            this.focusable = false;
        }
        Video24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-video24",
                        template: "\n    <svg\n      ibmIconVideo24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Video24.propDecorators = {
    ...
    var Video24Directive = /** @class */ (function () {
        function Video24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Video24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Video24Directive.titleIdCounter++;
                title.setAttribute("id", "video24-" + Video24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "video24-" + Video24Directive.titleIdCounter);
            }
        };
        Video24Directive.titleIdCounter = 0;
        Video24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconVideo24]"
                    },] },
        ];
        /** @nocollapse */
        Video24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Video24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Video24Directive;
    }());
    var Video24Module = /** @class */ (function () {
        function Video24Module() {
        }
        Video24Module.decorators = [
        ...
        return Video24Module;
    }());

    exports.Video24 = Video24;
    exports.Video24Directive = Video24Directive;
    exports.Video24Module = Video24Module;
