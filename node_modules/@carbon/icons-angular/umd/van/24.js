(function (global, factory) {
    ...
    var Van24 = /** @class */ (function () {
        function Van24() {
            this.focusable = false;
        }
        Van24.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-van24",
                        template: "\n    <svg\n      ibmIconVan24\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Van24.propDecorators = {
    ...
    var Van24Directive = /** @class */ (function () {
        function Van24Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Van24Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Van24Directive.titleIdCounter++;
                title.setAttribute("id", "van24-" + Van24Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "van24-" + Van24Directive.titleIdCounter);
            }
        };
        Van24Directive.titleIdCounter = 0;
        Van24Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconVan24]"
                    },] },
        ];
        /** @nocollapse */
        Van24Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Van24Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Van24Directive;
    }());
    var Van24Module = /** @class */ (function () {
        function Van24Module() {
        }
        Van24Module.decorators = [
    ...
    exports.Van24 = Van24;
    exports.Van24Directive = Van24Directive;
    exports.Van24Module = Van24Module;
