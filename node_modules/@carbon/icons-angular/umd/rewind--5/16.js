(function (global, factory) {
    ...
    var Rewind_516 = /** @class */ (function () {
        function Rewind_516() {
            this.focusable = false;
        }
        Rewind_516.decorators = [
            { type: core.Component, args: [{
                        selector: "ibm-icon-rewind-516",
                        template: "\n    <svg\n      ibmIconRewind_516\n      [ariaLabel]=\"ariaLabel\"\n      [ariaLabelledby]=\"ariaLabelledby\"\n      [ariaHidden]=\"ariaHidden\"\n      [title]=\"title\"\n      [isFocusable]=\"focusable\"\n      [attr.class]=\"innerClass\">\n    </svg>\n  "
                    },] },
        ];
        Rewind_516.propDecorators = {
    ...
    var Rewind_516Directive = /** @class */ (function () {
        function Rewind_516Directive(elementRef) {
            this.elementRef = elementRef;
            this.isFocusable = false;
        }
        Rewind_516Directive.prototype.ngAfterViewInit = function () {
            ...
            if (attributes.title) {
                ...
                Rewind_516Directive.titleIdCounter++;
                title.setAttribute("id", "rewind-516-" + Rewind_516Directive.titleIdCounter);
                svg.appendChild(title);
                svg.setAttribute("aria-labelledby", "rewind-516-" + Rewind_516Directive.titleIdCounter);
            }
        };
        Rewind_516Directive.titleIdCounter = 0;
        Rewind_516Directive.decorators = [
            { type: core.Directive, args: [{
                        selector: "[ibmIconRewind_516]"
                    },] },
        ];
        /** @nocollapse */
        Rewind_516Directive.ctorParameters = function () { return [
            { type: core.ElementRef }
        ]; };
        Rewind_516Directive.propDecorators = {
            ariaLabel: [{ type: core.Input }],
            ariaLabelledby: [{ type: core.Input }],
            ariaHidden: [{ type: core.Input }],
            title: [{ type: core.Input }],
        ...
        return Rewind_516Directive;
    }());
    var Rewind_516Module = /** @class */ (function () {
        function Rewind_516Module() {
        }
        Rewind_516Module.decorators = [
        ...
        return Rewind_516Module;
    }());

    exports.Rewind_516 = Rewind_516;
    exports.Rewind_516Directive = Rewind_516Directive;
    exports.Rewind_516Module = Rewind_516Module;
