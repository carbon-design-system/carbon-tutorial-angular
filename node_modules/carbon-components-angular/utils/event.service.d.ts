...
export declare const getEventObservable: (targetElement: Element | HTMLElement, eventType: string) => Observable<Event>;
export declare class EventService implements OnDestroy {
    protected documentService: DocumentService;
    protected subscriptions: Subscription;
    protected targets: WeakMap<Element | HTMLElement | Document, Map<string, Observable<Event>>>;
