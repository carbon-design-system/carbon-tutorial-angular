...
export declare class Slider implements AfterViewInit, ControlValueAccessor {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<Slider, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<Slider, "ibm-slider", never, { "step": "step"; "id": "id"; "shiftMultiplier": "shiftMultiplier"; "skeleton": "skeleton"; "disableArrowKeys": "disableArrowKeys"; "min": "min"; "value": "value"; "max": "max"; "disabled": "disabled"; "label": "label"; }, { "valueChange": "valueChange"; }, never, ["[minLabel]", "[maxLabel]", "input"]>;
}
