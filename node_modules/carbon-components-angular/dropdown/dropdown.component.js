...
var Dropdown = /** @class */ (function () {
    ...
    Dropdown.prototype.ngAfterContentInit = function () {
        ...
        this.view.select.subscribe(function (event) {
            if (_this.type === "multi") {
                ...
                if (_this.value && _this.view.getSelected()) {
                    var values = _this.view.getSelected().map(function (item) { return item[_this.value]; });
        ...
        if (!value) {
            ...
            if (this.value) {
                ...
                for (var _i = 0, value_1 = value; _i < value_1.length; _i++) {
                    var v = value_1[_i];
                    for (var _a = 0, _b = this.view.getListItems(); _a < _b.length; _a++) {
                        var item = _b[_a];
    ...
    Dropdown.prototype.clearSelected = function () {
        ...
        for (var _i = 0, _a = this.view.getListItems(); _i < _a.length; _i++) {
            var item = _a[_i];
            item.selected = false;
        }
        this.selected.emit([]);
