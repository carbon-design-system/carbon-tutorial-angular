...
import { QueryList, AfterContentInit, ElementRef, TemplateRef, OnChanges, SimpleChanges } from "@angular/core";
import { Tab } from "./tab.component";
/**
 * The `TabHeaders` component contains the `Tab` items and controls scroll functionality
 * if content has overflow.
 */
export declare class TabHeaders implements AfterContentInit, OnChanges {
    ...
    tabDropdownKeydown(event: KeyboardEvent): void;
    /**
