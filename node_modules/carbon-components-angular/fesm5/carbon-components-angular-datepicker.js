...
var DatePicker = /** @class */ (function () {
    ...
    DatePicker.prototype.ngOnChanges = function (changes) {
        ...
        if (changeKeys.some(function (key) { return flatpickrChangeKeys.includes(key); })) {
     ...
     */
    DatePicker.prototype.resetFlatpickrInstance = function (newDates) {
        if (this.isFlatpickrLoaded()) {
