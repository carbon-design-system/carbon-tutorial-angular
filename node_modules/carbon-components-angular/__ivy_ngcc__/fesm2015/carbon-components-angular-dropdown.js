...
function Dropdown_div_16_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵtemplate(2, Dropdown_div_16_2_Template, 1, 1, undefined, 6);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
const _c10 = function (a0, a1, a2) { return { "bx--list-box__menu-item--active": a0, "bx--list-box__menu-item--highlighted": a1, disabled: a2 }; };
function DropdownList_li_2_Template(rf, ctx) { if (rf & 1) {
    const _r14 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "li", 3);
    ɵngcc0.ɵɵlistener("click", function DropdownList_li_2_Template_li_click_0_listener($event) { const restoredCtx = ɵngcc0.ɵɵrestoreView(_r14); const item_r2 = restoredCtx.$implicit; const ctx_r13 = ɵngcc0.ɵɵnextContext(); return ctx_r13.doClick($event, item_r2); });
    ...
    ɵngcc0.ɵɵproperty("id", ctx_r1.getItemId(i_r3))("ngClass", ɵngcc0.ɵɵpureFunction3(7, _c10, item_r2.selected, ctx_r1.highlightedItem === ctx_r1.getItemId(i_r3), item_r2.disabled));
    ɵngcc0.ɵɵattribute("aria-selected", item_r2.selected);
    ɵngcc0.ɵɵadvance(3);
...
Dropdown.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: Dropdown, selectors: [["ibm-dropdown"]], contentQueries: function Dropdown_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ])], ngContentSelectors: _c6, decls: 17, vars: 36, consts: [["class", "bx--label", 3, "for", 4, "ngIf"], [1, "bx--list-box", 3, "ngClass"], ["type", "button", "aria-haspopup", "listbox", 1, "bx--list-box__field", 3, "id", "ngClass", "click", "blur"], ["dropdownButton", ""], ["class", "bx--list-box__selection bx--tag--filter bx--list-box__selection--multi", "tabindex", "0", 3, "title", "click", "keydown.enter", 4, "ngIf"], ["class", "bx--list-box__label", 4, "ngIf"], [4, "ngIf"], ["class", "bx--dropdown__invalid-icon", "ibmIcon", "warning--filled", "size", "16", 4, "ngIf"], ["ibmIcon", "warning--alt--filled", "size", "16", "class", "bx--list-box__invalid-icon bx--list-box__invalid-icon--warning", 4, "ngIf"], [1, "bx--list-box__menu-icon"], ["ibmIcon", "chevron--down", "size", "16", 3, "ngClass", 4, "ngIf"], [3, "ngClass"], ["dropdownMenu", ""], ["class", "bx--form__helper-text", 4, "ngIf"], ["class", "bx--form-requirement", 4, "ngIf"], [1, "bx--label", 3, "for"], [3, "ngTemplateOutlet"], ["tabindex", "0", 1, "bx--list-box__selection", "bx--tag--filter", "bx--list-box__selection--multi", 3, "title", "click", "keydown.enter"], ["focusable", "false", "preserveAspectRatio", "xMidYMid meet", "role", "img", "xmlns", "http://www.w3.org/2000/svg", "width", "16", "height", "16", "viewBox", "0 0 16 16", "aria-hidden", "true", 2, "will-change", "transform"], ["d", "M12 4.7l-.7-.7L8 7.3 4.7 4l-.7.7L7.3 8 4 11.3l.7.7L8 8.7l3.3 3.3.7-.7L8.7 8z"], [1, "bx--list-box__label"], [3, "ngTemplateOutletContext", "ngTemplateOutlet"], ["ibmIcon", "warning--filled", "size", "16", 1, "bx--dropdown__invalid-icon"], ["ibmIcon", "warning--alt--filled", "size", "16", 1, "bx--list-box__invalid-icon", "bx--list-box__invalid-icon--warning"], ["ibmIcon", "chevron--down", "size", "16", 3, "ngClass"], [1, "bx--form__helper-text"], [1, "bx--form-requirement"]], template: function Dropdown_Template(rf, ctx) { if (rf & 1) {
...
DropdownList.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: DropdownList, selectors: [["ibm-dropdown-list"]], viewQuery: function DropdownList_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵtemplate(2, DropdownList_li_2_Template, 7, 11, "li", 2);
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {
...
DropdownModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [DropdownService], imports: [[
            CommonModule,
            FormsModule,
            I18nModule,
            PlaceholderModule,
