...
function FileUploader_ng_container_0_ng_container_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("remove", function FileUploader_ng_container_0_ng_container_11_Template_ibm_file_remove_1_listener() { const restoredCtx = ɵngcc0.ɵɵrestoreView(_r23); const fileItem_r19 = restoredCtx.$implicit; const ctx_r22 = ɵngcc0.ɵɵnextContext(2); return ctx_r22.removeFile(fileItem_r19); });
    ɵngcc0.ɵɵelementEnd();
...
FileUploader.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: FileUploader, selectors: [["ibm-file-uploader"]], viewQuery: function FileUploader_Query(rf, ctx) { if (rf & 1) {
...
FileComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: FileComponent, selectors: [["ibm-file"]], hostVars: 4, hostBindings: function FileComponent_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵclassProp("bx--file__selected-file", ctx.selectedFile)("bx--file__selected-file--invalid", ctx.isInvalidText);
    } }, inputs: { translations: "translations", fileItem: "fileItem" }, outputs: { remove: "remove" }, decls: 5, vars: 4, consts: [[1, "bx--file-filename"], ["class", "bx--file__state-container", 3, "click", "keyup.enter", "keyup.space", 4, "ngIf"], [4, "ngIf"], ["class", "bx--file__state-container", "tabindex", "0", 4, "ngIf"], [1, "bx--file__state-container", 3, "click", "keyup.enter", "keyup.space"], ["ibmIcon", "warning--filled", "class", "bx--file--invalid", "size", "16", "tabindex", "0", 4, "ngIf"], ["ibmIcon", "close", "size", "16", "tabindex", "0", 1, "bx--file-close", 3, "ariaLabel"], ["ibmIcon", "warning--filled", "size", "16", "tabindex", "0", 1, "bx--file--invalid"], [1, "bx--inline-loading__animation"], ["size", "sm"], ["tabindex", "0", 1, "bx--file__state-container"], ["ibmIcon", "checkmark--filled", "size", "16", 1, "bx--file-complete", 3, "ariaLabel"]], template: function FileComponent_Template(rf, ctx) { if (rf & 1) {
...
FileUploaderModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: FileUploaderModule });
FileUploaderModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[
            CommonModule,
            ButtonModule,
            LoadingModule,
            IconModule
