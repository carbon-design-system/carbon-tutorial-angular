...
import * as i2 from "../utils/element.service";
var styles_Dialog = [];
...
export function View_Dialog_Host_0(_l) { return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, 0, null, null, 1, "ibm-dialog", [], null, [[null, "keydown"], ["document", "click"]], function (_v, en, $event) { var ad = true; if (("keydown" === en)) {
        ...
        ad = (pd_1 && ad);
    } return ad; }, View_Dialog_0, RenderType_Dialog)), i0.ɵdid(1, 4440064, null, 0, i1.Dialog, [i0.ElementRef, [2, i2.ElementService]], null, null)], function (_ck, _v) { _ck(_v, 1, 0); }, null); }
