/**
 *
 * carbon-angular v0.0.0 | carbon-components-angular-list.umd.js
 *
...
(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('carbon-components-angular/list', ['exports', '@angular/core', '@angular/common'], factory) :
    (factory((global['carbon-components-angular'] = global['carbon-components-angular'] || {}, global['carbon-components-angular'].list = {}),global.ng.core,global.ng.common));
    ...
    var ListItemDirective = /** @class */ (function () {
        ...
        ListItemDirective.propDecorators = {
            wrapper: [{ type: core.HostBinding, args: ["class.bx--list__item",] }]
        };
    ...
    var List = /** @class */ (function () {
        ...
        List.propDecorators = {
            ordered: [{ type: core.HostBinding, args: ["class.bx--list--ordered",] }],
            unordered: [{ type: core.HostBinding, args: ["class.bx--list--unordered",] }],
            nested: [{ type: core.HostBinding, args: ["class.bx--list--nested",] }]
        };
        return List;
    }());
...
//# sourceMappingURL=carbon-components-angular-list.umd.js.map