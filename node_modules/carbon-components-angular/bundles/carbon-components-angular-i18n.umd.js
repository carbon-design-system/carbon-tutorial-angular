/**
 *
 * carbon-angular v0.0.0 | carbon-components-angular-i18n.umd.js
 *
...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('carbon-components-angular/utils'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('carbon-components-angular/i18n', ['exports', 'rxjs', 'rxjs/operators', 'carbon-components-angular/utils', '@angular/core'], factory) :
    (factory((global['carbon-components-angular'] = global['carbon-components-angular'] || {}, global['carbon-components-angular'].i18n = {}),global.rxjs,global.rxjs.operators,global['carbon-components-angular'].utils,global.ng.core));
}(this, (function (exports,rxjs,operators,utils,core) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    var replace = function (subject, variables) {
        return subject.pipe(operators.map(function (str) {
            var e_1, _a;
    ...
    var Overridable = /** @class */ (function () {
        function Overridable(path, i18n) {
            ...
            this.$override = new rxjs.BehaviorSubject(value);
            this._value = value;
        }
        ...
        Object.defineProperty(Overridable.prototype, "subject", {
            ...
            get: function () {
                 ...
                 */
                return rxjs.iif(function () { return _this.isOverridden; }, this.$override, this.baseTranslation);
            },
            enumerable: true,
            configurable: true
        });
    ...
    var I18n = /** @class */ (function () {
        function I18n() {
            ...
            this.locale = new rxjs.BehaviorSubject("en");
        }
        /**
        ...
        I18n.prototype.set = function (strings) {
            var e_2, _a;
            this.translationStrings = utils.merge({}, EN, strings);
            ...
            try {
                ...
                try {
                    if (translations_1_1 && !translations_1_1.done && (_a = translations_1.return))
                        _a.call(translations_1);
                }
                finally {
                    if (e_2)
                        throw e_2.error;
        ...
        I18n.prototype.getSubject = function (path) {
            try {
                ...
                var translation = new rxjs.BehaviorSubject(value);
    ...
    var I18N_SERVICE_PROVIDER = {
        provide: I18n,
        deps: [[new core.Optional(), new core.SkipSelf(), I18n]],
    ...
    exports.I18N_SERVICE_PROVIDER_FACTORY = I18N_SERVICE_PROVIDER_FACTORY;
    exports.I18N_SERVICE_PROVIDER = I18N_SERVICE_PROVIDER;
...
//# sourceMappingURL=carbon-components-angular-i18n.umd.js.map