/**
 *
 * carbon-angular v0.0.0 | carbon-components-angular-table.umd.js
 *
...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('carbon-components-angular/common'), require('carbon-components-angular/utils'), require('rxjs/operators'), require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('carbon-components-angular/forms'), require('carbon-components-angular/dialog'), require('carbon-components-angular/i18n'), require('carbon-components-angular/button'), require('carbon-components-angular/search'), require('carbon-components-angular/icon')) :
    typeof define === 'function' && define.amd ? define('carbon-components-angular/table', ['exports', 'rxjs', 'carbon-components-angular/common', 'carbon-components-angular/utils', 'rxjs/operators', '@angular/core', '@angular/common', '@angular/forms', 'carbon-components-angular/forms', 'carbon-components-angular/dialog', 'carbon-components-angular/i18n', 'carbon-components-angular/button', 'carbon-components-angular/search', 'carbon-components-angular/icon'], factory) :
    (factory((global['carbon-components-angular'] = global['carbon-components-angular'] || {}, global['carbon-components-angular'].table = {}),global.rxjs,global['carbon-components-angular'].common,global['carbon-components-angular'].utils,global.rxjs.operators,global.ng.core,global.ng.common,global.ng.forms,global['carbon-components-angular'].forms,global['carbon-components-angular'].dialog,global['carbon-components-angular'].i18n,global['carbon-components-angular'].button,global['carbon-components-angular'].search,global['carbon-components-angular'].icon));
}(this, (function (exports,rxjs,common,utils,operators,core,common$1,forms,forms$1,dialog,i18n,button,search,icon) { 'use strict';
    ...
    var TableToolbar = /** @class */ (function () {
        ...
        /** @nocollapse */
        TableToolbar.ctorParameters = function () {
            return [
                { type: i18n.I18n }
            ];
        };
    ...
    ***************************************************************************** */
    ...
    var TableToolbarSearch = /** @class */ (function (_super) {
        ...
        TableToolbarSearch.propDecorators = {
            hostClass: [{ type: core.HostBinding, args: ["class.bx--toolbar-content",] }]
        };
    ...
    var TableToolbarContent = /** @class */ (function () {
        ...
        TableToolbarContent.propDecorators = {
            class: [{ type: core.HostBinding, args: ["class.bx--toolbar-content",] }]
        };
    ...
    var TableHeaderDescription = /** @class */ (function () {
        ...
        TableHeaderDescription.propDecorators = {
            ...
            descriptionClass: [{ type: core.HostBinding, args: ["class.bx--data-table-header__description",] }]
        };
    ...
    var TableHeaderTitle = /** @class */ (function () {
        ...
        TableHeaderTitle.propDecorators = {
            id: [{ type: core.HostBinding, args: ["attr.id",] }, { type: core.Input }],
            titleClass: [{ type: core.HostBinding, args: ["class.bx--data-table-header__title",] }]
        };
    ...
    var DataGridInteractionModel = /** @class */ (function () {
        ...
        function DataGridInteractionModel(keyboardEventStream, clickEventStream, tableAdapter) {
             ...
             */
            this.rowSubject = new rxjs.BehaviorSubject({ current: 0, previous: -1 });
            /**
             * Internal subject to handle changes in column
             */
            this.columnSubject = new rxjs.BehaviorSubject({ current: 0, previous: -1 });
            this.rowIndex = this.rowSubject.asObservable();
            this.columnIndex = this.columnSubject.asObservable();
            this.position = rxjs.combineLatest(this.rowIndex, this.columnIndex).pipe(operators.map(function (positions) {
            ...
            for (var i = 0; i < this.tableAdapter.lastRowIndex; i++) {
                ...
                try {
                    for (var _b = __values(Array.from(row.cells)), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var cell = _c.value;
                        var tabbableElements = common.getFocusElementList(cell, common.tabbableSelectorIgnoreTabIndex);
                    ...
                    for (var _f = __values(headerRows.reverse()), _g = _f.next(); !_g.done; _g = _f.next()) {
                        ...
                        if (header) {
                            ...
                            try {
                                ...
                                try {
                                    if (headerCells_1_1 && !headerCells_1_1.done && (_b = headerCells_1.return))
                                        _b.call(headerCells_1);
                                }
                                finally {
                                    if (e_2)
                                        throw e_2.error;
                ...
                try {
                    for (var ids_1 = __values(ids_2), ids_1_1 = ids_1.next(); !ids_1_1.done; ids_1_1 = ids_1.next()) {
                        ...
                        try {
                            ...
                            try {
                                if (rowCells_1_1 && !rowCells_1_1.done && (_d = rowCells_1.return))
                                    _d.call(rowCells_1);
                            }
                            finally {
                                if (e_4)
                    ...
                    try {
                        if (ids_1_1 && !ids_1_1.done && (_c = ids_1.return))
                            _c.call(ids_1);
                    }
                    finally {
                        if (e_3)
    ...
    var Table = /** @class */ (function () {
         ...
         */
        function Table(elementRef, applicationRef, i18n$$1) {
             ...
             * @param model
             */
            this.deselectAll = new core.EventEmitter();
            /**
             ...
             */
            this.deselectRow = new core.EventEmitter();
            /**
             ...
             */
            this.scrollLoad = new core.EventEmitter();
            /**
        ...
        Table.setTabIndex = function (element, index) {
            var focusElementList = common.getFocusElementList(element, common.tabbableSelectorIgnoreTabIndex);
        ...
        Object.defineProperty(Table.prototype, "translations", {
             ...
             */
            set: function (value) {
                var valueWithDefaults = utils.merge(this.i18n.getMultiple("TABLE"), value);
        ...
        Table.prototype.enableDataGridInteractions = function () {
            ...
            var keydownEventStream = rxjs.fromEvent(table, "keydown");
            var clickEventStream = rxjs.fromEvent(table, "click");
            this.interactionModel = new DataGridInteractionModel(keydownEventStream, clickEventStream, tableAdapter);
        ...
        Table.prototype.resetTabIndex = function (newTabIndex) {
            ...
            setTimeout(function () {
                ...
                var focusElementList = common.getFocusElementList(_this.elementRef.nativeElement, common.tabbableSelectorIgnoreTabIndex);
                if (focusElementList) {
        ...
        Table.prototype.columnResizeStart = function (event, column) {
            ...
            event.preventDefault();
            this.mouseMoveSubscription = rxjs.fromEvent(document.body, "mousemove").subscribe(function (event) {
                _this.columnResizeProgress(event, column);
            });
            this.mouseUpSubscription = rxjs.fromEvent(document.body, "mouseup").subscribe(function (event) {
        ...
        Table.propDecorators = {
            ...
            isDataGrid: [{ type: core.Input }],
            sortable: [{ type: core.Input }],
            noBorder: [{ type: core.Input }],
            showSelectionColumn: [{ type: core.Input }],
            enableSingleSelect: [{ type: core.Input }],
            scrollLoadDistance: [{ type: core.Input }],
            columnsResizable: [{ type: core.Input }],
            columnsDraggable: [{ type: core.Input }],
            expandButtonAriaLabel: [{ type: core.Input }],
            sortDescendingLabel: [{ type: core.Input }],
            sortAscendingLabel: [{ type: core.Input }],
            translations: [{ type: core.Input }],
            striped: [{ type: core.Input }],
            tableContent: [{ type: core.HostBinding, args: ["class.bx--data-table-content",] }],
            stickyHeader: [{ type: core.HostBinding, args: ["class.bx--data-table_inner-container",] }, { type: core.Input }],
            footerTemplate: [{ type: core.Input }],
            selectionLabelColumn: [{ type: core.Input }],
            sort: [{ type: core.Output }],
            selectAll: [{ type: core.Output }],
            deselectAll: [{ type: core.Output }],
            selectRow: [{ type: core.Output }],
            deselectRow: [{ type: core.Output }],
            rowClick: [{ type: core.Output }],
            scrollLoad: [{ type: core.Output }]
        };
        return Table;
    }());
    ...
    var TableContainer = /** @class */ (function () {
        ...
        TableContainer.prototype.ngAfterContentInit = function () {
        ...
        TableContainer.propDecorators = {
            containerClass: [{ type: core.HostBinding, args: ["class.bx--data-table-container",] }],
            headerTitle: [{ type: core.ContentChild, args: [TableHeaderTitle,] }],
            headerDescription: [{ type: core.ContentChild, args: [TableHeaderDescription,] }],
    ...
    var TableHeader = /** @class */ (function () {
        ...
        TableHeader.propDecorators = {
            headerClass: [{ type: core.HostBinding, args: ["class.bx--data-table-header",] }],
    ...
    var TableHeadCellLabel = /** @class */ (function () {
        ...
        TableHeadCellLabel.propDecorators = {
            baseClass: [{ type: core.HostBinding, args: ["class.bx--table-header-label",] }]
        };
    ...
    var ExpandedRowHover = /** @class */ (function () {
        ...
        ExpandedRowHover.propDecorators = {
            addHoverClass: [{ type: core.HostListener, args: ["mouseenter", ["$event"],] }],
            removeHoverClass: [{ type: core.HostListener, args: ["mouseleave", ["$event"],] }]
        };
    ...
    var TableDirective = /** @class */ (function () {
        ...
        TableDirective.propDecorators = {
            sortable: [{ type: core.Input }, { type: core.HostBinding, args: ["class.bx--data-table--sort",] }],
            noBorder: [{ type: core.Input }, { type: core.HostBinding, args: ["class.bx--data-table--no-border",] }],
            striped: [{ type: core.Input }, { type: core.HostBinding, args: ["class.bx--data-table--zebra",] }],
            skeleton: [{ type: core.Input }, { type: core.HostBinding, args: ["class.bx--skeleton",] }],
            size: [{ type: core.Input }],
            tableClass: [{ type: core.HostBinding, args: ["class.bx--data-table",] }],
            compactClass: [{ type: core.HostBinding, args: ["class.bx--data-table--compact",] }],
            tallClass: [{ type: core.HostBinding, args: ["class.bx--data-table--tall",] }],
            shortClass: [{ type: core.HostBinding, args: ["class.bx--data-table--short",] }]
        };
    ...
    var TableHead = /** @class */ (function () {
        ...
        TableHead.prototype.ngAfterViewInit = function () {
            var _this = this;
            setTimeout(function () {
                _this.scrollbarWidth = utils.getScrollbarWidth();
            });
        };
        ...
        /** @nocollapse */
        TableHead.ctorParameters = function () {
            return [
                { type: i18n.I18n }
            ];
        };
        TableHead.propDecorators = {
            ...
            showSelectionColumn: [{ type: core.Input }],
            enableSingleSelect: [{ type: core.Input }],
            selectAllCheckboxSomeSelected: [{ type: core.Input }],
            selectAllCheckbox: [{ type: core.Input }],
            skeleton: [{ type: core.Input }],
            stickyHeader: [{ type: core.Input }],
            sortable: [{ type: core.Input }],
            size: [{ type: core.Input }],
            checkboxHeaderLabel: [{ type: core.Input }],
            sortDescendingLabel: [{ type: core.Input }],
            sortAscendingLabel: [{ type: core.Input }],
    ...
    var TableHeadCell = /** @class */ (function () {
        ...
        TableHeadCell.prototype.sortLabelMap = function () {
            var _this = this;
            return operators.map(function (str) {
        ...
        /** @nocollapse */
        TableHeadCell.ctorParameters = function () {
            return [
                { type: i18n.I18n }
            ];
        };
        TableHeadCell.propDecorators = {
            ...
            filterTitle: [{ type: core.Input }],
            sort: [{ type: core.Output }],
            theadAction: [{ type: core.HostBinding, args: ["class.thead_action",] }]
        };
        return TableHeadCell;
    }());

    var TableHeadCheckbox = /** @class */ (function () {
        function TableHeadCheckbox(i18n$$1) {
            this.i18n = i18n$$1;
            /**
             * Size of the table rows.
             */
        ...
        /** @nocollapse */
        TableHeadCheckbox.ctorParameters = function () {
            return [
                { type: i18n.I18n }
            ];
        };
        TableHeadCheckbox.propDecorators = {
            ...
            hostClass: [{ type: core.HostBinding, args: ["class.bx--table-column-checkbox",] }]
        };
    ...
    var TableHeadExpand = /** @class */ (function () {
        ...
        TableHeadExpand.propDecorators = {
            hostClass: [{ type: core.HostBinding, args: ["class.bx--table-expand",] }]
        };
        return TableHeadExpand;
    }());

    var TableBody = /** @class */ (function () {
        function TableBody(i18n$$1) {
            this.i18n = i18n$$1;
            /**
             * Controls whether to enable multiple or single row selection.
             */
        ...
        TableBody.propDecorators = {
            ...
            enableSingleSelect: [{ type: core.Input }],
            expandButtonAriaLabel: [{ type: core.Input }],
            checkboxRowLabel: [{ type: core.Input }],
            showSelectionColumn: [{ type: core.Input }],
            size: [{ type: core.Input }],
            selectionLabelColumn: [{ type: core.Input }],
            skeleton: [{ type: core.Input }],
    ...
    var TableRowComponent = /** @class */ (function () {
        function TableRowComponent(i18n$$1) {
            this.i18n = i18n$$1;
            this.expanded = false;
             ...
             */
            this.expandRow = new core.EventEmitter();
            /**
        ...
        TableRowComponent.propDecorators = {
            ...
            showSelectionColumn: [{ type: core.Input }],
            showSelectionColumnCheckbox: [{ type: core.Input }],
            selectionLabelColumn: [{ type: core.Input }],
            skeleton: [{ type: core.Input }],
            selectRow: [{ type: core.Output }],
            deselectRow: [{ type: core.Output }],
            expandRow: [{ type: core.Output }],
            rowClick: [{ type: core.Output }],
            selectedClass: [{ type: core.HostBinding, args: ["class.bx--data-table--selected",] }],
            parentRowClass: [{ type: core.HostBinding, args: ["class.bx--parent-row",] }],
            expandableRowClass: [{ type: core.HostBinding, args: ["class.bx--expandable-row",] }],
            selectableClass: [{ type: core.HostBinding, args: ["class.tbody_row--selectable",] }],
            isParentRow: [{ type: core.HostBinding, args: ["attr.data-parent-row",] }],
            isAccessible: [{ type: core.HostBinding, args: ["attr.tabindex",] }],
            onHostClick: [{ type: core.HostListener, args: ["click",] }]
        };
    ...
    var TableExpandedRow = /** @class */ (function () {
        ...
        TableExpandedRow.propDecorators = {
            ...
            skeleton: [{ type: core.Input }],
            expandableRowClass: [{ type: core.HostBinding, args: ["class.bx--expandable-row",] }],
            dataChildRow: [{ type: core.HostBinding, args: ["attr.data-child-row",] }],
            expanded: [{ type: core.Input }],
            displayStyle: [{ type: core.HostBinding, args: ["style.display",] }]
        };
    ...
    var TableRadio = /** @class */ (function () {
        ...
        /** @nocollapse */
        TableRadio.ctorParameters = function () {
            return [
                { type: i18n.I18n }
            ];
        };
    ...
    var TableExpandButton = /** @class */ (function () {
        function TableExpandButton(i18n$$1) {
            this.i18n = i18n$$1;
            /**
        ...
        /** @nocollapse */
        TableExpandButton.ctorParameters = function () {
            return [
                { type: i18n.I18n }
            ];
        };
        TableExpandButton.propDecorators = {
            ...
            ariaLabel: [{ type: core.Input }],
            skeleton: [{ type: core.Input }],
            expandClass: [{ type: core.HostBinding, args: ["class.bx--table-expand",] }],
            previousValue: [{ type: core.HostBinding, args: ["attr.data-previous-value",] }],
            expandRow: [{ type: core.Output }]
        };
    ...
    exports.TableToolbarActions = TableToolbarActions;
    exports.TableToolbarSearch = TableToolbarSearch;
    exports.TableToolbarContent = TableToolbarContent;
    exports.TableContainer = TableContainer;
    exports.TableHeader = TableHeader;
    exports.TableHeaderTitle = TableHeaderTitle;
    exports.TableHeadCellLabel = TableHeadCellLabel;
    exports.TableHeaderDescription = TableHeaderDescription;
    exports.ExpandedRowHover = ExpandedRowHover;
    exports.Table = Table;
    exports.TableDirective = TableDirective;
    exports.TableHead = TableHead;
    exports.TableHeadCell = TableHeadCell;
    exports.TableHeadCheckbox = TableHeadCheckbox;
    exports.TableHeadExpand = TableHeadExpand;
    ...
    exports.TableRadio = TableRadio;
    exports.TableExpandButton = TableExpandButton;
    exports.TableModel = TableModel;
    exports.TableItem = TableItem;
    exports.TableHeaderItem = TableHeaderItem;
    exports.TableCellAdapter = TableCellAdapter;
    exports.TableRowAdapter = TableRowAdapter;
    exports.TableAdapter = TableAdapter;
    exports.TableDomAdapter = TableDomAdapter;
    exports.DataGridInteractionModel = DataGridInteractionModel;
...
//# sourceMappingURL=carbon-components-angular-table.umd.js.map