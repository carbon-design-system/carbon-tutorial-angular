/**
 *
 * carbon-angular v0.0.0 | carbon-components-angular-context-menu.umd.js
 *
...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('carbon-components-angular/icon'), require('rxjs'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('carbon-components-angular/context-menu', ['exports', '@angular/common', 'carbon-components-angular/icon', 'rxjs', '@angular/core'], factory) :
    (factory((global['carbon-components-angular'] = global['carbon-components-angular'] || {}, global['carbon-components-angular']['context-menu'] = {}),global.ng.common,global['carbon-components-angular'].icon,global.rxjs,global.ng.core));
}(this, (function (exports,common,icon,rxjs,core) { 'use strict';
    ...
    var ContextMenuDividerComponent = /** @class */ (function () {
        ...
        ContextMenuDividerComponent.propDecorators = {
            dividerContextClass: [{ type: core.HostBinding, args: ["class.bx--context-menu-divider",] }],
            dividerClass: [{ type: core.HostBinding, args: ["class.bx--menu-divider",] }],
    ...
    var ContextMenuSelectionService = /** @class */ (function () {
        function ContextMenuSelectionService() {
            this.selectionSubject = new rxjs.ReplaySubject(1);
            this.value = [];
    ...
    var ContextMenuGroupComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        ContextMenuGroupComponent.ctorParameters = function () {
            return [
    ...
    var ContextMenuComponent = /** @class */ (function () {
        ...
        ContextMenuComponent.propDecorators = {
            ...
            handleNavigation: [{ type: core.HostListener, args: ["keydown", ["$event"],] }]
        };
    ...
    var ContextMenuItemComponent = /** @class */ (function () {
        ...
        ContextMenuItemComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: ContextMenuSelectionService, decorators: [{ type: core.Optional }] }
            ];
        };
        ContextMenuItemComponent.propDecorators = {
            optionContextClass: [{ type: core.HostBinding, args: ["class.bx--context-menu-option",] }],
            optionClass: [{ type: core.HostBinding, args: ["class.bx--menu-option",] }],
            role: [{ type: core.HostBinding, args: ["attr.role",] }],
            ...
            childContextMenu: [{ type: core.ContentChild, args: [ContextMenuComponent, { static: true },] }],
            handleClick: [{ type: core.HostListener, args: ["keydown.enter", ["$event"],] }, { type: core.HostListener, args: ["keydown.space", ["$event"],] }, { type: core.HostListener, args: ["click", ["$event"],] }],
            handleMouseOver: [{ type: core.HostListener, args: ["mouseover",] }],
            handleMouseOut: [{ type: core.HostListener, args: ["mouseout",] }],
            handleFocus: [{ type: core.HostListener, args: ["focus",] }],
            handleBlur: [{ type: core.HostListener, args: ["blur",] }]
        };
    ...
    exports.ɵa = ContextMenuSelectionService;
    exports.ContextMenuModule = ContextMenuModule;
    exports.ContextMenuDividerComponent = ContextMenuDividerComponent;
    exports.ContextMenuGroupComponent = ContextMenuGroupComponent;
...
//# sourceMappingURL=carbon-components-angular-context-menu.umd.js.map