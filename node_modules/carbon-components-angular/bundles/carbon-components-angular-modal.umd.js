/**
 *
 * carbon-angular v0.0.0 | carbon-components-angular-modal.umd.js
 *
...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/operators'), require('carbon-components-angular/common'), require('@angular/common'), require('carbon-components-angular/forms'), require('carbon-components-angular/i18n'), require('carbon-components-angular/placeholder'), require('carbon-components-angular/experimental'), require('@angular/core'), require('carbon-components-angular/icon')) :
    typeof define === 'function' && define.amd ? define('carbon-components-angular/modal', ['exports', 'rxjs/operators', 'carbon-components-angular/common', '@angular/common', 'carbon-components-angular/forms', 'carbon-components-angular/i18n', 'carbon-components-angular/placeholder', 'carbon-components-angular/experimental', '@angular/core', 'carbon-components-angular/icon'], factory) :
    (factory((global['carbon-components-angular'] = global['carbon-components-angular'] || {}, global['carbon-components-angular'].modal = {}),global.rxjs.operators,global['carbon-components-angular'].common,global.ng.common,global['carbon-components-angular'].forms,global['carbon-components-angular'].i18n,global['carbon-components-angular'].placeholder,global['carbon-components-angular'].experimental,global.ng.core,global['carbon-components-angular'].icon));
}(this, (function (exports,operators,common,common$1,forms,i18n,placeholder,experimental,core,icon) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var BaseModal = /** @class */ (function () {
        ...
        BaseModal.decorators = [
            { type: core.Directive, args: [{ selector: "[ibmBaseModal]" },] }
        ];
    ...
    var AlertModal = /** @class */ (function (_super) {
        ...
        function AlertModal(type, label, title, content, size, hasScrollingContent, buttons, onClose, showCloseButton) {
            ...
            if (hasScrollingContent === void 0) {
                hasScrollingContent = null;
            }
            if (buttons === void 0) {
                buttons = [];
            }
            if (showCloseButton === void 0) {
        ...
        /** @nocollapse */
        AlertModal.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: ["type",] }] },
                { type: String, decorators: [{ type: core.Optional }, { type: core.Inject, args: ["label",] }] },
                { type: String, decorators: [{ type: core.Optional }, { type: core.Inject, args: ["title",] }] },
                { type: String, decorators: [{ type: core.Optional }, { type: core.Inject, args: ["content",] }] },
                { type: String, decorators: [{ type: core.Optional }, { type: core.Inject, args: ["size",] }] },
                { type: Boolean, decorators: [{ type: core.Optional }, { type: core.Inject, args: ["hasScrollingContent",] }] },
                { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: ["buttons",] }] },
                { type: Function, decorators: [{ type: core.Optional }, { type: core.Inject, args: ["close",] }] },
                { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: ["showCloseButton",] }] }
            ];
        };
        AlertModal.propDecorators = {
            modalContent: [{ type: core.ViewChild, args: ["modalContent", { static: true },] }]
        };
        return AlertModal;
    }(BaseModal));
    ...
    })(exports.AlertModalType || (exports.AlertModalType = {}));
    ...
    var ModalHeader = /** @class */ (function () {
        function ModalHeader(i18n$$1, experimental$$1) {
            this.i18n = i18n$$1;
             ...
             */
            this.closeSelect = new core.EventEmitter();
        }
        /**
        ...
        /** @nocollapse */
        ModalHeader.ctorParameters = function () {
            return [
                { type: i18n.I18n },
    ...
    var ModalService = /** @class */ (function () {
        ...
        ModalService.prototype.create = function (data) {
            ...
            var injector = core.Injector.create(inputProviders);
            ...
            operators.delay(150)).subscribe(function () {
    ...
    var Modal = /** @class */ (function () {
        ...
        function Modal(modalService) {
             ...
             */
            this.overlaySelected = new core.EventEmitter();
            /**
        ...
        Modal.prototype.handleKeyboardEvent = function (event) {
            switch (event.key) {
                ...
                case "Tab": {
                    common.cycleTabs(event, this.modal.nativeElement);
                    break;
                }
            }
        };
        ...
        Modal.prototype.focusInitialElement = function () {
            ...
            else if (common.getFocusElementList(this.modal.nativeElement).length > 0) {
                setTimeout(function () { return common.getFocusElementList(_this.modal.nativeElement)[0].focus(); });
            }
            else {
        ...
        Modal.propDecorators = {
            ...
            theme: [{ type: core.Input }],
            modalLabel: [{ type: core.Input }],
            ariaLabel: [{ type: core.Input }],
            open: [{ type: core.Input }],
            trigger: [{ type: core.Input }],
            hasScrollingContent: [{ type: core.Input }],
            overlaySelected: [{ type: core.Output }],
            close: [{ type: core.Output }],
    ...
    var Overlay = /** @class */ (function () {
        function Overlay() {
             ...
             */
            this.overlaySelect = new core.EventEmitter();
        }
        /**
        ...
        Overlay.propDecorators = {
            theme: [{ type: core.Input }],
            open: [{ type: core.Input }],
            overlaySelect: [{ type: core.Output }],
            overlay: [{ type: core.ViewChild, args: ["overlay", { static: true },] }]
        };
        return Overlay;
    }());
    ...
    var ModalContent = /** @class */ (function () {
        ...
        ModalContent.propDecorators = {
            modalContentClass: [{ type: core.HostBinding, args: ["class.bx--modal-content",] }],
            hasForm: [{ type: core.HostBinding, args: ["class.bx--modal-content--with-form",] }, { type: core.Input }]
        };
        return ModalContent;
    }());
    ...
    var ModalContentText = /** @class */ (function () {
        ...
        ModalContentText.propDecorators = {
            modalContentTextClass: [{ type: core.HostBinding, args: ["class.bx--modal-content__text",] }]
        };
    ...
    var ModalHeaderHeading = /** @class */ (function () {
        ...
        ModalHeaderHeading.propDecorators = {
            modalHeaderHeadingClass: [{ type: core.HostBinding, args: ["class.bx--modal-header__heading",] }]
        };
    ...
    var ModalHeaderLabel = /** @class */ (function () {
        ...
        ModalHeaderLabel.propDecorators = {
            modalHeaderLabelClass: [{ type: core.HostBinding, args: ["class.bx--modal-header__label",] }]
        };
    ...
    exports.ModalContentText = ModalContentText;
    exports.ModalHeaderHeading = ModalHeaderHeading;
    exports.ModalHeaderLabel = ModalHeaderLabel;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=carbon-components-angular-modal.umd.js.map