/**
 *
 * carbon-angular v0.0.0 | carbon-components-angular-structured-list.umd.js
 *
...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/forms'), require('@angular/core'), require('@angular/common'), require('carbon-components-angular/icon')) :
    typeof define === 'function' && define.amd ? define('carbon-components-angular/structured-list', ['exports', '@angular/forms', '@angular/core', '@angular/common', 'carbon-components-angular/icon'], factory) :
    (factory((global['carbon-components-angular'] = global['carbon-components-angular'] || {}, global['carbon-components-angular']['structured-list'] = {}),global.ng.forms,global.ng.core,global.ng.common,global['carbon-components-angular'].icon));
}(this, (function (exports,forms,core,common,icon) { 'use strict';
    ...
    var ListColumn = /** @class */ (function () {
        ...
        ListColumn.propDecorators = {
            ...
            isHeaderColumn: [{ type: core.HostBinding, args: ["class.bx--structured-list-th",] }],
            isBodyColumn: [{ type: core.HostBinding, args: ["class.bx--structured-list-td",] }],
            nowrap: [{ type: core.HostBinding, args: ["class.bx--structured-list-content--nowrap",] }, { type: core.Input }]
        };
        return ListColumn;
    }());
    ...
    var ListHeader = /** @class */ (function () {
        ...
        ListHeader.propDecorators = {
            wrapper: [{ type: core.HostBinding, args: ["class.bx--structured-list-thead",] }],
            skeleton: [{ type: core.Input }],
            columns: [{ type: core.ContentChildren, args: [ListColumn,] }]
        };
        return ListHeader;
    }());
    ...
    var ListRow = /** @class */ (function () {
        ...
        ListRow.propDecorators = {
            selected: [{ type: core.Input }, { type: core.HostBinding, args: ["class.bx--structured-list-row--selected",] }],
            label: [{ type: core.Input }, { type: core.HostBinding, args: ["attr.aria-label",] }],
            value: [{ type: core.Input }],
            change: [{ type: core.Output }],
            wrapper: [{ type: core.HostBinding, args: ["class.bx--structured-list-row",] }],
    ...
    var StructuredList = /** @class */ (function () {
        ...
        StructuredList.propDecorators = {
            ...
            rows: [{ type: core.ContentChildren, args: [ListRow,] }],
            headers: [{ type: core.ContentChildren, args: [ListHeader,] }]
        };
    ...
    exports.StructuredListModule = StructuredListModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=carbon-components-angular-structured-list.umd.js.map