/**
 *
 * carbon-angular v0.0.0 | carbon-components-angular-breadcrumb.umd.js
 *
...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/platform-browser'), require('@angular/router'), require('@angular/core'), require('@angular/common'), require('carbon-components-angular/dialog'), require('carbon-components-angular/i18n')) :
    typeof define === 'function' && define.amd ? define('carbon-components-angular/breadcrumb', ['exports', '@angular/platform-browser', '@angular/router', '@angular/core', '@angular/common', 'carbon-components-angular/dialog', 'carbon-components-angular/i18n'], factory) :
    (factory((global['carbon-components-angular'] = global['carbon-components-angular'] || {}, global['carbon-components-angular'].breadcrumb = {}),global.ng.platformBrowser,global.ng.router,global.ng.core,global.ng.common,global['carbon-components-angular'].dialog,global['carbon-components-angular'].i18n));
}(this, (function (exports,platformBrowser,router,core,common,dialog,i18n) { 'use strict';

    var BreadcrumbItemComponent = /** @class */ (function () {
        function BreadcrumbItemComponent(domSanitizer, router$$1) {
        ...
        /** @nocollapse */
        BreadcrumbItemComponent.ctorParameters = function () {
            return [
        ...
        BreadcrumbItemComponent.propDecorators = {
            ...
            ariaCurrent: [{ type: core.Input }],
            current: [{ type: core.HostBinding, args: ["class.bx--breadcrumb-item--current",] }, { type: core.Input }],
            itemClass: [{ type: core.HostBinding, args: ["class.bx--breadcrumb-item",] }]
        };
    ...
    var Breadcrumb = /** @class */ (function () {
        function Breadcrumb(i18n$$1, router$$1) {
            this.i18n = i18n$$1;
            this.router = router$$1;
        ...
        /** @nocollapse */
        Breadcrumb.ctorParameters = function () {
            return [
                { type: i18n.I18n },
                { type: router.Router, decorators: [{ type: core.Optional }] }
            ];
        ...
        Breadcrumb.propDecorators = {
            children: [{ type: core.ContentChildren, args: [BreadcrumbItemComponent,] }],
            items: [{ type: core.Input }],
            noTrailingSlash: [{ type: core.Input }],
...
//# sourceMappingURL=carbon-components-angular-breadcrumb.umd.js.map