...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/forms'), require('carbon-components-angular/i18n'), require('carbon-components-angular/experimental'), require('carbon-components-angular/utils'), require('carbon-components-angular/common'), require('@angular/core'), require('carbon-components-angular/icon'), require('carbon-components-angular/forms')) :
    typeof define === 'function' && define.amd ? define('carbon-components-angular/pagination', ['exports', '@angular/common', '@angular/forms', 'carbon-components-angular/i18n', 'carbon-components-angular/experimental', 'carbon-components-angular/utils', 'carbon-components-angular/common', '@angular/core', 'carbon-components-angular/icon', 'carbon-components-angular/forms'], factory) :
    (factory((global['carbon-components-angular'] = global['carbon-components-angular'] || {}, global['carbon-components-angular'].pagination = {}),global.ng.common,global.ng.forms,global['carbon-components-angular'].i18n,global['carbon-components-angular'].experimental,global['carbon-components-angular'].utils,global['carbon-components-angular'].common,global.ng.core,global['carbon-components-angular'].icon,global['carbon-components-angular'].forms));
}(this, (function (exports,common,forms,i18n,experimental,utils,common$1,core,icon,forms$1) { 'use strict';
