...
<div class="tab-content">
    <div class="tab-pane fade active in" id="c-info">
        ...
        <p class="comment">
            ...
            <p class="comment">
                <p>Used to emit changes performed on checkbox components.</p>
    ...
    <table class="table table-sm table-bordered index-table">
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <span class="name">
                            ...
                            <a href="#checked"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <code>checked:     <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/boolean" target="_blank" >boolean</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="38" class="link-to-prism">src/checkbox/checkbox.component.ts:38</a></div>
                            </td>
                        </tr>

                <tr>
                    <td class="col-md-4">
                        <div class="io-description"><p>The state of the <code>Checkbox</code> encompassed in the <code>CheckboxChange</code> class.</p>
</div>
                    </td>
                </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <code>source:     <code><a href="../components/Checkbox.html" target="_self" >Checkbox</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                        <td class="col-md-4">
                            <i>Type : </i>    <code><a href="../components/Checkbox.html" target="_self" >Checkbox</a></code>

                        </td>
                    </tr>
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="34" class="link-to-prism">src/checkbox/checkbox.component.ts:34</a></div>
                            </td>
                        </tr>

                <tr>
                    <td class="col-md-4">
                        <div class="io-description"><p>Contains the <code>Checkbox</code> that has been changed.</p>
</div>
                    </td>
                </tr>
...
export class Checkbox implements ControlValueAccessor, AfterViewInit {
    ...
    <div class="no-results">
       ...
       <script>
            ...
            var COMPODOC_CURRENT_PAGE_URL = 'CheckboxChange.html';
       </script>
