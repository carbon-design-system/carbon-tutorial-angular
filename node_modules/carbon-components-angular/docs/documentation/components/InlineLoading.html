...
<p class="comment">
    <code>src/inline-loading/inline-loading.component.ts</code>
</p>
    ...
    <p class="comment">
        <p><a href="../../?path=/story/inline-loading--basic">See demo</a></p>
<p><example-url>../../iframe.html?id=inline-loading--basic</example-url></p>
    ...
    <table class="table table-sm table-hover">
        <tbody>
            ...
            <tr>
                ...
                <td class="col-md-9"><code>ibm-inline-loading</code></td>
            </tr>
            ...
            <tr>
                ...
                <td class="col-md-9"><pre class="line-numbers"><code class="language-html">&lt;div *ngIf&#x3D;&quot;state !&#x3D;&#x3D; InlineLoadingState.Hidden&quot;
...
&lt;p *ngIf&#x3D;&quot;state &#x3D;&#x3D;&#x3D; InlineLoadingState.Error&quot; class&#x3D;&quot;bx--inline-loading__text&quot;&gt;{{errorText}}&lt;/p&gt;
        ...
        <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <ul class="index-list">
                            <li>
                                <a href="#InlineLoadingState">InlineLoadingState</a>
                            </li>
                        </ul>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <ul class="index-list">
                            <li>
                                <a href="#errorText">errorText</a>
                            </li>
                            <li>
                                <a href="#isActive">isActive</a>
                            </li>
                            <li>
                                <a href="#loadingText">loadingText</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#successDelay">successDelay</a>
                            </li>
                            <li>
                ...
                <tr>
                    <td class="col-md-4">
                        <ul class="index-list">
                            <li>
                                <a href="#class.bx--inline-loading">class.bx--inline-loading</a>
                            </li>
                        </ul>
                    </td>
                </tr>
    ...
    <h3 id="inputs">Inputs</h3>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Specify the text description for the error state.</p>
</div>
                            <p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="89" class="link-to-prism">src/inline-loading/inline-loading.component.ts:89</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>set to <code>false</code> to stop the loading animation</p>
</div>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="93" class="link-to-prism">src/inline-loading/inline-loading.component.ts:93</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-2">
                        <a name="loadingText"></a>
                        <code>loadingText</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Specify the text description for the loading state.</p>
</div>
                            <p>
                            <em>Type :</em>    <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string" target="_blank" >string</a></code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="77" class="link-to-prism">src/inline-loading/inline-loading.component.ts:77</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
                ...
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Specify the text description for the loading state.</p>
                            ...
                            <p>
                            <em>Type :</em>    <code><a href="../components/Loading.html" target="_self" >InlineLoadingState | string</a></code>

                            </p>
                        <p>
                            <em>Default value : </em><code>InlineLoadingState.Active</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="73" class="link-to-prism">src/inline-loading/inline-loading.component.ts:73</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Returns value <code>true</code> if the component is in the success state.</p>
</div>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="103" class="link-to-prism">src/inline-loading/inline-loading.component.ts:103</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-2">
                        <a name="successDelay"></a>
                        <code>successDelay</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Provide a delay for the <code>setTimeout</code> for success.</p>
</div>
                        <p>
                            <em>Default value : </em><code>1500</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="85" class="link-to-prism">src/inline-loading/inline-loading.component.ts:85</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-2">
                        <a name="successText"></a>
                        <code>successText</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Specify the text description for the success state.</p>
</div>
                            <p>
                            <em>Type :</em>    <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string" target="_blank" >string</a></code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="81" class="link-to-prism">src/inline-loading/inline-loading.component.ts:81</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Emits event after the success state is active</p>
</div>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="121" class="link-to-prism">src/inline-loading/inline-loading.component.ts:121</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
    ...
    <h3>HostBindings</h3>        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="class.bx--inline-loading"></a>
                        <span class="name">
                            <b>
                            class.bx--inline-loading
                            </b>
                            <a href="#class.bx--inline-loading"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <code>class.bx--inline-loading:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="123" class="link-to-prism">src/inline-loading/inline-loading.component.ts:123</a></div>
                            </td>
                        </tr>
    ...
    <section>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="InlineLoadingState"></a>
                        <span class="name">
                            <b>
                            InlineLoadingState
                            </b>
                            <a href="#InlineLoadingState"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <code>InlineLoadingState:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        <td class="col-md-4">
                            <i>Default value : </i><code>InlineLoadingState</code>
                        </td>
                    </tr>
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="68" class="link-to-prism">src/inline-loading/inline-loading.component.ts:68</a></div>
                            </td>
                        </tr>
    ...
    <h3 id="accessors">
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>isActive(active: <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/boolean" target="_blank">boolean</a>)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="96" class="link-to-prism">src/inline-loading/inline-loading.component.ts:96</a></div>
                                </td>
                            </tr>
                    <tr>
                        <td class="col-md-4">
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>success(success: <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/boolean" target="_blank">boolean</a>)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="109" class="link-to-prism">src/inline-loading/inline-loading.component.ts:109</a></div>
                                </td>
                            </tr>
                    <tr>
                        <td class="col-md-4">
                                <div class="io-description"><p>Set the component&#39;s state to match the parameter and emits onSuccess if it exits.</p>
</div>
...
export class InlineLoading {
    ...
    <div class="tab-pane fade " id="c-example">
            <iframe class="exampleContainer" src="../../iframe.html?id&#x3D;inline-loading--basic">
                <p>no-iframes</p>
            </iframe>
    </div>
...
<script>
        var COMPONENT_TEMPLATE = '<div><div *ngIf="state !== InlineLoadingState.Hidden"	class="bx--inline-loading__animation">	<div		*ngIf="state === InlineLoadingState.Inactive || state === InlineLoadingState.Active"		class="bx--loading bx--loading--small"		[ngClass]="{			\'bx--loading--stop\': state === InlineLoadingState.Inactive		}">		<svg class="bx--loading__svg" viewBox="-75 -75 150 150">			<circle class="bx--loading__background" cx="0" cy="0" r="30" />			<circle class="bx--loading__stroke" cx="0" cy="0" r="30" />		</svg>	</div>	<svg		*ngIf="state === InlineLoadingState.Finished"		class="bx--inline-loading__checkmark-container bx--inline-loading__svg"		xmlns="http://www.w3.org/2000/svg"		viewBox="0 0 10 10">		<polyline class="bx--inline-loading__checkmark" points="0.74 3.4 3.67 6.34 9.24 0.74"></polyline>	</svg>	<svg		*ngIf="state === InlineLoadingState.Error"		class="bx--inline-loading--error"		xmlns="http://www.w3.org/2000/svg"		viewBox="0 0 16 16">		<path d="M8,1C4.1,1,1,4.1,1,8s3.1,7,7,7s7-3.1,7-7S11.9,1,8,1z M10.7,11.5L4.5,5.3l0.8-0.8l6.2,6.2L10.7,11.5z"></path>		<path fill="none" d="M10.7,11.5L4.5,5.3l0.8-0.8l6.2,6.2L10.7,11.5z" data-icon-path="inner-path" opacity="0"></path>	</svg></div><p	*ngIf="state === InlineLoadingState.Inactive || state === InlineLoadingState.Active"	class="bx--inline-loading__text">{{loadingText}}</p><p *ngIf="state === InlineLoadingState.Finished" class="bx--inline-loading__text">{{successText}}</p><p *ngIf="state === InlineLoadingState.Error" class="bx--inline-loading__text">{{errorText}}</p>	</div>'
    ...
    var ACTUAL_COMPONENT = {'name': 'InlineLoading'};
</script>
<script src="../js/tree.js"></script>
    ...
    <div class="no-results">
       ...
       <script>
            ...
            var COMPODOC_CURRENT_PAGE_URL = 'InlineLoading.html';
       </script>
