...
<p class="comment">
    ...
    <p class="comment">
        <p><code>ibm-select</code> provides a styled <code>select</code> component.</p>
<p><a href="../../?path=/story/select--basic">See demo</a></p>
<p>Example:</p>
<div><pre class="line-numbers"><code class="language-none"> * &lt;ibm-select [(ngModel)]=&quot;model&quot;&gt;
 *     &lt;option value=&quot;default&quot; disabled selected hidden&gt;Choose an option&lt;/option&gt;
 *     &lt;option value=&quot;option1&quot;&gt;Option 1&lt;/option&gt;
 *    &lt;option value=&quot;option2&quot;&gt;Option 2&lt;/option&gt;
 *     &lt;option value=&quot;option3&quot;&gt;Option 3&lt;/option&gt;
 * &lt;/ibm-select&gt;
 *</code></pre></div><p><example-url>../../iframe.html?id=select--basic</example-url></p>
...
<section>
    ...
    provide: NG_VALUE_ACCESSOR, useExisting: Select, multi: true
            ...
            <tr>
                ...
                <td class="col-md-9"><code>ibm-select</code></td>
            </tr>
		...
		[data-invalid] ~ .bx--select__arrow {
            ...
            <tr>
                ...
                <td class="col-md-9"><pre class="line-numbers"><code class="language-html">&lt;div class&#x3D;&quot;bx--form-item&quot;&gt;
	&lt;div
		[ngClass]&#x3D;&quot;{
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="137" class="link-to-prism">src/select/select.component.ts:137</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="133" class="link-to-prism">src/select/select.component.ts:133</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="149" class="link-to-prism">src/select/select.component.ts:149</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="207" class="link-to-prism">src/select/select.component.ts:207</a></div>
                            </td>
                        </tr>
...
<code>registerOnTouched(fn: <a href="https://www.typescriptlang.org/docs/handbook/basic-types.html" target="_blank">any</a>)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="178" class="link-to-prism">src/select/select.component.ts:178</a></div>
                            </td>
                        </tr>
...
<code>setDisabledState(isDisabled: <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/boolean" target="_blank">boolean</a>)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="185" class="link-to-prism">src/select/select.component.ts:185</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="215" class="link-to-prism">src/select/select.component.ts:215</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="151" class="link-to-prism">src/select/select.component.ts:151</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="104" class="link-to-prism">src/select/select.component.ts:104</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>value(v)</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="157" class="link-to-prism">src/select/select.component.ts:157</a></div>
                                </td>
                            </tr>
                    <tr>
                        <td class="col-md-4">
...
export class Select implements ControlValueAccessor {
    ...
    <div class="tab-pane fade " id="c-example">
            <iframe class="exampleContainer" src="../../iframe.html?id&#x3D;select--basic">
                <p>no-iframes</p>
            </iframe>
    </div>
...
<script>
        var COMPONENT_TEMPLATE = '<div><div class="bx--form-item">	<div		[ngClass]="{			\'bx--select--inline\': display === \'inline\',			\'bx--select--light\': theme === \'light\',			\'bx--skeleton\': skeleton		}"		class="bx--select"		style="width: 100%">		<label *ngIf="skeleton && label" [for]="id" class="bx--label bx--skeleton"></label>		<label *ngIf="!skeleton && label" [for]="id" class="bx--label">			<ng-container *ngIf="!isTemplate(label)">{{label}}</ng-container>			<ng-template *ngIf="isTemplate(label)" [ngTemplateOutlet]="label"></ng-template>		</label>		<div *ngIf="helperText" class="bx--form__helper-text">			<ng-container *ngIf="!isTemplate(helperText)">{{helperText}}</ng-container>			<ng-template *ngIf="isTemplate(helperText)" [ngTemplateOutlet]="helperText"></ng-template>		</div>		<div class="bx--select-input__wrapper" [attr.data-invalid]="(invalid ? true : null)">			<select				#select				[attr.id]="id"				[disabled]="disabled"				(change)="onChange($event)"				class="bx--select-input">				<ng-content></ng-content>			</select>			<ibm-icon-warning-filled16				*ngIf="!skeleton && invalid"				class="bx--select__invalid-icon"				style="display: inherit;">			</ibm-icon-warning-filled16>			<svg				*ngIf="!skeleton"				focusable="false"				preserveAspectRatio="xMidYMid meet"				style="will-change: transform;"				xmlns="http://www.w3.org/2000/svg"				class="bx--select__arrow"				width="10"				height="6"				viewBox="0 0 10 6"				aria-hidden="true">				<path d="M5 6L0 1 .7.3 5 4.6 9.3.3l.7.7z"></path>			</svg>		</div>		<div *ngIf="invalid" class="bx--form-requirement">			<ng-container *ngIf="!isTemplate(invalidText)">{{invalidText}}</ng-container>			<ng-template *ngIf="isTemplate(invalidText)" [ngTemplateOutlet]="invalidText"></ng-template>		</div>	</div></div>	</div>'
