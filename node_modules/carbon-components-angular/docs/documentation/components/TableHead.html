...
<p class="comment">
    <code>src/table/head/table-head.component.ts</code>
</p>
    ...
    <p class="comment">
        <p>A subcomponent that creates the thead of the table</p>
<h2 id="basic-usage">Basic usage</h2>
<div><pre class="line-numbers"><code class="language-html"> *     &lt;thead ibmTableHead [model]=&quot;model&quot;&gt;&lt;/thead&gt;
 *</code></pre></div>
    </p>
    ...
    <table class="table table-sm table-hover">
        <tbody>
            ...
            <tr>
                ...
                <td class="col-md-9"><code>[ibmTableHead]</code></td>
            </tr>
        ...
        <tbody>
                    ...
                    <td class="col-md-4">
                        <ul class="index-list">
                            ...
                            <li>
                                ...
                                <a href="#scrollbarWidth">scrollbarWidth</a>
                            </li>
                        </ul>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <ul class="index-list">
                            ...
                            <li>
                                <a href="#onSelectAllCheckboxChange">onSelectAllCheckboxChange</a>
                            </li>
                        </ul>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <ul class="index-list">
                            <li>
                                <a href="#checkboxHeaderLabel">checkboxHeaderLabel</a>
                            </li>
                            <li>
                                <a href="#enableSingleSelect">enableSingleSelect</a>
                            </li>
                            <li>
                                <a href="#filterTitle">filterTitle</a>
                            </li>
                            <li>
...
<code>constructor(i18n: <a href="../injectables/I18n.html">I18n</a>)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                <div class="io-line">Defined in <a href="" data-line="170" class="link-to-prism">src/table/head/table-head.component.ts:170</a></div>
                            </td>
                        </tr>
    ...
    <h3 id="inputs">Inputs</h3>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-2">
                        <a name="checkboxHeaderLabel"></a>
                        <code>checkboxHeaderLabel</code>
                    </td>
                    <td class="col-md-10">
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="113" class="link-to-prism">src/table/head/table-head.component.ts:113</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="91" class="link-to-prism">src/table/head/table-head.component.ts:91</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-2">
                        <a name="filterTitle"></a>
                        <code>filterTitle</code>
                    </td>
                    <td class="col-md-10">
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="140" class="link-to-prism">src/table/head/table-head.component.ts:140</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="87" class="link-to-prism">src/table/head/table-head.component.ts:87</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="95" class="link-to-prism">src/table/head/table-head.component.ts:95</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>selectAllCheckboxSomeSelected</code>
                    </td>
                    <td class="col-md-10">
                        <p>
                            <em>Default value : </em><code>false</code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="93" class="link-to-prism">src/table/head/table-head.component.ts:93</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="89" class="link-to-prism">src/table/head/table-head.component.ts:89</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
                ...
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Size of the table rows.</p>
                            ...
                            <p>
                            <em>Type :</em>    <code>&quot;sm&quot; | &quot;sh&quot; | &quot;md&quot; | &quot;lg&quot;</code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="110" class="link-to-prism">src/table/head/table-head.component.ts:110</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="97" class="link-to-prism">src/table/head/table-head.component.ts:97</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Setting sortable to false will disable all headers including headers which are sortable. Is is
possible to set the sortable state on the header item to disable/enable sorting for only some headers.</p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="105" class="link-to-prism">src/table/head/table-head.component.ts:105</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="131" class="link-to-prism">src/table/head/table-head.component.ts:131</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="122" class="link-to-prism">src/table/head/table-head.component.ts:122</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="99" class="link-to-prism">src/table/head/table-head.component.ts:99</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Emits if all rows are deselected.</p>
</div>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="163" class="link-to-prism">src/table/head/table-head.component.ts:163</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Emits if all rows are selected.</p>
</div>
                        <em><code>$event</code> Type:</em>    <code><a href="https://angular.io/api/core/EventEmitter" target="_blank" >EventEmitter</a></code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="157" class="link-to-prism">src/table/head/table-head.component.ts:157</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Emits an index of the column that wants to be sorted.</p>
</div>
                        <em><code>$event</code> Type:</em>    <code><a href="https://angular.io/api/core/EventEmitter" target="_blank" >EventEmitter</a></code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="151" class="link-to-prism">src/table/head/table-head.component.ts:151</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
...
<code>getCheckboxHeaderLabel()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="188" class="link-to-prism">src/table/head/table-head.component.ts:188</a></div>
                            </td>
                        </tr>
...
<code>getFilterTitle()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="200" class="link-to-prism">src/table/head/table-head.component.ts:200</a></div>
                            </td>
                        </tr>
...
<code>getSortAscendingLabel()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="196" class="link-to-prism">src/table/head/table-head.component.ts:196</a></div>
                            </td>
                        </tr>
...
<code>getSortDescendingLabel()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="192" class="link-to-prism">src/table/head/table-head.component.ts:192</a></div>
                            </td>
                        </tr>
...
<code>ngAfterViewInit()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="174" class="link-to-prism">src/table/head/table-head.component.ts:174</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="onSelectAllCheckboxChange"></a>
                        <span class="name">
                            <b>
                            onSelectAllCheckboxChange
                            </b>
                            <a href="#onSelectAllCheckboxChange"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
<code>onSelectAllCheckboxChange()</code>
                    </td>
                </tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="180" class="link-to-prism">src/table/head/table-head.component.ts:180</a></div>
                            </td>
                        </tr>
    ...
    <section>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_checkboxHeaderLabel:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="167" class="link-to-prism">src/table/head/table-head.component.ts:167</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_filterTitle:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_sortAscendingLabel:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="169" class="link-to-prism">src/table/head/table-head.component.ts:169</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_sortDescendingLabel:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="168" class="link-to-prism">src/table/head/table-head.component.ts:168</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <span class="name">
                            ...
                            <a href="#scrollbarWidth"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>scrollbarWidth:     <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/number" target="_blank" >number</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="165" class="link-to-prism">src/table/head/table-head.component.ts:165</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="checkboxHeaderLabel"></a>
                        <span class="name"><b>checkboxHeaderLabel</b><a href="#checkboxHeaderLabel"><span class="icon ion-ios-link"></span></a></span>
                    </td>
                </tr>

                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>checkboxHeaderLabel()</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="117" class="link-to-prism">src/table/head/table-head.component.ts:117</a></div>
                                </td>
                            </tr>

                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>checkboxHeaderLabel(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>sortDescendingLabel()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="126" class="link-to-prism">src/table/head/table-head.component.ts:126</a></div>
                                </td>
                            </tr>

                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>sortDescendingLabel(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>sortAscendingLabel()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="135" class="link-to-prism">src/table/head/table-head.component.ts:135</a></div>
                                </td>
                            </tr>

                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>sortAscendingLabel(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="filterTitle"></a>
                        <span class="name"><b>filterTitle</b><a href="#filterTitle"><span class="icon ion-ios-link"></span></a></span>
                    </td>
                </tr>

                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>filterTitle()</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="144" class="link-to-prism">src/table/head/table-head.component.ts:144</a></div>
                                </td>
                            </tr>

                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>filterTitle(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
...
<script>
        var COMPONENT_TEMPLATE = '<div><ng-container *ngIf="model">	<tr>		<th			ibmTableHeadExpand			*ngIf="model.hasExpandableRows()"			[ngClass]="{\'bx--table-expand-v2\': stickyHeader}"			[id]="model.getId(\'expand\')">		</th>		<th			*ngIf="!skeleton && showSelectionColumn && enableSingleSelect"			style="width: 0;"			[id]="model.getId(\'select\')">			<!-- add width 0; since the carbon styles don\'t seem to constrain this headers width -->		</th>		<th			ibmTableHeadCheckbox			*ngIf="!skeleton && showSelectionColumn && !enableSingleSelect"			[checked]="selectAllCheckbox"			[indeterminate]="selectAllCheckboxSomeSelected"			[ariaLabel]="getCheckboxHeaderLabel()"			[size]="size"			[skeleton]="skeleton"			(change)="onSelectAllCheckboxChange()"			[name]="model.getHeaderId(\'select\')"			[id]="model.getId(\'select\')">		</th>		<ng-container *ngFor="let column of model.header; let i = index">			<th				*ngIf="column && column.visible"				[ngStyle]="column.style"				ibmTableHeadCell				[class]="column.className"				[sortable]="sortable"				[skeleton]="skeleton"				[id]="model.getId(i)"				[column]="column"				[skeleton]="skeleton"				[filterTitle]="getFilterTitle()"				[attr.colspan]="column.colSpan"				[attr.rowspan]="column.rowSpan"				(sort)="sort.emit(i)">			</th>		</ng-container>		<th *ngIf="!skeleton && stickyHeader && scrollbarWidth" [ngStyle]="{\'width\': scrollbarWidth + \'px\', \'padding\': 0, \'border\': 0}">			<!--				Scrollbar pushes body to the left so this header column is added to push				the title bar the same amount and keep the header and body columns aligned.			-->		</th>	</tr></ng-container><ng-content></ng-content></div>'
    ...
    var ACTUAL_COMPONENT = {'name': 'TableHead'};
</script>
<script src="../js/tree.js"></script>
    ...
    <div class="no-results">
       ...
       <script>
            ...
            var COMPODOC_CURRENT_PAGE_URL = 'TableHead.html';
       </script>
