...
<p class="comment">
    ...
    <p class="comment">
        <p>ComboBoxes are similar to dropdowns, except a combobox provides an input field for users to search items and (optionally) add their own.
Multi-select comboboxes also provide &quot;pills&quot; of selected items.</p>
<p><a href="../../?path=/story/combobox--basic">See demo</a></p>
<p><example-url>../../iframe.html?id=combobox--basic</example-url></p>
...
<section>
    ...
    provide: NG_VALUE_ACCESSOR, useExisting: ComboBox, multi: true
            ...
            <tr>
                ...
                <td class="col-md-9"><code>ibm-combo-box</code></td>
            </tr>
            ...
            <tr>
                ...
                <td class="col-md-9"><pre class="line-numbers"><code class="language-html">&lt;label *ngIf&#x3D;&quot;label&quot; [for]&#x3D;&quot;id&quot; class&#x3D;&quot;bx--label&quot;&gt;
    ...
    <h3 id="constructor">Constructor</h3>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
<code>constructor(elementRef: <a href="https://angular.io/api/core/ElementRef" target="_blank">ElementRef</a>, documentService: <a href="../injectables/DocumentService.html">DocumentService</a>, i18n: <a href="../injectables/I18n.html">I18n</a>)</code>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-4">
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>clearSelectionAria</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Value to display for accessibility purposes on the clear the selected item icon, when single is selected</p>
</div>
                    </td>
                </tr>
                        <tr>
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>clearSelectionsAria</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Value to display for accessibility purposes to clear selections, when multi is selected</p>
</div>
                    </td>
                </tr>
                        <tr>
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>clearSelectionsTitle</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Value to display on the clear selections icon, when multi is selected</p>
</div>
                    </td>
                </tr>
                        <tr>
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>clearSelectionTitle</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Value to display on the clear the selected item icon, when single is selected</p>
</div>
                    </td>
                </tr>
                        <tr>
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>closeMenuAria</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Value to display for accessibility purposes on the combobox control menu when opened</p>
</div>
                    </td>
                </tr>
                        <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> to disable combobox.</p>
</div>
                        <p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="268" class="link-to-prism">src/combobox/combobox.component.ts:268</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>List of items to fill the content with.</p>
...
<div><pre class="line-numbers"><code class="language-javascript">     * items = [
     ...
     *</code></pre></div></div>
                            <p>
                            <em>Type :</em>    <code><a href="../interfaces/ListItem.html" target="_self" >Array&lt;ListItem&gt;</a></code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="166" class="link-to-prism">src/combobox/combobox.component.ts:166</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="188" class="link-to-prism">src/combobox/combobox.component.ts:188</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Max length value to limit input characters</p>
</div>
                            <p>
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>openMenuAria</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Value to display for accessibility purposes on the combobox control menu when closed</p>
</div>
                    </td>
                </tr>
                        <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Text to show when nothing is selected.</p>
</div>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="170" class="link-to-prism">src/combobox/combobox.component.ts:170</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Combo box type (supporting single or multi selection of items).</p>
</div>
                            <p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="180" class="link-to-prism">src/combobox/combobox.component.ts:180</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>emits an empty event when the menu is closed </p>
</div>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Intended to be used to add items to the list.</p>
    ...
    <h3>HostBindings</h3>        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        <td class="col-md-4">
                            <i>Default value : </i><code>&quot;combobox&quot;</code>
                        </td>
                    </tr>
                        <tr>
                            <td class="col-md-4">
...
<code>keydown(ev: KeyboardEvent)</code>
                ...
                <tr>
                    <td class="col-md-4">
                            <div class="io-description"><p>Handles <code>Escape</code> key closing the dropdown, and arrow up/down focus to/from the dropdown list.</p>
</div>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="486" class="link-to-prism">src/combobox/combobox.component.ts:486</a></div>
                            </td>
                        </tr>
...
<code>ngAfterContentInit()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="368" class="link-to-prism">src/combobox/combobox.component.ts:368</a></div>
                            </td>
                        </tr>
...
<code>ngAfterViewInit()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="407" class="link-to-prism">src/combobox/combobox.component.ts:407</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="513" class="link-to-prism">src/combobox/combobox.component.ts:513</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="494" class="link-to-prism">src/combobox/combobox.component.ts:494</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="502" class="link-to-prism">src/combobox/combobox.component.ts:502</a></div>
                            </td>
                        </tr>
    ...
    <section>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_clearSelectionAria:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_clearSelectionsAria:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_clearSelectionsTitle:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_clearSelectionTitle:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="337" class="link-to-prism">src/combobox/combobox.component.ts:337</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_closeMenuAria:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="333" class="link-to-prism">src/combobox/combobox.component.ts:333</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_openMenuAria:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_placeholder:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="138" class="link-to-prism">src/combobox/combobox.component.ts:138</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <code>input:     <code><a href="https://angular.io/api/core/ElementRef" target="_blank" >ElementRef</a></code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>noop:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>open:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>pills:     <code>[]</code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>propagateChangeCallback:     <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/function" target="_blank" >function</a></code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>selectedValue:     <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string" target="_blank" >string</a></code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>showClearButton:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="321" class="link-to-prism">src/combobox/combobox.component.ts:321</a></div>
                            </td>
                        </tr>
    ...
    <h3 id="accessors">
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>placeholder()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="174" class="link-to-prism">src/combobox/combobox.component.ts:174</a></div>
                                </td>
                            </tr>

                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>placeholder(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>openMenuAria(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>closeMenuAria(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>clearSelectionsTitle(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>clearSelectionsAria(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>clearSelectionTitle(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>clearSelectionAria(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
...
export class ComboBox implements OnChanges, AfterViewInit, AfterContentInit {
    ...
    <div class="tab-pane fade " id="c-example">
            <iframe class="exampleContainer" src="../../iframe.html?id&#x3D;combobox--basic">
                <p>no-iframes</p>
            </iframe>
    </div>
...
<script>
        var COMPONENT_TEMPLATE = '<div><label *ngIf="label" [for]="id" class="bx--label">	<ng-container *ngIf="!isTemplate(label)">{{label}}</ng-container>	<ng-template *ngIf="isTemplate(label)" [ngTemplateOutlet]="label"></ng-template></label><div *ngIf="helperText" class="bx--form__helper-text">	<ng-container *ngIf="!isTemplate(helperText)">{{helperText}}</ng-container>	<ng-template *ngIf="isTemplate(helperText)" [ngTemplateOutlet]="helperText"></ng-template></div><div	[ngClass]="{		\'bx--multi-select\': type === \'multi\',		\'bx--combo-box\': type === \'single\' || !pills.length,		\'bx--list-box--disabled\': disabled	}"	class="bx--combo-box bx--list-box"	role="listbox"	[attr.data-invalid]="(invalid ? true : null)">	<div		[attr.aria-expanded]="open"		role="button"		class="bx--list-box__field"		type="button"		tabindex="-1"		[attr.aria-label]="label"		aria-haspopup="true"		(click)="toggleDropdown()"		[id]="id">		<div			*ngIf="type === \'multi\' && pills.length > 0"			(click)="clearSelected()"			(keydown.enter)="clearSelected()"			role="button"			class="bx--tag--filter bx--list-box__selection--multi"			tabindex="0"			[title]="clearSelectionsTitle"			[attr.aria-label]="clearSelectionAria">			{{ pills.length }}			<svg				focusable="false"				preserveAspectRatio="xMidYMid meet"				style="will-change: transform;"				role="img"				xmlns="http://www.w3.org/2000/svg"				width="16"				height="16"				viewBox="0 0 16 16"				aria-hidden="true">				<path d="M12 4.7l-.7-.7L8 7.3 4.7 4l-.7.7L7.3 8 4 11.3l.7.7L8 8.7l3.3 3.3.7-.7L8.7 8z"></path>			</svg>		</div>		<input			#input			[disabled]="disabled"			(keyup)="onSearch($event.target.value)"			(keydown.enter)="onSubmit($event)"			[value]="selectedValue"			class="bx--text-input"			[ngClass]="{\'bx--text-input--empty\': !showClearButton}"			role="searchbox"			tabindex="0"			[attr.aria-aria-labelledby]="id"			[attr.maxlength]="maxLength"			aria-haspopup="true"			autocomplete="list"			[placeholder]="placeholder"/>		<ibm-icon-warning-filled16 *ngIf="invalid" class="bx--list-box__invalid-icon"></ibm-icon-warning-filled16>		<div			*ngIf="showClearButton"			role="button"			class="bx--list-box__selection"			tabindex="0"			[attr.aria-label]="clearSelectionAria"			[title]="clearSelectionTitle"			(click)="clearInput($event)">			<ibm-icon-close16></ibm-icon-close16>		</div>		<ibm-icon-chevron-down16			[ngClass]="{\'bx--list-box__menu-icon--open\': open}"			class="bx--list-box__menu-icon"			[title]="open ? closeMenuAria : openMenuAria"			[ariaLabel]="open ? closeMenuAria : openMenuAria">		</ibm-icon-chevron-down16>	</div>	<div		#dropdownMenu		*ngIf="open">		<ng-content></ng-content>	</div></div><div *ngIf="invalid">	<div *ngIf="!isTemplate(invalidText)" class="bx--form-requirement">{{ invalidText }}</div>	<ng-template *ngIf="isTemplate(invalidText)" [ngTemplateOutlet]="invalidText"></ng-template></div>	</div>'
