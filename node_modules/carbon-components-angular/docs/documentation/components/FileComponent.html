...
<p class="comment">
    <code>src/file-uploader/file.component.ts</code>
</p>
    ...
    <table class="table table-sm table-hover">
        <tbody>
            ...
            <tr>
                ...
                <td class="col-md-9"><code>ibm-file</code></td>
            </tr>
            ...
            <tr>
                ...
                <td class="col-md-9"><pre class="line-numbers"><code class="language-html">&lt;p class&#x3D;&quot;bx--file-filename&quot;&gt;{{fileItem.file.name}}&lt;/p&gt;
&lt;span
        ...
        <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <ul class="index-list">
                            <li>
                                <a href="#class.bx--file__selected-file">class.bx--file__selected-file</a>
                            </li>
                            <li>
                                <a href="#class.bx--file__selected-file--invalid">class.bx--file__selected-file--invalid</a>
                            </li>
                        </ul>
                    </td>
                </tr>
...
<code>constructor(i18n: <a href="../injectables/I18n.html">I18n</a>)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                <div class="io-line">Defined in <a href="" data-line="65" class="link-to-prism">src/file-uploader/file.component.ts:65</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>A single <code>FileItem</code> from the set of <code>FileItem</code>s</p>
</div>
                            <p>
                            <em>Type :</em>    <code><a href="../interfaces/FileItem.html" target="_self" >FileItem</a></code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="57" class="link-to-prism">src/file-uploader/file.component.ts:57</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Accessible translations for the close and complete icons</p>
</div>
                        <p>
                            <em>Default value : </em><code>this.i18n.get().FILE_UPLOADER</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="53" class="link-to-prism">src/file-uploader/file.component.ts:53</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="59" class="link-to-prism">src/file-uploader/file.component.ts:59</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
    ...
    <h3>HostBindings</h3>        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="class.bx--file__selected-file"></a>
                        <span class="name">
                            <b>
                            class.bx--file__selected-file
                            </b>
                            <a href="#class.bx--file__selected-file"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <code>class.bx--file__selected-file:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="61" class="link-to-prism">src/file-uploader/file.component.ts:61</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="class.bx--file__selected-file--invalid"></a>
                        <span class="name">
                            <b>
                            class.bx--file__selected-file--invalid
                            </b>
                            <a href="#class.bx--file__selected-file--invalid"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <code>class.bx--file__selected-file--invalid:     <code></code>
</code>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="63" class="link-to-prism">src/file-uploader/file.component.ts:63</a></div>
                            </td>
                        </tr>
...
<code>ngOnDestroy()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="69" class="link-to-prism">src/file-uploader/file.component.ts:69</a></div>
                            </td>
                        </tr>
...
<script>
        var COMPONENT_TEMPLATE = '<div><p class="bx--file-filename">{{fileItem.file.name}}</p><span	*ngIf="fileItem.state === \'edit\'"	class="bx--file__state-container"	(click)="remove.emit()"	(keyup.enter)="remove.emit()"	(keyup.space)="remove.emit()"	tabindex="0">	<ibm-icon-warning-filled16		*ngIf="isInvalidText"		class="bx--file--invalid">	</ibm-icon-warning-filled16>	<ibm-icon-close16		class="bx--file-close"		[ariaLabel]="translations.REMOVE_BUTTON">	</ibm-icon-close16></span><span *ngIf="fileItem.state === \'upload\'">	<div class="bx--inline-loading__animation">		<ibm-loading size="sm"></ibm-loading>	</div></span><span	*ngIf="fileItem.state === \'complete\'"	class="bx--file__state-container"	tabindex="0">	<ibm-icon-checkmark-filled16		class="bx--file-complete"		[ariaLabel]="translations.CHECKMARK">	</ibm-icon-checkmark-filled16></span>	</div>'
...
<script src="../js/tree.js"></script>
    ...
    <div class="no-results">
       ...
       <script>
            ...
            var COMPODOC_CURRENT_PAGE_URL = 'FileComponent.html';
       </script>
