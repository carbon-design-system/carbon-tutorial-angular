...
<p class="comment">
    ...
    <p class="comment">
        <p><a href="../../?path=/story/number--basic">See demo</a></p>
<p><example-url>../../iframe.html?id=number--basic</example-url></p>
...
<section>
    ...
    provide: NG_VALUE_ACCESSOR, useExisting: NumberComponent, multi: true
            ...
            <tr>
                ...
                <td class="col-md-9"><code>ibm-number</code></td>
            </tr>
            ...
            <tr>
                ...
                <td class="col-md-9"><pre class="line-numbers"><code class="language-html">&lt;label *ngIf&#x3D;&quot;skeleton &amp;&amp; label&quot; class&#x3D;&quot;bx--label bx--skeleton&quot;&gt;&lt;/label&gt;
...
<code>constructor(i18n: <a href="../injectables/I18n.html">I18n</a>)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                <div class="io-line">Defined in <a href="" data-line="199" class="link-to-prism">src/number-input/number.component.ts:199</a></div>
                            </td>
                        </tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="179" class="link-to-prism">src/number-input/number.component.ts:179</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> for a disabled number input.</p>
</div>
                        <p>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="167" class="link-to-prism">src/number-input/number.component.ts:167</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>The unique id for the number component.</p>
</div>
                        <p>
                            <em>Default value : </em><code>&#x60;number-${NumberComponent.numberCount}&#x60;</code>
                        </p>
                    </td>
                </tr>
                        <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> for an invalid number component.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="171" class="link-to-prism">src/number-input/number.component.ts:171</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="163" class="link-to-prism">src/number-input/number.component.ts:163</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Sets the max attribute on the <code>input</code> element.</p>
</div>
                        <p>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Sets the min attribute on the <code>input</code> element.</p>
</div>
                        <p>
                            <em>Default value : </em><code>null</code>
                        </p>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> for a loading number component.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p><code>light</code> or <code>dark</code> number input theme.</p>
</div>
                            <p>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Emits event notifying other classes when a change in state occurs in the input.</p>
</div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="112" class="link-to-prism">src/number-input/number.component.ts:112</a></div>
                            </td>
                        </tr>
...
<code>focusout()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="232" class="link-to-prism">src/number-input/number.component.ts:232</a></div>
                            </td>
                        </tr>
...
<code>getDecrementLabel()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="273" class="link-to-prism">src/number-input/number.component.ts:273</a></div>
                            </td>
                        </tr>
...
<code>getIncrementLabel()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="277" class="link-to-prism">src/number-input/number.component.ts:277</a></div>
                            </td>
                        </tr>
...
<code>onDecrement()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="266" class="link-to-prism">src/number-input/number.component.ts:266</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                            <div class="io-description"><p>Subtracts 1 to the current <code>value</code>.</p>
</div>
...
<code>onIncrement()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="256" class="link-to-prism">src/number-input/number.component.ts:256</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                            <div class="io-description"><p>Adds 1 to the current <code>value</code>.</p>
</div>
                                        ...
                                        <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <td>
                                                                <code><p>Callback to be triggered when the number input is touched.</p>
</code>
                                                        </td>
                                                </tr>
                                        </tbody>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="212" class="link-to-prism">src/number-input/number.component.ts:212</a></div>
                            </td>
                        </tr>
    ...
    <section>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_decrementLabel:     <code><a href="../classes/Overridable.html" target="_self" >Overridable</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="198" class="link-to-prism">src/number-input/number.component.ts:198</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_incrementLabel:     <code><a href="../classes/Overridable.html" target="_self" >Overridable</a></code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_value:     <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/number" target="_blank" >number</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="196" class="link-to-prism">src/number-input/number.component.ts:196</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>numberCount:     <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/number" target="_blank" >number</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="110" class="link-to-prism">src/number-input/number.component.ts:110</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="246" class="link-to-prism">src/number-input/number.component.ts:246</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>value()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="149" class="link-to-prism">src/number-input/number.component.ts:149</a></div>
                                </td>
                            </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>decrementLabel()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="183" class="link-to-prism">src/number-input/number.component.ts:183</a></div>
                                </td>
                            </tr>

                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>decrementLabel(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>incrementLabel()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="192" class="link-to-prism">src/number-input/number.component.ts:192</a></div>
                                </td>
                            </tr>

                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>incrementLabel(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
...
export { NumberComponent as Number };
    ...
    <div class="tab-pane fade " id="c-example">
            <iframe class="exampleContainer" src="../../iframe.html?id&#x3D;number--basic">
                <p>no-iframes</p>
            </iframe>
    </div>
...
<script>
        var COMPONENT_TEMPLATE = '<div><label *ngIf="skeleton && label" class="bx--label bx--skeleton"></label><label *ngIf="!skeleton && label" [for]="id" class="bx--label">	<ng-container *ngIf="!isTemplate(label)">{{label}}</ng-container>	<ng-template *ngIf="isTemplate(label)" [ngTemplateOutlet]="label"></ng-template></label><div *ngIf="helperText" class="bx--form__helper-text">	<ng-container *ngIf="!isTemplate(helperText)">{{helperText}}</ng-container>	<ng-template *ngIf="isTemplate(helperText)" [ngTemplateOutlet]="helperText"></ng-template></div><div	data-numberinput	[attr.data-invalid]="(invalid ? true : null)"	class="bx--number"	[ngClass]="{		\'bx--number--light\': theme === \'light\',		\'bx--number--nolabel\': !label,		\'bx--number--helpertext\': helperText,		\'bx--skeleton\' : skeleton	}">	<div class="bx--number__input-wrapper">		<input			type="number"			[id]="id"			[value]="value"			[attr.min]="min"			[attr.max]="max"			[disabled]="disabled"			[required]="required"			(input)="onNumberInputChange($event)"/>		<ibm-icon-warning-filled16			*ngIf="!skeleton && invalid"			class="bx--number__invalid"			style="display: inherit;">		</ibm-icon-warning-filled16>		<div *ngIf="!skeleton" class="bx--number__controls">			<button				class="bx--number__control-btn up-icon"				type="button"				aria-live="polite"				aria-atomic="true"				[attr.aria-label]="getIncrementLabel() | async"				(click)="onIncrement()">				<ibm-icon-caret-up16></ibm-icon-caret-up16>			</button>			<button				class="bx--number__control-btn down-icon"				type="button"				aria-live="polite"				aria-atomic="true"				[attr.aria-label]="getDecrementLabel() | async"				(click)="onDecrement()">				<ibm-icon-caret-down16></ibm-icon-caret-down16>			</button>		</div>	</div>	<div *ngIf="invalid" class="bx--form-requirement">		<ng-container *ngIf="!isTemplate(invalidText)">{{invalidText}}</ng-container>		<ng-template *ngIf="isTemplate(invalidText)" [ngTemplateOutlet]="invalidText"></ng-template>	</div></div>	</div>'
