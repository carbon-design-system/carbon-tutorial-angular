...
<p><a href="../../?path=/story/overflow-menu--basic">See demo</a></p>
<p>html:</p>
<div><pre class="line-numbers"><code class="language-none"> * &lt;ibm-overflow-menu&gt;
 *    &lt;ibm-overflow-menu-option&gt;Option 1&lt;/ibm-overflow-menu-option&gt;
 *    &lt;ibm-overflow-menu-option&gt;Option 2&lt;/ibm-overflow-menu-option&gt;
 * &lt;/ibm-overflow-menu&gt;
 *</code></pre></div><p><example-url>../../iframe.html?id=overflow-menu--basic</example-url></p>
    ...
    <table class="table table-sm table-hover">
        <tbody>
            ...
            <tr>
                ...
                <td class="col-md-9"><code>ibm-overflow-menu</code></td>
            </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <p>
                            <em>Default value : </em><code>this.i18n.get().OVERFLOW_MENU.OVERFLOW</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="73" class="link-to-prism">src/dialog/overflow-menu/overflow-menu.component.ts:73</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Sets the custom overflow menu trigger</p>
</div>
                            <p>
                            <em>Type :</em>    <code>TemplateRef&lt;any&gt;</code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="89" class="link-to-prism">src/dialog/overflow-menu/overflow-menu.component.ts:89</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="75" class="link-to-prism">src/dialog/overflow-menu/overflow-menu.component.ts:75</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="82" class="link-to-prism">src/dialog/overflow-menu/overflow-menu.component.ts:82</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                            <p>
                            <em>Type :</em>    <code>&quot;bottom&quot; | &quot;top&quot;</code>

                            </p>
                        <p>
                            <em>Default value : </em><code>&quot;bottom&quot;</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="77" class="link-to-prism">src/dialog/overflow-menu/overflow-menu.component.ts:77</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="84" class="link-to-prism">src/dialog/overflow-menu/overflow-menu.component.ts:84</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
    ...
    <section>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <code>overflowMenuDirective:     <code><a href="../components/OverflowMenu.html" target="_self" >OverflowMenuDirective</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                        <td class="col-md-4">
                            <i>Type : </i>    <code><a href="../components/OverflowMenu.html" target="_self" >OverflowMenuDirective</a></code>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="91" class="link-to-prism">src/dialog/overflow-menu/overflow-menu.component.ts:91</a></div>
                            </td>
                        </tr>
...
export class OverflowMenu {
    ...
    <div class="tab-pane fade " id="c-example">
            <iframe class="exampleContainer" src="../../iframe.html?id&#x3D;overflow-menu--basic">
                <p>no-iframes</p>
            </iframe>
    </div>
...
<script>
        var COMPONENT_TEMPLATE = '<div><div	[ibmOverflowMenu]="options"	[ngClass]="{\'bx--overflow-menu--open\': open}"	[attr.aria-label]="buttonLabel"	[flip]="flip"	[offset]="offset"	[wrapperClass]="wrapperClass"	(onOpen)="open = true"	(onClose)="open = false"	role="button"	aria-haspopup="true"	class="bx--overflow-menu"	[placement]="placement"	tabindex="0">	<ng-template *ngIf="customTrigger; else defaultIcon" [ngTemplateOutlet]="customTrigger"></ng-template></div><ng-template #options>	<ng-content></ng-content></ng-template><ng-template #defaultIcon>	<svg icon ibmIconOverflowMenuVertical16 class="bx--overflow-menu__icon"></svg></ng-template>	</div>'
    ...
    var ACTUAL_COMPONENT = {'name': 'OverflowMenu'};
</script>
<script src="../js/tree.js"></script>
    ...
    <div class="no-results">
       ...
       <script>
            ...
            var COMPODOC_CURRENT_PAGE_URL = 'OverflowMenu.html';
       </script>
