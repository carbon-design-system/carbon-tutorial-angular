...
<p class="comment">
    ...
    <p class="comment">
        <p><a href="../../?path=/story/file-uploader--basic">See demo</a></p>
<p><example-url>../../iframe.html?id=file-uploader--basic</example-url></p>
...
<section>
    ...
    provide: NG_VALUE_ACCESSOR, useExisting: FileUploader, multi: true
            ...
            <tr>
                ...
                <td class="col-md-9"><code>ibm-file-uploader</code></td>
            </tr>
...
<code>constructor(i18n: <a href="../injectables/I18n.html">I18n</a>)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                <div class="io-line">Defined in <a href="" data-line="163" class="link-to-prism">src/file-uploader/file-uploader.component.ts:163</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Specify the types of files that the input should be able to receive</p>
</div>
                        <p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="116" class="link-to-prism">src/file-uploader/file-uploader.component.ts:116</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Accessible text for the button that opens the upload window.</p>
<p>Defaults to the <code>FILE_UPLOADER.OPEN</code> value from the i18n service</p>
</div>
                        <p>
                            <em>Default value : </em><code>this.i18n.get().FILE_UPLOADER.OPEN</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="100" class="link-to-prism">src/file-uploader/file-uploader.component.ts:100</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Type set for button</p>
</div>
                            <p>
                            <em>Type :</em>    <code>&quot;primary&quot; | &quot;secondary&quot; | &quot;tertiary&quot; | &quot;ghost&quot; | &quot;danger&quot;</code>

                            </p>
                        <p>
                            <em>Default value : </em><code>&quot;primary&quot;</code>
                        </p>
                    </td>
                </tr>
                        <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Text set to the description</p>
</div>
                            <p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="112" class="link-to-prism">src/file-uploader/file-uploader.component.ts:112</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> to disable upload button or drop container</p>
</div>
                        <p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="154" class="link-to-prism">src/file-uploader/file-uploader.component.ts:154</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> to enable drag and drop.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="134" class="link-to-prism">src/file-uploader/file-uploader.component.ts:134</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Sets the text shown in drag and drop box.</p>
</div>
                            <p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="138" class="link-to-prism">src/file-uploader/file-uploader.component.ts:138</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>The list of files that have been submitted to be uploaded</p>
</div>
                            <p>
                            <em>Type :</em>    <code>Set</code>

                            </p>
                        <p>
                            <em>Default value : </em><code>new Set&lt;FileItem&gt;()</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="150" class="link-to-prism">src/file-uploader/file-uploader.component.ts:150</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>fileUploaderId</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Provides a unique id for the underlying <input> node</p>
</div>
                        <p>
                            <em>Default value : </em><code>&#x60;file-uploader-${FileUploader.fileUploaderCount}&#x60;</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="142" class="link-to-prism">src/file-uploader/file-uploader.component.ts:142</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>false</code> to tell the component to only accept a single file on upload.</p>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Sets the size of the button.</p>
</div>
                            <p>
                            <em>Type :</em>    <code>&quot;sm&quot; | &quot;normal&quot;</code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="130" class="link-to-prism">src/file-uploader/file-uploader.component.ts:130</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> for a loading file uploader.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="108" class="link-to-prism">src/file-uploader/file-uploader.component.ts:108</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="155" class="link-to-prism">src/file-uploader/file-uploader.component.ts:155</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="265" class="link-to-prism">src/file-uploader/file-uploader.component.ts:265</a></div>
                            </td>
                        </tr>
...
<code>onBlur()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="182" class="link-to-prism">src/file-uploader/file-uploader.component.ts:182</a></div>
                            </td>
                        </tr>
...
<code>onDragLeave(event)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="228" class="link-to-prism">src/file-uploader/file-uploader.component.ts:228</a></div>
                            </td>
                        </tr>
...
<code>onDragOver(event)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="222" class="link-to-prism">src/file-uploader/file-uploader.component.ts:222</a></div>
                            </td>
                        </tr>
...
<code>onDrop(event)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="234" class="link-to-prism">src/file-uploader/file-uploader.component.ts:234</a></div>
                            </td>
                        </tr>
...
<code>onFilesAdded()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="209" class="link-to-prism">src/file-uploader/file-uploader.component.ts:209</a></div>
                            </td>
                        </tr>
...
<code>registerOnChange(fn: <a href="https://www.typescriptlang.org/docs/handbook/basic-types.html" target="_blank">any</a>)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="278" class="link-to-prism">src/file-uploader/file-uploader.component.ts:278</a></div>
                            </td>
                        </tr>
...
<code>registerOnTouched(fn: <a href="https://www.typescriptlang.org/docs/handbook/basic-types.html" target="_blank">any</a>)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="272" class="link-to-prism">src/file-uploader/file-uploader.component.ts:272</a></div>
                            </td>
                        </tr>
...
<code>removeFile(fileItem)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="257" class="link-to-prism">src/file-uploader/file-uploader.component.ts:257</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
<code>writeValue(value: <a href="../interfaces/FileItem.html">Set<FileItem></a>)</code>
                    </td>
                </tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="193" class="link-to-prism">src/file-uploader/file-uploader.component.ts:193</a></div>
                            </td>
                        </tr>
    ...
    <section>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>dragOver:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="146" class="link-to-prism">src/file-uploader/file-uploader.component.ts:146</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>fileUploaderCount:     <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/number" target="_blank" >number</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="94" class="link-to-prism">src/file-uploader/file-uploader.component.ts:94</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>onChangeCallback:     <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/function" target="_blank" >function</a></code>
</code>
                    </td>
                </tr>
                    <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="162" class="link-to-prism">src/file-uploader/file-uploader.component.ts:162</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>value(v)</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="175" class="link-to-prism">src/file-uploader/file-uploader.component.ts:175</a></div>
                                </td>
                            </tr>
                    <tr>
                        <td class="col-md-4">
...
export class FileUploader {
    ...
    <div class="tab-pane fade " id="c-example">
            <iframe class="exampleContainer" src="../../iframe.html?id&#x3D;file-uploader--basic">
                <p>no-iframes</p>
            </iframe>
    </div>
...
<script>
        var COMPONENT_TEMPLATE = '<div><ng-container *ngIf="!skeleton; else skeletonTemplate">	<label [for]="fileUploaderId" class="bx--file--label">{{title}}</label>	<p class="bx--label-description">{{description}}</p>	<div class="bx--file">		<label			*ngIf="drop"			class="bx--file-browse-btn"			[ngClass]="{\'bx--file-browse-btn--disabled\': disabled}">			<div				class="bx--file__drop-container"				[ngClass]="{\'bx--file__drop-container--drag-over\': dragOver}"				role="button"				(click)="fileInput.click()"				[attr.for]="fileUploaderId"				(dragover)="onDragOver($event)"				(dragleave)="onDragLeave($event)"				(drop)="onDrop($event)">				<ng-container *ngIf="!isTemplate(dropText)">{{dropText}}</ng-container>				<ng-template *ngIf="isTemplate(dropText)" [ngTemplateOutlet]="dropText"></ng-template>			</div>		</label>		<button			*ngIf="!drop"			type="button"			[ibmButton]="buttonType"			(click)="fileInput.click()"			[attr.for]="fileUploaderId"			[size]="size"			[disabled]="disabled">			{{buttonText}}		</button>		<input			#fileInput			type="file"			class="bx--file-input"			[accept]="accept"			[id]="fileUploaderId"			[disabled]="disabled"			[multiple]="multiple"			tabindex="-1"			(change)="onFilesAdded()"/>		<div class="bx--file-container">			<div *ngFor="let fileItem of files">				<ibm-file [fileItem]="fileItem" (remove)="removeFile(fileItem)"></ibm-file>				<div *ngIf="fileItem.invalid" class="bx--form-requirement">					{{fileItem.invalidText}}				</div>			</div>		</div>	</div></ng-container><ng-template #skeletonTemplate>	<div class="bx--skeleton__text" style="width: 100px"></div>	<div class="bx--skeleton__text" style="width: 225px"></div>	<button ibmButton skeleton="true"></button></ng-template>	</div>'
