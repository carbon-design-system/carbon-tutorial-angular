...
<p><a href="../../?path=/story/dropdown--basic">See demo</a></p>
<p><example-url>../../iframe.html?id=dropdown--basic</example-url></p>
...
<section>
    ...
    provide: NG_VALUE_ACCESSOR, useExisting: Dropdown, multi: true
            ...
            <tr>
                ...
                <td class="col-md-9"><code>ibm-dropdown</code></td>
            </tr>
            ...
            <tr>
                ...
                <td class="col-md-9"><pre class="line-numbers"><code class="language-html">&lt;label *ngIf&#x3D;&quot;label&quot; class&#x3D;&quot;bx--label&quot;&gt;
    ...
    <h3 id="constructor">Constructor</h3>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
<code>constructor(elementRef: <a href="https://angular.io/api/core/ElementRef" target="_blank">ElementRef</a>, i18n: <a href="../injectables/I18n.html">I18n</a>, dropdownService: <a href="../injectables/DropdownService.html">DropdownService</a>, appRef: <a href="https://angular.io/api/core/ApplicationRef" target="_blank">ApplicationRef</a>, elementService: <a href="../injectables/ElementService.html">ElementService</a>)</code>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-4">
                                <div class="io-line">Defined in <a href="" data-line="290" class="link-to-prism">src/dropdown/dropdown.component.ts:290</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>set to <code>true</code> to place the dropdown view inline with the component</p>
</div>
                        <p>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Deprecated. Dropdown now defaults to appending inline
Set to <code>true</code> if the <code>Dropdown</code> is to be appended to the DOM body.</p>
</div>
                    </td>
                </tr>
                        <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Sets the optional clear button tooltip text.</p>
</div>
                            <p>
                        ...
                        <p>
                            <em>Default value : </em><code>this.i18n.get().DROPDOWN.CLEAR</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="153" class="link-to-prism">src/dropdown/dropdown.component.ts:153</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>disableArrowKeys</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> for a dropdown without arrow key activation.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="182" class="link-to-prism">src/dropdown/dropdown.component.ts:182</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> to disable the dropdown.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="170" class="link-to-prism">src/dropdown/dropdown.component.ts:170</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>The selected value from the <code>Dropdown</code>. Can be a string or template.</p>
</div>
                            <p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="149" class="link-to-prism">src/dropdown/dropdown.component.ts:149</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> for an inline dropdown.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> for invalid state.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="186" class="link-to-prism">src/dropdown/dropdown.component.ts:186</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Value displayed if dropdown is in invalid state.</p>
</div>
                        <p>
                            <em>Default value : </em><code>&quot;&quot;</code>
                        </p>
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>itemValueKey</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Specifies the property to be used as the return value to <code>ngModel</code></p>
</div>
                            <p>
                            <em>Type :</em>    <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string" target="_blank" >string</a></code>
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>menuButtonLabel</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Accessible label for the button that opens the dropdown list.
Defaults to the <code>DROPDOWN.OPEN</code> value from the i18n service.</p>
</div>
                        <p>
                            <em>Default value : </em><code>this.i18n.get().DROPDOWN.OPEN</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="235" class="link-to-prism">src/dropdown/dropdown.component.ts:235</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Value displayed if no item is selected.</p>
</div>
                        <p>
                            <em>Default value : </em><code>&quot;&quot;</code>
                        </p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="145" class="link-to-prism">src/dropdown/dropdown.component.ts:145</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Query string for the element that contains the <code>Dropdown</code>.
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Provides the label for the &quot;# selected&quot; text.
Defaults to the <code>DROPDOWN.SELECTED</code> value from the i18n service.</p>
</div>
                        <p>
                            <em>Default value : </em><code>this.i18n.get().DROPDOWN.SELECTED</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="240" class="link-to-prism">src/dropdown/dropdown.component.ts:240</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Size to render the dropdown field.</p>
</div>
                            <p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="157" class="link-to-prism">src/dropdown/dropdown.component.ts:157</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> for a loading dropdown.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="174" class="link-to-prism">src/dropdown/dropdown.component.ts:174</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p><code>light</code> or <code>dark</code> dropdown theme</p>
</div>
                            <p>
                            <em>Type :</em>    <code>&quot;light&quot; | &quot;dark&quot;</code>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Defines whether or not the <code>Dropdown</code> supports selecting multiple items as opposed to single
item selection.</p>
</div>
                            <p>
                            <em>Type :</em>    <code>&quot;single&quot; | &quot;multi&quot;</code>

                            </p>
                        <p>
                            <em>Default value : </em><code>&quot;single&quot;</code>
                        </p>
                    </td>
                </tr>
                        <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Deprecated. Use <code>itemValueKey</code> instead.
Specifies the property to be used as the return value to <code>ngModel</code></p>
</div>
                            <p>
                            <em>Type :</em>    <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string" target="_blank" >string</a></code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="219" class="link-to-prism">src/dropdown/dropdown.component.ts:219</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Emits event notifying to other classes that the <code>Dropdown</code> has been closed (collapsed).</p>
</div>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="248" class="link-to-prism">src/dropdown/dropdown.component.ts:248</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Emits selection events.</p>
</div>
                        <em><code>$event</code> Type:</em>    <code>EventEmitter&lt;Object&gt;</code>
...
<code>keydown(event: KeyboardEvent)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="441" class="link-to-prism">src/dropdown/dropdown.component.ts:441</a></div>
                            </td>
                        </tr>
...
<code>_appendToBody()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="600" class="link-to-prism">src/dropdown/dropdown.component.ts:600</a></div>
                            </td>
                        </tr>
...
<code>_keyboardNav(event: KeyboardEvent)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="571" class="link-to-prism">src/dropdown/dropdown.component.ts:571</a></div>
                            </td>
                        </tr>
...
<code>_noop()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="551" class="link-to-prism">src/dropdown/dropdown.component.ts:551</a></div>
                            </td>
                        </tr>
...
<code>closedDropdownNavigation(event)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="473" class="link-to-prism">src/dropdown/dropdown.component.ts:473</a></div>
                            </td>
                        </tr>
...
<code>closeMenu()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="669" class="link-to-prism">src/dropdown/dropdown.component.ts:669</a></div>
                            </td>
                        </tr>
...
<code>getRenderTemplateContext()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="514" class="link-to-prism">src/dropdown/dropdown.component.ts:514</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                            ...
                            <div class="io-description">
                                <b>Returns : </b>    <code>{ items: any; item?: undefined; } | { item: any; items?: undefined; } | { items?: undefined; item...</code>
...
<code>isRenderString()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="510" class="link-to-prism">src/dropdown/dropdown.component.ts:510</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="706" class="link-to-prism">src/dropdown/dropdown.component.ts:706</a></div>
                            </td>
                        </tr>
...
<code>ngAfterContentInit()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="315" class="link-to-prism">src/dropdown/dropdown.component.ts:315</a></div>
                            </td>
                        </tr>
...
<code>ngOnDestroy()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="358" class="link-to-prism">src/dropdown/dropdown.component.ts:358</a></div>
                            </td>
                        </tr>
...
<code>onBlur()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="405" class="link-to-prism">src/dropdown/dropdown.component.ts:405</a></div>
                            </td>
                        </tr>
...
<code>openMenu()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="611" class="link-to-prism">src/dropdown/dropdown.component.ts:611</a></div>
                            </td>
                        </tr>
...
<code>registerOnChange(fn: <a href="https://www.typescriptlang.org/docs/handbook/basic-types.html" target="_blank">any</a>)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="409" class="link-to-prism">src/dropdown/dropdown.component.ts:409</a></div>
                            </td>
                        </tr>
...
<code>registerOnTouched(fn: <a href="https://www.typescriptlang.org/docs/handbook/basic-types.html" target="_blank">any</a>)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="416" class="link-to-prism">src/dropdown/dropdown.component.ts:416</a></div>
                            </td>
                        </tr>
                                        ...
                                        <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <td>
                                                                <code><p><code>true</code> to disable the input</p>
</code>
                                                        </td>
                                                </tr>
                                        </tbody>
...
<code>toggleMenu()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="698" class="link-to-prism">src/dropdown/dropdown.component.ts:698</a></div>
                            </td>
                        </tr>
...
<code>valueSelected()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="546" class="link-to-prism">src/dropdown/dropdown.component.ts:546</a></div>
                            </td>
                        </tr>
    ...
    <section>
                ...
                <tr>
                    ...
                    <tr>
                        <td class="col-md-4">
                            ...
                            <br />
                            <code>
                                @ViewChild(&#x27;dropdownButton&#x27;)<br />
                            </code>
                        </td>
                    </tr>
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="261" class="link-to-prism">src/dropdown/dropdown.component.ts:261</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="132" class="link-to-prism">src/dropdown/dropdown.component.ts:132</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="265" class="link-to-prism">src/dropdown/dropdown.component.ts:265</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <span class="name">
                            ...
                            <a href="#dropUp"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <code>dropUp:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="276" class="link-to-prism">src/dropdown/dropdown.component.ts:276</a></div>
                            </td>
                        </tr>

                <tr>
                    <td class="col-md-4">
                        <div class="io-description"><p>controls wether the <code>drop-up</code> class is applied</p>
</div>
                    </td>
                </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="280" class="link-to-prism">src/dropdown/dropdown.component.ts:280</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>onTouchedCallback:     <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/function" target="_blank" >function</a></code>
</code>
                    </td>
                </tr>
                    <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="281" class="link-to-prism">src/dropdown/dropdown.component.ts:281</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="282" class="link-to-prism">src/dropdown/dropdown.component.ts:282</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="423" class="link-to-prism">src/dropdown/dropdown.component.ts:423</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <code>view:     <code><a href="../classes/AbstractDropdownView.html" target="_self" >AbstractDropdownView</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                        <td class="col-md-4">
                            <i>Type : </i>    <code><a href="../classes/AbstractDropdownView.html" target="_self" >AbstractDropdownView</a></code>
                    ...
                    <tr>
                        <td class="col-md-4">
                            ...
                            <br />
                            <code>
                                @ContentChild(AbstractDropdownView)<br />
                            </code>
                        </td>
                    </tr>
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="257" class="link-to-prism">src/dropdown/dropdown.component.ts:257</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>visibilitySubscription:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="285" class="link-to-prism">src/dropdown/dropdown.component.ts:285</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <span class="name">
                            ...
                            <a href="#writtenValue"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>writtenValue:     <code>[]</code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="appendToBody"></a>
                        <span class="name"><b>appendToBody</b><a href="#appendToBody"><span class="icon ion-ios-link"></span></a></span>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>appendToBody(v)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
                    ...
                    <tr>
                        <td class="col-md-4">
                                <div class="io-description"><p>Deprecated. Dropdown now defaults to appending inline
Set to <code>true</code> if the <code>Dropdown</code> is to be appended to the DOM body.</p>
</div>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>value(newValue: <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string" target="_blank">string</a>)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
                    ...
                    <tr>
                        <td class="col-md-4">
                                <div class="io-description"><p>Deprecated. Use <code>itemValueKey</code> instead.
Specifies the property to be used as the return value to <code>ngModel</code></p>
</div>
...
export class Dropdown implements OnInit, AfterContentInit, OnDestroy, ControlValueAccessor {
    ...
    <div class="tab-pane fade " id="c-example">
            <iframe class="exampleContainer" src="../../iframe.html?id&#x3D;dropdown--basic">
                <p>no-iframes</p>
            </iframe>
    </div>
...
<script>
        var COMPONENT_TEMPLATE = '<div><label *ngIf="label" class="bx--label">	<ng-container *ngIf="!isTemplate(label)">{{label}}</ng-container>	<ng-template *ngIf="isTemplate(label)" [ngTemplateOutlet]="label"></ng-template></label><div *ngIf="helperText" class="bx--form__helper-text">	<ng-container *ngIf="!isTemplate(helperText)">{{helperText}}</ng-container>	<ng-template *ngIf="isTemplate(helperText)" [ngTemplateOutlet]="helperText"></ng-template></div><div	[id]="id"	class="bx--dropdown bx--list-box"	[ngClass]="{		\'bx--dropdown--light\': theme === \'light\',		\'bx--list-box--inline\': inline,		\'bx--skeleton\': skeleton,		\'bx--dropdown--disabled bx--list-box--disabled\': disabled,		\'bx--dropdown--invalid\': invalid	}">	<div		role="button"		type="button"		#dropdownButton		class="bx--list-box__field"		[ngClass]="{\'a\': !menuIsClosed}"		[attr.aria-expanded]="!menuIsClosed"		[attr.aria-disabled]="disabled"		(click)="disabled ? $event.stopPropagation() : toggleMenu()"		(blur)="onBlur()"		[attr.disabled]="disabled ? true : null"		[tabindex]="disabled ? -1 : 0">		<div			(click)="clearSelected()"			(keydown.enter)="clearSelected()"			*ngIf="type === \'multi\' && getSelectedCount() > 0"			class="bx--tag--filter bx--list-box__selection--multi"			tabindex="0"			[title]="clearText">			{{getSelectedCount()}}			<svg				focusable="false"				preserveAspectRatio="xMidYMid meet"				style="will-change: transform;"				role="img"				xmlns="http://www.w3.org/2000/svg"				width="16"				height="16"				viewBox="0 0 16 16"				aria-hidden="true">				<path d="M12 4.7l-.7-.7L8 7.3 4.7 4l-.7.7L7.3 8 4 11.3l.7.7L8 8.7l3.3 3.3.7-.7L8.7 8z"></path>			</svg>		</div>		<span *ngIf="isRenderString()" class="bx--list-box__label">{{getDisplayStringValue() | async}}</span>		<ng-template			*ngIf="!isRenderString()"			[ngTemplateOutletContext]="getRenderTemplateContext()"			[ngTemplateOutlet]="displayValue">		</ng-template>		<svg ibmIconWarningFilled16			*ngIf="invalid"			class="bx--dropdown__invalid-icon">		</svg>		<ibm-icon-chevron-down16			*ngIf="!skeleton"			class="bx--list-box__menu-icon"			[attr.aria-label]="menuButtonLabel"			[ngClass]="{\'bx--list-box__menu-icon--open\': !menuIsClosed }">		</ibm-icon-chevron-down16>	</div>	<div		#dropdownMenu		[ngClass]="{			\'drop-up\': dropUp		}">		<ng-content *ngIf="!menuIsClosed"></ng-content>	</div></div><div *ngIf="invalid && invalidText" class="bx--form-requirement">	{{invalidText}}</div></div>'
