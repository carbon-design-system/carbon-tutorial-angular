...
<p class="comment">
    <code>src/search/search.component.ts</code>
</p>
    ...
    <p class="comment">
        <p><a href="../../?path=/story/search--basic">See demo</a></p>
<p><example-url>../../iframe.html?id=search--basic</example-url></p>
...
<section>
    ...
    <table class="table table-sm table-hover">
        <tbody>
            ...
            <tr>
                ...
                <td class="col-md-9">
                            <code><a href="../components/Search.html" target="_self" >{
    provide: NG_VALUE_ACCESSOR, useExisting: Search, multi: true
            ...
            <tr>
                ...
                <td class="col-md-9"><code>ibm-search</code></td>
            </tr>
                    ...
                    <td class="col-md-4">
                        <ul class="index-list">
                            ...
                            <li>
                                ...
                                <a href="#searchCount">searchCount</a>
                            </li>
                        </ul>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <ul class="index-list">
                            ...
                            <li>
                                <a href="#doValueChange">doValueChange</a>
                            </li>
                            <li>
                                <a href="#onEnter">onEnter</a>
                            </li>
                            <li>
                ...
                <tr>
                    <td class="col-md-4">
                        <ul class="index-list">
                            ...
                            <li>
                                <a href="#tableSearch">tableSearch</a>
                            </li>
                            <li>
    ...
    <h3 id="constructor">Constructor</h3>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
<code>constructor(elementRef: <a href="https://angular.io/api/core/ElementRef" target="_blank">ElementRef</a>, i18n: <a href="../injectables/I18n.html">I18n</a>)</code>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-4">
                                <div class="io-line">Defined in <a href="" data-line="145" class="link-to-prism">src/search/search.component.ts:145</a></div>
                            </td>
                        </tr>

                <tr>
                    <td class="col-md-4">
                            <div class="io-description"><p>Creates an instance of <code>Search</code>.</p>
</div>
                            <div>
                                    <b>Parameters :</b>
                                    <table class="params">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <td>
                                                                <code><p>The i18n translations.</p>
</code>
                                                        </td>
                                                </tr>
                                        </tbody>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> to expand the toolbar search component.</p>
</div>
                        <p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="86" class="link-to-prism">src/search/search.component.ts:86</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
...
For refernece: <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete#Values">https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete#Values</a></p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="111" class="link-to-prism">src/search/search.component.ts:111</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-2">
                        <a name="clearButtonTitle"></a>
                        <code>clearButtonTitle</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Used to set the <code>title</code> attribute of the clear button.</p>
</div>
                        <p>
                            <em>Default value : </em><code>this.i18n.get().SEARCH.CLEAR_BUTTON</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="123" class="link-to-prism">src/search/search.component.ts:123</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> for a disabled search input.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="74" class="link-to-prism">src/search/search.component.ts:74</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>The unique id for the search component.</p>
</div>
                        <p>
                            <em>Default value : </em><code>&#x60;search-${Search.searchCount}&#x60;</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="98" class="link-to-prism">src/search/search.component.ts:98</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <p>
                            <em>Default value : </em><code>this.i18n.get().SEARCH.LABEL</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="115" class="link-to-prism">src/search/search.component.ts:115</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="94" class="link-to-prism">src/search/search.component.ts:94</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Sets the placeholder attribute on the <code>input</code> element.</p>
</div>
                        <p>
                            <em>Default value : </em><code>this.i18n.get().SEARCH.PLACEHOLDER</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="119" class="link-to-prism">src/search/search.component.ts:119</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="102" class="link-to-prism">src/search/search.component.ts:102</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Size of the search field.</p>
</div>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="60" class="link-to-prism">src/search/search.component.ts:60</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> for a loading search component.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="82" class="link-to-prism">src/search/search.component.ts:82</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>tableSearch</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Specifies whether the search component is used in the table toolbar.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="90" class="link-to-prism">src/search/search.component.ts:90</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p><code>light</code> or <code>dark</code> search theme.</p>
</div>
                            <p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="56" class="link-to-prism">src/search/search.component.ts:56</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> for a toolbar search component.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="78" class="link-to-prism">src/search/search.component.ts:78</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="106" class="link-to-prism">src/search/search.component.ts:106</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="128" class="link-to-prism">src/search/search.component.ts:128</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Emits an event when the clear button is clicked.</p>
</div>
                        <em><code>$event</code> Type:</em>    <code><a href="https://angular.io/api/core/EventEmitter" target="_blank" >EventEmitter</a></code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="141" class="link-to-prism">src/search/search.component.ts:141</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="137" class="link-to-prism">src/search/search.component.ts:137</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Emits an event on enter.</p>
</div>
                        <em><code>$event</code> Type:</em>    <code><a href="https://angular.io/api/core/EventEmitter" target="_blank" >EventEmitter</a></code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="136" class="link-to-prism">src/search/search.component.ts:136</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Emits an event when value is changed.</p>
</div>
                        <em><code>$event</code> Type:</em>    <code><a href="https://angular.io/api/core/EventEmitter" target="_blank" >EventEmitter</a></code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="132" class="link-to-prism">src/search/search.component.ts:132</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="51" class="link-to-prism">src/search/search.component.ts:51</a></div>
                            </td>
                        </tr>
...
<code>focusout(event)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="240" class="link-to-prism">src/search/search.component.ts:240</a></div>
                            </td>
                        </tr>
...
<code>keydown(event: KeyboardEvent)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="229" class="link-to-prism">src/search/search.component.ts:229</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <span class="name">
                            ...
                            <a href="#clearSearch"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
...
<code>clearSearch()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="207" class="link-to-prism">src/search/search.component.ts:207</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="doValueChange"></a>
                        <span class="name">
                            <b>
                            doValueChange
                            </b>
                            <a href="#doValueChange"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
<code>doValueChange()</code>
                    </td>
                </tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="213" class="link-to-prism">src/search/search.component.ts:213</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <span class="name">
                            ...
                            <a href="#onEnter"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
...
<code>onEnter()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="200" class="link-to-prism">src/search/search.component.ts:200</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
<code>onSearch(search: <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string" target="_blank">string</a>)</code>
                    </td>
                </tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="192" class="link-to-prism">src/search/search.component.ts:192</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <span class="name">
                            ...
                            <a href="#openSearch"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
...
<code>openSearch()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="222" class="link-to-prism">src/search/search.component.ts:222</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="166" class="link-to-prism">src/search/search.component.ts:166</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="174" class="link-to-prism">src/search/search.component.ts:174</a></div>
                            </td>
                        </tr>
                                        ...
                                        <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <td>
                                                                <code><p>Callback to be triggered when the search input is touched.</p>
</code>
                                                        </td>
                                                </tr>
                                        </tbody>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="159" class="link-to-prism">src/search/search.component.ts:159</a></div>
                            </td>
                        </tr>
    ...
    <section>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <span class="name">
                            ...
                            <a href="#_size"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_size:     <code>&quot;sm&quot; | &quot;xl&quot;</code>
</code>
                    </td>
                </tr>
                    <tr>
                        <td class="col-md-4">
                            <i>Type : </i>    <code>&quot;sm&quot; | &quot;xl&quot;</code>

                        </td>
                    </tr>
                    <tr>
                        <td class="col-md-4">
                            <i>Default value : </i><code>&quot;xl&quot;</code>
                        </td>
                    </tr>
                        <tr>
                            <td class="col-md-4">
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <code>inputRef:     <code><a href="https://angular.io/api/core/ElementRef" target="_blank" >ElementRef</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="143" class="link-to-prism">src/search/search.component.ts:143</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="181" class="link-to-prism">src/search/search.component.ts:181</a></div>
                            </td>
                        </tr>

                <tr>
                    <td class="col-md-4">
                        <div class="io-description"><p>Called when search input is blurred. Needed to properly implement <code>ControlValueAccessor</code>.</p>
</div>
                    </td>
                </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="186" class="link-to-prism">src/search/search.component.ts:186</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <span class="name">
                            ...
                            <a href="#searchCount"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>searchCount:     <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/number" target="_blank" >number</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="49" class="link-to-prism">src/search/search.component.ts:49</a></div>
                            </td>
                        </tr>

                <tr>
                    <td class="col-md-4">
                        <div class="io-description"><p>Variable used for creating unique ids for search components.</p>
</div>
                    </td>
                </tr>
    ...
    <h3 id="accessors">
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>size()</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="68" class="link-to-prism">src/search/search.component.ts:68</a></div>
                                </td>
                            </tr>

                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>size(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
                    ...
                    <tr>
                        <td class="col-md-4">
                                <div class="io-description"><p>Size of the search field.</p>
</div>
...
&lt;/div&gt;
    ...
    <div class="tab-pane fade " id="c-example">
            <iframe class="exampleContainer" src="../../iframe.html?id&#x3D;search--basic">
                <p>no-iframes</p>
            </iframe>
    </div>
...
<script>
    ...
    var ACTUAL_COMPONENT = {'name': 'Search'};
</script>
<script src="../js/tree.js"></script>
    ...
    <div class="no-results">
       ...
       <script>
            ...
            var COMPODOC_CURRENT_PAGE_URL = 'Search.html';
       </script>
