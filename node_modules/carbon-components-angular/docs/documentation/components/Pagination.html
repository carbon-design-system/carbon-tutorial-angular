...
<p class="comment">
    ...
    <p class="comment">
        <p>Use pagination when you have multiple pages of data to handle.</p>
<p><a href="../../?path=/story/pagination--basic">See demo</a></p>
<div><pre class="line-numbers"><code class="language-html"> * &lt;ibm-pagination [model]=&quot;model&quot; (selectPage)=&quot;selectPage($event)&quot;&gt;&lt;/ibm-pagination&gt;
 *</code></pre></div><p>In your <code>selectPage()</code> method set the <code>model.currentPage</code> to selected page, <em>after</em>
you load the page.</p>
 ...
 * }
 *</code></pre></div><p><example-url>../../iframe.html?id=pagination--basic</example-url></p>
    ...
    <table class="table table-sm table-hover">
        <tbody>
            ...
            <tr>
                ...
                <td class="col-md-9"><code>ibm-pagination</code></td>
            </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <ul class="index-list">
                            ...
                            <li>
                                <a href="#totalPagesText">totalPagesText</a>
                            </li>
                        </ul>
                    </td>
                </tr>
                    ...
                    <tr>
                        <td class="col-md-4">
                            <ul class="index-list">
                                ...
                                <li>
                                    <a href="#isExperimental">isExperimental</a>
                                </li>
                                <li>
    ...
    <h3 id="constructor">Constructor</h3>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
<code>constructor(i18n: <a href="../injectables/I18n.html">I18n</a>, experimental: <a href="../injectables/ExperimentalService.html">ExperimentalService</a>)</code>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-4">
                                <div class="io-line">Defined in <a href="" data-line="322" class="link-to-prism">src/pagination/pagination.component.ts:322</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> to disable the backward/forward buttons.</p>
</div>
                        <p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="190" class="link-to-prism">src/pagination/pagination.component.ts:190</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Options for items per page select</p>
<p>A default array of options will be defined: [10, 20, 30, 40, 50]</p>
</div>
                            <p>
                            <em>Type :</em>    <code>number[]</code>

                            </p>
                        <p>
                            <em>Default value : </em><code>[10, 20, 30, 40, 50]</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="234" class="link-to-prism">src/pagination/pagination.component.ts:234</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p><code>PaginationModel</code> with the information about pages you&#39;re controlling.</p>
</div>
                            <p>
                            <em>Type :</em>    <code><a href="../classes/PaginationModel.html" target="_self" >PaginationModel</a></code>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="186" class="link-to-prism">src/pagination/pagination.component.ts:186</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>pageInputDisabled</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> to disable the select box that changes the page.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>pageSelectThreshold</code>
                    </td>
                    <td class="col-md-10">
                        <p>
                            <em>Default value : </em><code>1000</code>
                        </p>
                    </td>
                </tr>
                        <tr>
            ...
            <tbody>
                <tr>
                    <td class="col-md-2">
                        ...
                        <code>pagesUnknown</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> if the total number of items is unknown.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="198" class="link-to-prism">src/pagination/pagination.component.ts:198</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Set to <code>true</code> for a loading pagination component.</p>
</div>
                        <p>
                            <em>Default value : </em><code>false</code>
                        </p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="182" class="link-to-prism">src/pagination/pagination.component.ts:182</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Expects an object that contains some or all of:</p>
<div><pre class="line-numbers"><code class="language-none">     * {
     ...
     *</code></pre></div></div>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="216" class="link-to-prism">src/pagination/pagination.component.ts:216</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Emits the new page number.</p>
...
data is finally loaded.</p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="242" class="link-to-prism">src/pagination/pagination.component.ts:242</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
    ...
    <section>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_pageOptions:     <code>[]</code>
</code>
                    </td>
                </tr>
                    <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="314" class="link-to-prism">src/pagination/pagination.component.ts:314</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <code>currentPageSelectId:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="310" class="link-to-prism">src/pagination/pagination.component.ts:310</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="315" class="link-to-prism">src/pagination/pagination.component.ts:315</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <code>itemsPerPageSelectId:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="309" class="link-to-prism">src/pagination/pagination.component.ts:309</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <code>itemsPerPageText:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="312" class="link-to-prism">src/pagination/pagination.component.ts:312</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <code>ofLastPagesText:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="320" class="link-to-prism">src/pagination/pagination.component.ts:320</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <code>optionsListText:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="313" class="link-to-prism">src/pagination/pagination.component.ts:313</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="319" class="link-to-prism">src/pagination/pagination.component.ts:319</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>paginationCounter:     <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/number" target="_blank" >number</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="177" class="link-to-prism">src/pagination/pagination.component.ts:177</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <code>totalItemsUnknownText:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="317" class="link-to-prism">src/pagination/pagination.component.ts:317</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="totalPagesText"></a>
                        <span class="name">
                            <b>
                            totalPagesText
                            </b>
                            <a href="#totalPagesText"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <code>totalPagesText:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        <td class="col-md-4">
                            <i>Default value : </i><code>this.i18n.getOverridable(&quot;PAGINATION.TOTAL_PAGES&quot;)</code>
                        </td>
                    </tr>
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="318" class="link-to-prism">src/pagination/pagination.component.ts:318</a></div>
                            </td>
                        </tr>
     ...
     *</code></pre></div></div>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>itemsPerPage()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="244" class="link-to-prism">src/pagination/pagination.component.ts:244</a></div>
                                </td>
                            </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>itemsPerPage(value)</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="247" class="link-to-prism">src/pagination/pagination.component.ts:247</a></div>
                                </td>
                            </tr>
                    <tr>
                        <td class="col-md-4">
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>currentPage()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="252" class="link-to-prism">src/pagination/pagination.component.ts:252</a></div>
                                </td>
                            </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>currentPage(value)</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="255" class="link-to-prism">src/pagination/pagination.component.ts:255</a></div>
                                </td>
                            </tr>
                    <tr>
                        <td class="col-md-4">
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>totalDataLength()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="262" class="link-to-prism">src/pagination/pagination.component.ts:262</a></div>
                                </td>
                            </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>lastPage()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="268" class="link-to-prism">src/pagination/pagination.component.ts:268</a></div>
                                </td>
                            </tr>
                    <tr>
                        <td class="col-md-4">
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>startItemIndex()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="273" class="link-to-prism">src/pagination/pagination.component.ts:273</a></div>
                                </td>
                            </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>previousPage()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="286" class="link-to-prism">src/pagination/pagination.component.ts:286</a></div>
                                </td>
                            </tr>
                    <tr>
                        <td class="col-md-4">
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>nextPage()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="293" class="link-to-prism">src/pagination/pagination.component.ts:293</a></div>
                                </td>
                            </tr>
                    <tr>
                        <td class="col-md-4">
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="isExperimental"></a>
                        <span class="name"><b>isExperimental</b><a href="#isExperimental"><span class="icon ion-ios-link"></span></a></span>
                    </td>
                </tr>

                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>isExperimental()</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>pageOptions()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="302" class="link-to-prism">src/pagination/pagination.component.ts:302</a></div>
                                </td>
                            </tr>
...
export class Pagination {
    ...
    <div class="tab-pane fade " id="c-example">
            <iframe class="exampleContainer" src="../../iframe.html?id&#x3D;pagination--basic">
                <p>no-iframes</p>
            </iframe>
    </div>
...
<script>
        var COMPONENT_TEMPLATE = '<div><div	class="bx--pagination"	[ngClass]="{		\'bx--skeleton\': skeleton	}">	<!-- left skeleton div -->	<div *ngIf="skeleton" class="bx--pagination__left">		<p class="bx--skeleton__text" style="width: 70px"></p>		<p class="bx--skeleton__text" style="width: 35px"></p>		<p class="bx--skeleton__text" style="width: 105px"></p>	</div>	<div *ngIf="!skeleton" class="bx--pagination__left">		<label class="bx--pagination__text" [for]="itemsPerPageSelectId">			{{itemsPerPageText.subject | async}}		</label>		<div class="bx--select bx--select--inline"			[ngClass]="{				\'bx--select__item-count\': isExperimental,				\'bx--select--disabled\': pageInputDisabled			}">			<select				[id]="itemsPerPageSelectId"				[disabled]="pageInputDisabled"				[(ngModel)]="itemsPerPage"				class="bx--select-input">				<option					class="bx--select-option"					*ngFor="let option of itemsPerPageOptions"					[value]="option">						{{ option }}				</option>			</select>			<svg				ibmIconChevronDown16				style="display: inherit"				class="bx--select__arrow"				aria-hidden="true"				[attr.ariaLabel]="optionsListText.subject | async">			</svg>		</div>		<span *ngIf="!pagesUnknown" class="bx--pagination__text">			<span *ngIf="!isExperimental">|&nbsp;</span>			{{totalItemsText.subject | i18nReplace:{start: startItemIndex, end: endItemIndex, total: totalDataLength } | async}}		</span>		<span *ngIf="pagesUnknown" class="bx--pagination__text">			<span *ngIf="!isExperimental">|&nbsp;</span>			{{totalItemsUnknownText.subject | i18nReplace:{start: startItemIndex, end: endItemIndex } | async}}		</span>	</div>	<!-- right skeleton div -->	<div *ngIf="skeleton" class="bx--pagination__right">		<p class="bx--skeleton__text" style="width: 70px"></p>	</div>	<div *ngIf="!skeleton" class="bx--pagination__right"		[ngClass]="{			\'bx--pagination--inline\': !isExperimental		}">		<div			class="bx--select bx--select--inline"			[ngClass]="{				\'bx--select__page-number\' : isExperimental,				\'bx--select--disabled\': pageInputDisabled			}">			<label [for]="currentPageSelectId" class="bx--label bx--visually-hidden">{{itemsPerPageText.subject | async}}</label>			<input				*ngIf="pageOptions.length > pageSelectThreshold"				style="padding-right: 1rem; margin-right: 1rem;"				[id]="currentPageSelectId"				type="number"				min="1"				[max]="pageOptions.length"				class="bx--select-input"				[(ngModel)]="currentPage">			<select				*ngIf="pageOptions.length <= pageSelectThreshold"				[id]="currentPageSelectId"				[disabled]="pageInputDisabled"				class="bx--select-input"				[(ngModel)]="currentPage">				<option *ngFor="let page of pageOptions; let i = index;" class="bx--select-option" [value]="i + 1">{{i + 1}}</option>			</select>			<svg				*ngIf="pageOptions.length <= 1000"				ibmIconChevronDown16				style="display: inherit;"				class="bx--select__arrow"				[attr.ariaLabel]="optionsListText.subject | async">			</svg>		</div>		<span *ngIf="!pagesUnknown" class="bx--pagination__text">			{{ofLastPagesText.subject | i18nReplace: {last: lastPage} | async}}		</span>		<span *ngIf="pagesUnknown" class="bx--pagination__text">			{{pageText.subject | async}} {{currentPage}}		</span>		<button			class="bx--pagination__button bx--pagination__button--backward"			[ngClass]="{				\'bx--pagination__button--no-index\': currentPage <= 1 || disabled			}"			tabindex="0"			[attr.aria-label]="backwardText.subject | async"			(click)="selectPage.emit(previousPage)"			[disabled]="(currentPage <= 1 || disabled ? true : null)">			<ibm-icon-caret-left16></ibm-icon-caret-left16>		</button>		<button			class="bx--pagination__button bx--pagination__button--forward"			[ngClass]="{				\'bx--pagination__button--no-index\': currentPage >= lastPage || disabled			}"			tabindex="0"			[attr.aria-label]="forwardText.subject | async"			(click)="selectPage.emit(nextPage)"			[disabled]="(currentPage >= lastPage || disabled ? true : null)">			<ibm-icon-caret-right16></ibm-icon-caret-right16>		</button>	</div></div></div>'
