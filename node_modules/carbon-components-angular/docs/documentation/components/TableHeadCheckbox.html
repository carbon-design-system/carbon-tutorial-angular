...
<p class="comment">
    <code>src/table/head/table-head-checkbox.component.ts</code>
</p>
    ...
    <table class="table table-sm table-hover">
        <tbody>
            ...
            <tr>
                ...
                <td class="col-md-9"><code>[ibmTableHeadCheckbox]</code></td>
            </tr>
        ...
        :host { width: 10px; }
            ...
            <tr>
                ...
                <td class="col-md-9"><pre class="line-numbers"><code class="language-html">&lt;ibm-checkbox
	*ngIf&#x3D;&quot;!skeleton&quot;
	inline&#x3D;&quot;true&quot;
	[size]&#x3D;&quot;(size !&#x3D;&#x3D; &#x27;sm&#x27; ? &#x27;md&#x27; : &#x27;sm&#x27;)&quot;
	[name]&#x3D;&quot;name&quot;
        ...
        <tbody>
                    ...
                    <td class="col-md-4">
                        <ul class="index-list">
                            <li>
                                ...
                                <a href="#_ariaLabel">_ariaLabel</a>
                            </li>
                            <li>
                                    <span class="modifier">Private</span>
                                    <span class="modifier">Static</span>
                                <a href="#tableSelectAllCount">tableSelectAllCount</a>
                            </li>
                        </ul>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <ul class="index-list">
                            <li>
                                <a href="#getAriaLabel">getAriaLabel</a>
                            </li>
                        </ul>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <ul class="index-list">
                            <li>
                                <a href="#class.bx--table-column-checkbox">class.bx--table-column-checkbox</a>
                            </li>
                        </ul>
                    </td>
                </tr>
...
<code>constructor(i18n: <a href="../injectables/I18n.html">I18n</a>)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                <div class="io-line">Defined in <a href="" data-line="59" class="link-to-prism">src/table/head/table-head-checkbox.component.ts:59</a></div>
                            </td>
                        </tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="47" class="link-to-prism">src/table/head/table-head-checkbox.component.ts:47</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="38" class="link-to-prism">src/table/head/table-head-checkbox.component.ts:38</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="40" class="link-to-prism">src/table/head/table-head-checkbox.component.ts:40</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <p>
                            <em>Default value : </em><code>&#x60;select-all-${TableHeadCheckbox.tableSelectAllCount++}&#x60;</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="44" class="link-to-prism">src/table/head/table-head-checkbox.component.ts:44</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="36" class="link-to-prism">src/table/head/table-head-checkbox.component.ts:36</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="42" class="link-to-prism">src/table/head/table-head-checkbox.component.ts:42</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="55" class="link-to-prism">src/table/head/table-head-checkbox.component.ts:55</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
    ...
    <h3>HostBindings</h3>        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="class.bx--table-column-checkbox"></a>
                        <span class="name">
                            <b>
                            class.bx--table-column-checkbox
                            </b>
                            <a href="#class.bx--table-column-checkbox"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <code>class.bx--table-column-checkbox:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="57" class="link-to-prism">src/table/head/table-head-checkbox.component.ts:57</a></div>
                            </td>
                        </tr>
    ...
    <section>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="getAriaLabel"></a>
                        <span class="name">
                            <b>
                            getAriaLabel
                            </b>
                            <a href="#getAriaLabel"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
...
<code>getAriaLabel()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="63" class="link-to-prism">src/table/head/table-head-checkbox.component.ts:63</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <span class="name">
                            ...
                            <a href="#_ariaLabel"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_ariaLabel:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <span class="name">
                            ...
                            <a href="#tableSelectAllCount"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>tableSelectAllCount:     <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/number" target="_blank" >number</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="31" class="link-to-prism">src/table/head/table-head-checkbox.component.ts:31</a></div>
                            </td>
                        </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>ariaLabel()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="51" class="link-to-prism">src/table/head/table-head-checkbox.component.ts:51</a></div>
                                </td>
                            </tr>

                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>ariaLabel(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
...
<script>
        var COMPONENT_TEMPLATE = '<div><ibm-checkbox	*ngIf="!skeleton"	inline="true"	[size]="(size !== \'sm\' ? \'md\' : \'sm\')"	[name]="name"	[checked]="checked"	[indeterminate]="indeterminate"	(change)="change.emit()"	[aria-label]="getAriaLabel() | async"></ibm-checkbox>	</div>'
    ...
    var ACTUAL_COMPONENT = {'name': 'TableHeadCheckbox'};
</script>
<script src="../js/tree.js"></script>
    ...
    <div class="no-results">
       ...
       <script>
            ...
            var COMPODOC_CURRENT_PAGE_URL = 'TableHeadCheckbox.html';
       </script>
