...
<p class="comment">
    ...
    <p class="comment">
        <div><pre class="line-numbers"><code class="language-html"> * &lt;ibm-dropdown-list [items]=&quot;listItems&quot;&gt;&lt;/ibm-dropdown-list&gt;
 *</code></pre></div><div><pre class="line-numbers"><code class="language-typescript"> * listItems = [
 *     {
 *         content: &quot;item one&quot;,
 *         selected: false
 *     },
 ...
 *</code></pre></div>
    ...
    <p class="comment">
                <code><a href="../classes/AbstractDropdownView.html" target="_self" >AbstractDropdownView</a></code>
...
<section>
    ...
    <table class="table table-sm table-hover">
        <tbody>
            ...
            <tr>
                ...
                <td class="col-md-9">
                            <code><a href="../classes/AbstractDropdownView.html" target="_self" >{
    provide: AbstractDropdownView, useExisting: DropdownList
            ...
            <tr>
                ...
                <td class="col-md-9"><code>ibm-dropdown-list</code></td>
            </tr>
...
<code>constructor(elementRef: <a href="https://angular.io/api/core/ElementRef" target="_blank">ElementRef</a>, i18n: <a href="../injectables/I18n.html">I18n</a>)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                <div class="io-line">Defined in <a href="" data-line="202" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:202</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <p>
                            <em>Default value : </em><code>this.i18n.get().DROPDOWN_LIST.LABEL</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="108" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:108</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>The list items belonging to the <code>DropdownList</code>.</p>
</div>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="112" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:112</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Template to bind to items in the <code>DropdownList</code> (optional).</p>
</div>
                            <p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="137" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:137</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Defines whether or not the <code>DropdownList</code> supports selecting multiple items as opposed to single
item selection.</p>
</div>
                            <p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="164" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:164</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-2">
                        <a name="blurIntent"></a>
                        <code>blurIntent</code>
                    </td>
                    <td class="col-md-10">
                        <div><p>Event to suggest a blur on the view.
...
<p>When this event fires focus should be placed on some element outside of the list - blurring the list as a result</p>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="155" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:155</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Event to emit scroll event of a list within the <code>DropdownList</code>.</p>
</div>
                        <em><code>$event</code> Type:</em>    <code><a href="../interfaces/ScrollCustomEvent.html" target="_self" >EventEmitter&lt;ScrollCustomEvent&gt;</a></code>

                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="145" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:145</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <div><p>Event to emit selection of a list item within the <code>DropdownList</code>.</p>
</div>
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="141" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:141</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <span class="name">
                            ...
                            <a href="#doKeyDown"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
<code>doKeyDown(event: KeyboardEvent, item: <a href="../interfaces/ListItem.html">ListItem</a>)</code>
                    </td>
                </tr>
                                    ...
                                    <table class="params">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                        <td>item</td>
                                                        <td>
                                                                    <code><a href="../interfaces/ListItem.html" target="_self" >ListItem</a></code>
                                                        </td>
...
<code>hasNextElement()</code>
                ...
                <tr>
                    <td class="col-md-4">
                            <div class="io-description"><p>Returns <code>true</code> if the selected item is not the last item in the <code>DropdownList</code>.
TODO: standardize</p>
</div>
...
<code>hasPrevElement()</code>
                ...
                <tr>
                    <td class="col-md-4">
                            <div class="io-description"><p>Returns <code>true</code> if the selected item is not the first in the list.
TODO: standardize</p>
</div>
...
<code>ngAfterViewInit()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="213" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:213</a></div>
                            </td>
                        </tr>
...
<code>onItemsReady(subcription: () => void)</code>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
<code>propagateSelected(value: <a href="../interfaces/ListItem.html">Array<ListItem></a>)</code>
                    </td>
                </tr>
    ...
    <section>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_items:     <code><a href="../interfaces/ListItem.html" target="_self" >Array&lt;ListItem&gt;</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="198" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:198</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_itemsReady:     <code>Observable&lt;boolean&gt;</code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_itemsSubscription:     <code>Subscription</code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="190" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:190</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>_originalItems:     <code><a href="../interfaces/ListItem.html" target="_self" >Array&lt;ListItem&gt; | Observable&lt;Array&lt;ListItem&gt;&gt;</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="194" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:194</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>displayItems:     <code><a href="../interfaces/ListItem.html" target="_self" >Array&lt;ListItem&gt;</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="174" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:174</a></div>
                            </td>
                        </tr>
...
it is always a subset of the total items in <code>DropdownList</code>).</p>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>elementRef:     <code><a href="https://angular.io/api/core/ElementRef" target="_blank" >ElementRef</a></code>
</code>
                    </td>
                </tr>
                    <tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>focusJump:     <code></code>
</code>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="186" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:186</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>index:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="178" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:178</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <code>list:     <code><a href="https://angular.io/api/core/ElementRef" target="_blank" >ElementRef</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="159" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:159</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>listElementList:     <code>QueryList&lt;ElementRef&gt;</code>
</code>
                    </td>
                </tr>
                    <tr>
                        <td class="col-md-4">
                            <i>Type : </i>    <code>QueryList&lt;ElementRef&gt;</code>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>size:     <code>&quot;sm&quot; | &quot;md&quot; | &quot;lg&quot;</code>
</code>
                    </td>
                </tr>
                    <tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>get</b><code>items()</code></span>
                            ...
                            <tr>
                                <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="131" class="link-to-prism">src/dropdown/list/dropdown-list.component.ts:131</a></div>
                                </td>
                            </tr>

                <tr>
                    <td class="col-md-4">
                        <span class="accessor"><b>set</b><code>items(value)</code></span>
                    </td>
                </tr>
                            <tr>
                                <td class="col-md-4">
...
<script>
        var COMPONENT_TEMPLATE = '<div><ul	#list	role="listbox"	class="bx--list-box__menu bx--multi-select"	(scroll)="emitScroll($event)"	[attr.aria-label]="ariaLabel">	<li		role="option"		*ngFor="let item of displayItems; let i = index"		(click)="doClick($event, item)"		(keydown)="doKeyDown($event, item)"		(focus)="onItemFocus(i)"		(blur)="onItemBlur(i)"		class="bx--list-box__menu-item"		[ngClass]="{			\'bx--list-box__menu-item--active\': item.selected,			disabled: item.disabled		}"		[title]="item.content">		<div			#listItem			tabindex="-1"			class="bx--list-box__menu-item__option">			<div				*ngIf="!listTpl && type === \'multi\'"				class="bx--form-item bx--checkbox-wrapper">				<label					[attr.data-contained-checkbox-state]="item.selected"					class="bx--checkbox-label">					<input						class="bx--checkbox"						type="checkbox"						[checked]="item.selected"						[disabled]="item.disabled"						tabindex="-1">					<span class="bx--checkbox-appearance"></span>					<span class="bx--checkbox-label-text">{{item.content}}</span>				</label>			</div>			<ng-container *ngIf="!listTpl && type === \'single\'">{{item.content}}</ng-container>			<ng-template				*ngIf="listTpl"				[ngTemplateOutletContext]="{item: item}"				[ngTemplateOutlet]="listTpl">			</ng-template>		</div>	</li></ul></div>'
