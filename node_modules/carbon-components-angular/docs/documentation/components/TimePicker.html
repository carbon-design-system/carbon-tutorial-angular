...
<p class="comment">
    <code>src/timepicker/timepicker.component.ts</code>
</p>
    ...
    <p class="comment">
        <p><a href="../../?path=/story/time-picker--simple">See demo</a></p>
<p><example-url>../../iframe.html?id=time-picker--simple</example-url></p>
...
<section>
    ...
    <table class="table table-sm table-hover">
        <tbody>
            ...
            <tr>
                ...
                <td class="col-md-9">
                            <code><a href="../components/TimePicker.html" target="_self" >{
    provide: NG_VALUE_ACCESSOR, useExisting: TimePicker, multi: true
            ...
            <tr>
                ...
                <td class="col-md-9"><code>ibm-timepicker</code></td>
            </tr>
            ...
            <tr>
                ...
                <td class="col-md-9"><pre class="line-numbers"><code class="language-html">&lt;div class&#x3D;&quot;bx--time-picker__input&quot;&gt;
...
&lt;ng-content&gt;&lt;/ng-content&gt;
        ...
        <tbody>
                    ...
                    <td class="col-md-4">
                        <ul class="index-list">
                            ...
                            <li>
                                ...
                                <a href="#timePickerCount">timePickerCount</a>
                            </li>
                        </ul>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="col-md-4">
                        <ul class="index-list">
                            <li>
                                <a href="#class.bx--time-picker">class.bx--time-picker</a>
                            </li>
                        </ul>
                    </td>
                </tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="62" class="link-to-prism">src/timepicker/timepicker.component.ts:62</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <p>
                            <em>Default value : </em><code>&#x60;timepicker-${TimePicker.timePickerCount++}&#x60;</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="61" class="link-to-prism">src/timepicker/timepicker.component.ts:61</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="58" class="link-to-prism">src/timepicker/timepicker.component.ts:58</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <p>
                            <em>Default value : </em><code>&quot;(1[012]|[0-9]):[0-5][0-9]&quot;</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="60" class="link-to-prism">src/timepicker/timepicker.component.ts:60</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        <p>
                            <em>Default value : </em><code>&quot;hh:mm&quot;</code>
                        </p>
                    </td>
                </tr>
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="59" class="link-to-prism">src/timepicker/timepicker.component.ts:59</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="68" class="link-to-prism">src/timepicker/timepicker.component.ts:68</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="73" class="link-to-prism">src/timepicker/timepicker.component.ts:73</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="63" class="link-to-prism">src/timepicker/timepicker.component.ts:63</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="col-md-10">
                        ...
                        <tr>
                            <td class="col-md-2" colspan="2">
                                    <div class="io-line">Defined in <a href="" data-line="75" class="link-to-prism">src/timepicker/timepicker.component.ts:75</a></div>
                            </td>
                        </tr>
            </tbody>
        </table>
    ...
    <h3>HostBindings</h3>        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="class.bx--time-picker"></a>
                        <span class="name">
                            <b>
                            class.bx--time-picker
                            </b>
                            <a href="#class.bx--time-picker"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <code>class.bx--time-picker:     <code></code>
</code>
                    </td>
                </tr>
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="56" class="link-to-prism">src/timepicker/timepicker.component.ts:56</a></div>
                            </td>
                        </tr>
...
<code>focusout()</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="99" class="link-to-prism">src/timepicker/timepicker.component.ts:99</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="103" class="link-to-prism">src/timepicker/timepicker.component.ts:103</a></div>
                            </td>
                        </tr>
...
<code>onChange(event)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="93" class="link-to-prism">src/timepicker/timepicker.component.ts:93</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
<code>registerOnChange(callback: <a href="https://www.typescriptlang.org/docs/handbook/basic-types.html" target="_blank">any</a>)</code>
                    </td>
                </tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="81" class="link-to-prism">src/timepicker/timepicker.component.ts:81</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
<code>registerOnTouched(callback: <a href="https://www.typescriptlang.org/docs/handbook/basic-types.html" target="_blank">any</a>)</code>
                    </td>
                </tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="85" class="link-to-prism">src/timepicker/timepicker.component.ts:85</a></div>
                            </td>
                        </tr>
...
<code>setDisabledState(isDisabled: <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/boolean" target="_blank">boolean</a>)</code>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="89" class="link-to-prism">src/timepicker/timepicker.component.ts:89</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">
<code>writeValue(value: <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string" target="_blank">string</a>)</code>
                    </td>
                </tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="77" class="link-to-prism">src/timepicker/timepicker.component.ts:77</a></div>
                            </td>
                        </tr>
    ...
    <section>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="107" class="link-to-prism">src/timepicker/timepicker.component.ts:107</a></div>
                            </td>
                        </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="108" class="link-to-prism">src/timepicker/timepicker.component.ts:108</a></div>
                            </td>
                        </tr>
        ...
        <table class="table table-sm table-bordered">
            <tbody>
                <tr>
                    <td class="col-md-4">
                        <a name="timePickerCount"></a>
                        <span class="name">
                            <b>
                                <span class="modifier">Static</span>
                            timePickerCount
                            </b>
                            <a href="#timePickerCount"><span class="icon ion-ios-link"></span></a>
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="col-md-4">
                        <span class="modifier-icon icon ion-ios-reset"></span><code>timePickerCount:     <code><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/number" target="_blank" >number</a></code>
</code>
                    </td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="col-md-4">
                                    <div class="io-line">Defined in <a href="" data-line="54" class="link-to-prism">src/timepicker/timepicker.component.ts:54</a></div>
                            </td>
                        </tr>
...
export class TimePicker implements ControlValueAccessor {
    ...
    <div class="tab-pane fade " id="c-example">
            <iframe class="exampleContainer" src="../../iframe.html?id&#x3D;time-picker--simple">
                <p>no-iframes</p>
            </iframe>
    </div>
...
<script>
        var COMPONENT_TEMPLATE = '<div><div class="bx--time-picker__input">	<label *ngIf="!skeleton && label" [for]="id" class="bx--label">		<ng-container *ngIf="!isTemplate(label)">{{label}}</ng-container>		<ng-template *ngIf="isTemplate(label)" [ngTemplateOutlet]="label"></ng-template>	</label>	<input		[ngClass]="{			\'bx--text-input--light\': theme === \'light\',			\'bx--skeleton\': skeleton		}"		[value]="value"		[placeholder]="placeholder"		[pattern]="pattern"		[attr.id]="id"		[disabled]="disabled"		maxlength="5"		(change)="onChange($event)"		type="text"		class="bx--time-picker__input-field bx--text-input"></div><ng-content></ng-content>	</div>'
    ...
    var ACTUAL_COMPONENT = {'name': 'TimePicker'};
</script>
<script src="../js/tree.js"></script>
    ...
    <div class="no-results">
       ...
       <script>
            ...
            var COMPODOC_CURRENT_PAGE_URL = 'TimePicker.html';
       </script>
