/**
 *
 * carbon-angular v0.0.0 | timepicker.component.ngfactory.js
 *
...
import * as i3 from "./timepicker.component";
...
export function View_TimePicker_0(_l) { return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, 0, null, null, 5, "div", [["class", "bx--time-picker__input"]], null, null, null, null, null)), (_l()(), i0.ɵand(16777216, null, null, 1, null, View_TimePicker_1)), i0.ɵdid(2, 16384, null, 0, i1.NgIf, [i0.ViewContainerRef, i0.TemplateRef], { ngIf: [0, "ngIf"] }, null), (_l()(), i0.ɵeld(3, 0, null, null, 2, "input", [["class", "bx--time-picker__input-field bx--text-input"], ["maxlength", "5"], ["type", "text"]], [[8, "value", 0], [8, "placeholder", 0], [8, "pattern", 0], [1, "id", 0], [8, "disabled", 0]], [[null, "change"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("change" === en)) {
        ...
        ad = (pd_0 && ad);
    } return ad; }, null, null)), i0.ɵdid(4, 278528, null, 0, i1.NgClass, [i0.IterableDiffers, i0.KeyValueDiffers, i0.ElementRef, i0.Renderer2], { klass: [0, "klass"], ngClass: [1, "ngClass"] }, null), i0.ɵpod(5, { "bx--text-input--light": 0, "bx--skeleton": 1 }), i0.ɵncd(null, 0)], function (_ck, _v) { var _co = _v.component; var currVal_0 = (!_co.skeleton && _co.label); _ck(_v, 2, 0, currVal_0); var currVal_6 = "bx--time-picker__input-field bx--text-input"; var currVal_7 = _ck(_v, 5, 0, (_co.theme === "light"), _co.skeleton); _ck(_v, 4, 0, currVal_6, currVal_7); }, function (_ck, _v) { var _co = _v.component; var currVal_1 = _co.value; var currVal_2 = _co.placeholder; var currVal_3 = _co.pattern; var currVal_4 = _co.id; var currVal_5 = _co.disabled; _ck(_v, 3, 0, currVal_1, currVal_2, currVal_3, currVal_4, currVal_5); }); }
export function View_TimePicker_Host_0(_l) { return i0.ɵvid(0, [(_l()(), i0.ɵeld(0, 0, null, null, 2, "ibm-timepicker", [], [[2, "bx--time-picker", null]], [[null, "focusout"]], function (_v, en, $event) { var ad = true; if (("focusout" === en)) {
        var pd_0 = (i0.ɵnov(_v, 2).focusOut() !== false);
        ad = (pd_0 && ad);
    } return ad; }, View_TimePicker_0, RenderType_TimePicker)), i0.ɵprd(5120, null, i2.NG_VALUE_ACCESSOR, function (p0_0) { return [p0_0]; }, [i3.TimePicker]), i0.ɵdid(2, 49152, null, 0, i3.TimePicker, [], null, null)], null, function (_ck, _v) { var currVal_0 = i0.ɵnov(_v, 2).timePicker; _ck(_v, 0, 0, currVal_0); }); }
var TimePickerNgFactory = i0.ɵccf("ibm-timepicker", i3.TimePicker, View_TimePicker_Host_0, { label: "label", placeholder: "placeholder", pattern: "pattern", id: "id", disabled: "disabled", value: "value", skeleton: "skeleton", theme: "theme" }, { valueChange: "valueChange" }, ["*"]);
export { TimePickerNgFactory as TimePickerNgFactory };
