...
export declare class StructuredList implements AfterContentInit, ControlValueAccessor {
    ...
    */
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<StructuredList, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<StructuredList, "ibm-structured-list", never, { "selection": "selection"; "border": "border"; "condensed": "condensed"; "nowrap": "nowrap"; "name": "name"; "skeleton": "skeleton"; }, { "selected": "selected"; }, ["rows", "headers"], ["ibm-list-header", "*"]>;
}

//# sourceMappingURL=structured-list.component.d.ts.map