...
export declare class AlertModal extends BaseModal implements AfterViewInit {
     ...
     */
    constructor(type: string, label: string, title: string, content: string, size: string, hasScrollingContent: boolean, buttons: any[], onClose: Function);
    ngAfterViewInit(): boolean;
    buttonClicked(buttonIndex: any): void;
    dismissModal(trigger: any): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<AlertModal, [{ optional: true; }, { optional: true; }, { optional: true; }, { optional: true; }, { optional: true; }, { optional: true; }, { optional: true; }, { optional: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<AlertModal, "ibm-alert-modal", never, {}, {}, never, never>;
}
