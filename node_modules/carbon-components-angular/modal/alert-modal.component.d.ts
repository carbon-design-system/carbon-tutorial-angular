...
export declare class AlertModal extends BaseModal implements AfterViewInit {
     ...
     */
    constructor(modalType: string, modalLabel: string, modalTitle: string, modalContent: string, size: string, hasScrollingContent: boolean, buttons: any[], onClose: Function);
