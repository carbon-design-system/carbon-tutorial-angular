...
<ul data-progress data-progress-current class="bx--progress bx--progress--vertical">
    ...
    <li class="bx--progress-step bx--progress-step--current "  >
      ...
      <p tabindex="0" class="bx--progress-label" aria-describedby="label-tooltip3ifatclp2y6">
            Second Step
      </p>
      <div id="label-tooltip3ifatclp2y6" role="tooltip" data-floating-menu-direction="bottom" class="bx--tooltip" data-avoid-focus-on-open>
        <span class="bx--tooltip__caret"></span>
    ...
    <li class="bx--progress-step bx--progress-step--incomplete "  >
      ...
      <p tabindex="0" class="bx--progress-label" aria-describedby="label-tooltipy7ah2pz1dm">
            Third Step
      </p>
      <div id="label-tooltipy7ah2pz1dm" role="tooltip" data-floating-menu-direction="bottom" class="bx--tooltip" data-avoid-focus-on-open>
        <span class="bx--tooltip__caret"></span>
