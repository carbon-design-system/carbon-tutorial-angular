...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ux8qjbvkjct">Show
  modal</button>

<div data-modal id="modal-ux8qjbvkjct" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ux8qjbvkjct-label" aria-describedby="modal-ux8qjbvkjct-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ux8qjbvkjct-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ux8qjbvkjct-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-ux8qjbvkjct" class="bx--label">Text Input label</label>
        <input id="text-input-ux8qjbvkjct" type="text" class="bx--text-input" placeholder="Optional placeholder text"
