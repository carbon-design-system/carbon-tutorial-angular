...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-dc6d5pcigtv">Show
  modal</button>

<div data-modal id="modal-dc6d5pcigtv" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-dc6d5pcigtv-label" aria-describedby="modal-dc6d5pcigtv-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-dc6d5pcigtv-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-dc6d5pcigtv-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-dc6d5pcigtv" class="bx--label">Text Input label</label>
        <input id="text-input-dc6d5pcigtv" type="text" class="bx--text-input" placeholder="Optional placeholder text"
