...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-koyz3zus28r">Show
  modal</button>

<div data-modal id="modal-koyz3zus28r" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-koyz3zus28r-label" aria-describedby="modal-koyz3zus28r-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-koyz3zus28r-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-koyz3zus28r-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-koyz3zus28r" class="bx--label">Text Input label</label>
        <input id="text-input-koyz3zus28r" type="text" class="bx--text-input" placeholder="Optional placeholder text"
