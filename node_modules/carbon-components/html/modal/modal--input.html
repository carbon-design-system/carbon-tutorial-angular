...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-721g6tg1cmv">Show
  modal</button>

<div data-modal id="modal-721g6tg1cmv" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-721g6tg1cmv-label" aria-describedby="modal-721g6tg1cmv-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-721g6tg1cmv-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-721g6tg1cmv-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-721g6tg1cmv" class="bx--label">Text Input label</label>
        <input id="text-input-721g6tg1cmv" type="text" class="bx--text-input" placeholder="Optional placeholder text"
