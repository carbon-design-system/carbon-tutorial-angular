...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-lrqpf84o2fj">Show
  modal</button>

<div data-modal id="modal-lrqpf84o2fj" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-lrqpf84o2fj-label" aria-describedby="modal-lrqpf84o2fj-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-lrqpf84o2fj-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-lrqpf84o2fj-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-lrqpf84o2fj" class="bx--label">Text Input label</label>
        <input id="text-input-lrqpf84o2fj" type="text" class="bx--text-input" placeholder="Optional placeholder text"
