...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-axzrienmwpo">Show
  modal</button>

<div data-modal id="modal-axzrienmwpo" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-axzrienmwpo-label" aria-describedby="modal-axzrienmwpo-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-axzrienmwpo-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-axzrienmwpo-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-axzrienmwpo" class="bx--label">Text Input label</label>
        <input id="text-input-axzrienmwpo" type="text" class="bx--text-input" placeholder="Optional placeholder text"
