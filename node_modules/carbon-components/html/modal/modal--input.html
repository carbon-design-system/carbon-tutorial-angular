...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ghhu91upvc">Show
  modal</button>

<div data-modal id="modal-ghhu91upvc" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ghhu91upvc-label" aria-describedby="modal-ghhu91upvc-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ghhu91upvc-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ghhu91upvc-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-ghhu91upvc" class="bx--label">Text Input label</label>
        <input id="text-input-ghhu91upvc" type="text" class="bx--text-input" placeholder="Optional placeholder text"
