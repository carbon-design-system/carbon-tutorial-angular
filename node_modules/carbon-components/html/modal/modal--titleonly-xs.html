...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-jbg71camnx">Show
  modal</button>

<div data-modal id="modal-jbg71camnx" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-jbg71camnx-label" aria-describedby="modal-jbg71camnx-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jbg71camnx-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jbg71camnx-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
