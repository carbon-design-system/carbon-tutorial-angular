...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-kxzhhvnfopc">Show
  modal</button>

<div data-modal id="modal-kxzhhvnfopc" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-kxzhhvnfopc-label" aria-describedby="modal-kxzhhvnfopc-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-kxzhhvnfopc-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-kxzhhvnfopc-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
