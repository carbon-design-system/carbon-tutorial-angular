...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-1makfltvv1v">Show
  modal</button>

<div data-modal id="modal-1makfltvv1v" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-1makfltvv1v-label" aria-describedby="modal-1makfltvv1v-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-1makfltvv1v-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-1makfltvv1v-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
