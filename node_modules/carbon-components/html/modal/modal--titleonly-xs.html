...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-fe533c5ncnn">Show
  modal</button>

<div data-modal id="modal-fe533c5ncnn" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-fe533c5ncnn-label" aria-describedby="modal-fe533c5ncnn-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-fe533c5ncnn-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-fe533c5ncnn-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
