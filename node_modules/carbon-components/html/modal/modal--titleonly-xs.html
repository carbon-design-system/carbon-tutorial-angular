...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-lobfu3lb6h">Show
  modal</button>

<div data-modal id="modal-lobfu3lb6h" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-lobfu3lb6h-label" aria-describedby="modal-lobfu3lb6h-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-lobfu3lb6h-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-lobfu3lb6h-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
