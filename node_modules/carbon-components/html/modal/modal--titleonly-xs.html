...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-eady312kpl">Show
  modal</button>

<div data-modal id="modal-eady312kpl" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-eady312kpl-label" aria-describedby="modal-eady312kpl-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-eady312kpl-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-eady312kpl-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
