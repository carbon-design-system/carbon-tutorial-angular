...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-18aq37efy0o">Show
  modal</button>

<div data-modal id="modal-18aq37efy0o" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-18aq37efy0o-label" aria-describedby="modal-18aq37efy0o-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-18aq37efy0o-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-18aq37efy0o-heading">Modal heading</p>
