...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-ayzhvje9tll">Show
  modal</button>

<div data-modal id="modal-ayzhvje9tll" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-ayzhvje9tll-label" aria-describedby="modal-ayzhvje9tll-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ayzhvje9tll-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ayzhvje9tll-heading">Modal heading</p>
