...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-mtmj6nyhs9l">Show
  modal</button>

<div data-modal id="modal-mtmj6nyhs9l" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-mtmj6nyhs9l-label" aria-describedby="modal-mtmj6nyhs9l-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mtmj6nyhs9l-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mtmj6nyhs9l-heading">Modal heading</p>
