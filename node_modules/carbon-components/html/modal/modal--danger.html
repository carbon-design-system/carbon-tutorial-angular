...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-eyebe3qu64h">Show
  modal</button>

<div data-modal id="modal-eyebe3qu64h" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-eyebe3qu64h-label" aria-describedby="modal-eyebe3qu64h-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-eyebe3qu64h-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-eyebe3qu64h-heading">Modal heading</p>
