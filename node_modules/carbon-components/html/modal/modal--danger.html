...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-t7eldstbgl">Show
  modal</button>

<div data-modal id="modal-t7eldstbgl" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-t7eldstbgl-label" aria-describedby="modal-t7eldstbgl-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-t7eldstbgl-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-t7eldstbgl-heading">Modal heading</p>
