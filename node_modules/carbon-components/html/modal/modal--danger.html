...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-0v4wqi5eo1ai">Show
  modal</button>

<div data-modal id="modal-0v4wqi5eo1ai" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-0v4wqi5eo1ai-label" aria-describedby="modal-0v4wqi5eo1ai-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-0v4wqi5eo1ai-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-0v4wqi5eo1ai-heading">Modal heading</p>
