...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-j0fz2n8ko2">Show
  modal</button>

<div data-modal id="modal-j0fz2n8ko2" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-j0fz2n8ko2-label" aria-describedby="modal-j0fz2n8ko2-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-j0fz2n8ko2-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-j0fz2n8ko2-heading">Modal heading</p>
