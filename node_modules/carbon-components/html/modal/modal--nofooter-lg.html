...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-uobhfp38pr">Show
  modal</button>

<div data-modal id="modal-uobhfp38pr" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-uobhfp38pr-label" aria-describedby="modal-uobhfp38pr-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-uobhfp38pr-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-uobhfp38pr-heading">Modal heading</p>
