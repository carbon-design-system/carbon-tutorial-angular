...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-1wpp20gzqcm">Show
  modal</button>

<div data-modal id="modal-1wpp20gzqcm" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-1wpp20gzqcm-label" aria-describedby="modal-1wpp20gzqcm-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-1wpp20gzqcm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-1wpp20gzqcm-heading">Modal heading</p>
