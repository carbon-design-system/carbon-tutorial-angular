...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-jwjkktbql0b">Show
  modal</button>

<div data-modal id="modal-jwjkktbql0b" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-jwjkktbql0b-label" aria-describedby="modal-jwjkktbql0b-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jwjkktbql0b-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jwjkktbql0b-heading">Modal heading</p>
