...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ttcn74afii">Show
  modal</button>

<div data-modal id="modal-ttcn74afii" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ttcn74afii-label" aria-describedby="modal-ttcn74afii-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ttcn74afii-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ttcn74afii-heading">Modal heading</p>
