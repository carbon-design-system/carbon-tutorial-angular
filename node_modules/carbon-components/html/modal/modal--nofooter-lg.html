...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-f3vnuugi50v">Show
  modal</button>

<div data-modal id="modal-f3vnuugi50v" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-f3vnuugi50v-label" aria-describedby="modal-f3vnuugi50v-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-f3vnuugi50v-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-f3vnuugi50v-heading">Modal heading</p>
