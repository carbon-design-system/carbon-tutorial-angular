...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-erwhkm4vb0g">Show
  modal</button>

<div data-modal id="modal-erwhkm4vb0g" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-erwhkm4vb0g-label" aria-describedby="modal-erwhkm4vb0g-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-erwhkm4vb0g-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-erwhkm4vb0g-heading">Modal heading</p>
