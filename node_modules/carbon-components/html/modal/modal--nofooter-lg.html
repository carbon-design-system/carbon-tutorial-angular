...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-bsy007ijrm">Show
  modal</button>

<div data-modal id="modal-bsy007ijrm" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-bsy007ijrm-label" aria-describedby="modal-bsy007ijrm-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-bsy007ijrm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-bsy007ijrm-heading">Modal heading</p>
