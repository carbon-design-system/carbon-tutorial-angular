...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-nc8gcgdpwvn">Show
  modal</button>

<div data-modal id="modal-nc8gcgdpwvn" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-nc8gcgdpwvn-label" aria-describedby="modal-nc8gcgdpwvn-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nc8gcgdpwvn-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nc8gcgdpwvn-heading">Modal heading</p>
