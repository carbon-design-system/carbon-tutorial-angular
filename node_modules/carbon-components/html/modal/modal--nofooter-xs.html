...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-23kg8oui3ps">Show
  modal</button>

<div data-modal id="modal-23kg8oui3ps" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-23kg8oui3ps-label" aria-describedby="modal-23kg8oui3ps-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-23kg8oui3ps-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-23kg8oui3ps-heading">Modal heading</p>
