...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-27i5wloj38c">Show
  modal</button>

<div data-modal id="modal-27i5wloj38c" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-27i5wloj38c-label" aria-describedby="modal-27i5wloj38c-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-27i5wloj38c-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-27i5wloj38c-heading">Modal heading</p>
