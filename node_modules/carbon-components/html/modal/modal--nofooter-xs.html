...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-pd6jnz3bmdi">Show
  modal</button>

<div data-modal id="modal-pd6jnz3bmdi" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-pd6jnz3bmdi-label" aria-describedby="modal-pd6jnz3bmdi-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-pd6jnz3bmdi-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-pd6jnz3bmdi-heading">Modal heading</p>
