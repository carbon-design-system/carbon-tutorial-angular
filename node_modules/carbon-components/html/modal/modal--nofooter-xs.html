...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-npwg0fgl1oa">Show
  modal</button>

<div data-modal id="modal-npwg0fgl1oa" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-npwg0fgl1oa-label" aria-describedby="modal-npwg0fgl1oa-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-npwg0fgl1oa-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-npwg0fgl1oa-heading">Modal heading</p>
