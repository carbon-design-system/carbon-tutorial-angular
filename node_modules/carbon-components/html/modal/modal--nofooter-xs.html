...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-s0ktgibtt2e">Show
  modal</button>

<div data-modal id="modal-s0ktgibtt2e" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-s0ktgibtt2e-label" aria-describedby="modal-s0ktgibtt2e-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-s0ktgibtt2e-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-s0ktgibtt2e-heading">Modal heading</p>
