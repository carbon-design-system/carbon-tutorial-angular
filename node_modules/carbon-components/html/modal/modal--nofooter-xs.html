...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-oifk8jal9kd">Show
  modal</button>

<div data-modal id="modal-oifk8jal9kd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-oifk8jal9kd-label" aria-describedby="modal-oifk8jal9kd-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-oifk8jal9kd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-oifk8jal9kd-heading">Modal heading</p>
