...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-u7apnl8fihh">Show
  modal</button>

<div data-modal id="modal-u7apnl8fihh" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-u7apnl8fihh-label" aria-describedby="modal-u7apnl8fihh-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-u7apnl8fihh-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-u7apnl8fihh-heading">Modal heading</p>
