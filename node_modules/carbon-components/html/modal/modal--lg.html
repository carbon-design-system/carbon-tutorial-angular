...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-e0ss8tm8esc">Show
  modal</button>

<div data-modal id="modal-e0ss8tm8esc" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-e0ss8tm8esc-label" aria-describedby="modal-e0ss8tm8esc-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-e0ss8tm8esc-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-e0ss8tm8esc-heading">Modal heading</p>
