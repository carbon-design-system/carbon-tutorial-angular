...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-tvkhqijyzw">Show
  modal</button>

<div data-modal id="modal-tvkhqijyzw" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-tvkhqijyzw-label" aria-describedby="modal-tvkhqijyzw-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-tvkhqijyzw-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-tvkhqijyzw-heading">Modal heading</p>
