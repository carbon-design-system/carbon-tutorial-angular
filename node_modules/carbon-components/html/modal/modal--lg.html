...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-tkuu0lt2r8">Show
  modal</button>

<div data-modal id="modal-tkuu0lt2r8" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-tkuu0lt2r8-label" aria-describedby="modal-tkuu0lt2r8-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-tkuu0lt2r8-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-tkuu0lt2r8-heading">Modal heading</p>
