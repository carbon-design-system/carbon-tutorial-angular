...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-4b5jqwx8rcp">Show
  modal</button>

<div data-modal id="modal-4b5jqwx8rcp" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-4b5jqwx8rcp-label" aria-describedby="modal-4b5jqwx8rcp-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-4b5jqwx8rcp-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-4b5jqwx8rcp-heading">Modal heading</p>
