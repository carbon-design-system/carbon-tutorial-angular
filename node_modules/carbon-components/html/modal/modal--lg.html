...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-5q1ddzq499v">Show
  modal</button>

<div data-modal id="modal-5q1ddzq499v" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-5q1ddzq499v-label" aria-describedby="modal-5q1ddzq499v-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-5q1ddzq499v-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-5q1ddzq499v-heading">Modal heading</p>
