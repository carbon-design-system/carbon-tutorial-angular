...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-8kn01gyjqeu">Show
  modal</button>

<div data-modal id="modal-8kn01gyjqeu" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-8kn01gyjqeu-label" aria-describedby="modal-8kn01gyjqeu-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-8kn01gyjqeu-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-8kn01gyjqeu-heading">Modal heading</p>
