...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-crzctqh79g4">Show
  modal</button>

<div data-modal id="modal-crzctqh79g4" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-crzctqh79g4-label" aria-describedby="modal-crzctqh79g4-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-crzctqh79g4-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-crzctqh79g4-heading">Modal heading</p>
