...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-868c5edw53f">Show
  modal</button>

<div data-modal id="modal-868c5edw53f" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-868c5edw53f-label" aria-describedby="modal-868c5edw53f-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-868c5edw53f-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-868c5edw53f-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
