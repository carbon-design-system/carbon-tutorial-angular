...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-nfj4ml0ksts">Show
  modal</button>

<div data-modal id="modal-nfj4ml0ksts" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-nfj4ml0ksts-label" aria-describedby="modal-nfj4ml0ksts-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nfj4ml0ksts-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nfj4ml0ksts-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
