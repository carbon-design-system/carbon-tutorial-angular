...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-loxi4vmzgz">Show
  modal</button>

<div data-modal id="modal-loxi4vmzgz" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-loxi4vmzgz-label" aria-describedby="modal-loxi4vmzgz-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-loxi4vmzgz-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-loxi4vmzgz-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
