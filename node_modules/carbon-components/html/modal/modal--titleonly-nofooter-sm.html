...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-vqoe0lim0ba">Show
  modal</button>

<div data-modal id="modal-vqoe0lim0ba" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-vqoe0lim0ba-label" aria-describedby="modal-vqoe0lim0ba-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-vqoe0lim0ba-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-vqoe0lim0ba-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
