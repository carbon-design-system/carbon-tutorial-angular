...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-wyaz3piy5ja">Show
  modal</button>

<div data-modal id="modal-wyaz3piy5ja" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-wyaz3piy5ja-label" aria-describedby="modal-wyaz3piy5ja-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-wyaz3piy5ja-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-wyaz3piy5ja-heading">Modal heading</p>
