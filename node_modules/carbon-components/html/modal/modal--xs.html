...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-nm58egb8k4">Show
  modal</button>

<div data-modal id="modal-nm58egb8k4" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-nm58egb8k4-label" aria-describedby="modal-nm58egb8k4-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nm58egb8k4-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nm58egb8k4-heading">Modal heading</p>
