...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rr3e4rx1f">Show
  modal</button>

<div data-modal id="modal-rr3e4rx1f" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rr3e4rx1f-label" aria-describedby="modal-rr3e4rx1f-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rr3e4rx1f-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rr3e4rx1f-heading">Modal heading</p>
