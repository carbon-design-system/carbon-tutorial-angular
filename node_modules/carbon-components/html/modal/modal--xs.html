...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-mtoh9cmdmei">Show
  modal</button>

<div data-modal id="modal-mtoh9cmdmei" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-mtoh9cmdmei-label" aria-describedby="modal-mtoh9cmdmei-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mtoh9cmdmei-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mtoh9cmdmei-heading">Modal heading</p>
