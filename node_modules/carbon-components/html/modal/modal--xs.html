...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-vi6krvogrxp">Show
  modal</button>

<div data-modal id="modal-vi6krvogrxp" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-vi6krvogrxp-label" aria-describedby="modal-vi6krvogrxp-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-vi6krvogrxp-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-vi6krvogrxp-heading">Modal heading</p>
