...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-fkxfkmfggww">Show
  modal</button>

<div data-modal id="modal-fkxfkmfggww" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-fkxfkmfggww-label" aria-describedby="modal-fkxfkmfggww-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-fkxfkmfggww-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-fkxfkmfggww-heading">Modal heading</p>
