...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-w1oho5xsht9">Show
  modal</button>

<div data-modal id="modal-w1oho5xsht9" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-w1oho5xsht9-label" aria-describedby="modal-w1oho5xsht9-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-w1oho5xsht9-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-w1oho5xsht9-heading">Modal heading</p>
