...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-5ndoyca1r1">Show
  modal</button>

<div data-modal id="modal-5ndoyca1r1" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-5ndoyca1r1-label" aria-describedby="modal-5ndoyca1r1-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-5ndoyca1r1-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-5ndoyca1r1-heading">Modal heading</p>
