...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-uk2xohpwk8r">Show
  modal</button>

<div data-modal id="modal-uk2xohpwk8r" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-uk2xohpwk8r-label" aria-describedby="modal-uk2xohpwk8r-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-uk2xohpwk8r-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-uk2xohpwk8r-heading">Modal heading</p>
