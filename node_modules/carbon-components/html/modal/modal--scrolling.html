...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-vngnhsvh9ne">Show
  modal</button>

<div data-modal id="modal-vngnhsvh9ne" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-vngnhsvh9ne-label" aria-describedby="modal-vngnhsvh9ne-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-vngnhsvh9ne-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-vngnhsvh9ne-heading">Modal heading</p>
