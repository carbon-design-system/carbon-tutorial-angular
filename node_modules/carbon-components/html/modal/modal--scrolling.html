...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-hj5yhqkswqr">Show
  modal</button>

<div data-modal id="modal-hj5yhqkswqr" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-hj5yhqkswqr-label" aria-describedby="modal-hj5yhqkswqr-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-hj5yhqkswqr-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-hj5yhqkswqr-heading">Modal heading</p>
