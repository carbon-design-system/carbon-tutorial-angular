...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-7h944uin0uq">Show
  modal</button>

<div data-modal id="modal-7h944uin0uq" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-7h944uin0uq-label" aria-describedby="modal-7h944uin0uq-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-7h944uin0uq-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-7h944uin0uq-heading">Modal heading</p>
