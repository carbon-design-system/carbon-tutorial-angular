...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-dc09615s9j">Show
  modal</button>

<div data-modal id="modal-dc09615s9j" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-dc09615s9j-label" aria-describedby="modal-dc09615s9j-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-dc09615s9j-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-dc09615s9j-heading">Modal heading</p>
