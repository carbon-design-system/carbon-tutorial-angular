...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-1p4t9v6qwek">Show
  modal</button>

<div data-modal id="modal-1p4t9v6qwek" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-1p4t9v6qwek-label" aria-describedby="modal-1p4t9v6qwek-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-1p4t9v6qwek-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-1p4t9v6qwek-heading">Modal heading</p>
