...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-g5nys3e3btd">Show
  modal</button>

<div data-modal id="modal-g5nys3e3btd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-g5nys3e3btd-label" aria-describedby="modal-g5nys3e3btd-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-g5nys3e3btd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-g5nys3e3btd-heading">Modal heading</p>
