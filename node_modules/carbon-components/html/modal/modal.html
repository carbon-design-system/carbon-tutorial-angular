...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-hac4csrv814">Show
  modal</button>

<div data-modal id="modal-hac4csrv814" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-hac4csrv814-label" aria-describedby="modal-hac4csrv814-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-hac4csrv814-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-hac4csrv814-heading">Modal heading</p>
