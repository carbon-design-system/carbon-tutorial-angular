...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-6zvlpgoad8s">Show
  modal</button>

<div data-modal id="modal-6zvlpgoad8s" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-6zvlpgoad8s-label" aria-describedby="modal-6zvlpgoad8s-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-6zvlpgoad8s-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-6zvlpgoad8s-heading">Modal heading</p>
