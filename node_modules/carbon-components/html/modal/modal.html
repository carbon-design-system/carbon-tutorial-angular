...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-36zr18ljf8i">Show
  modal</button>

<div data-modal id="modal-36zr18ljf8i" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-36zr18ljf8i-label" aria-describedby="modal-36zr18ljf8i-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-36zr18ljf8i-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-36zr18ljf8i-heading">Modal heading</p>
