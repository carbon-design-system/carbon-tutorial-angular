...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-hrxjsn6dftk">Show
  modal</button>

<div data-modal id="modal-hrxjsn6dftk" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-hrxjsn6dftk-label" aria-describedby="modal-hrxjsn6dftk-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-hrxjsn6dftk-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-hrxjsn6dftk-heading">Modal heading</p>
