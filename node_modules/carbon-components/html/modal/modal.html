...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-jy2ycf36i0p">Show
  modal</button>

<div data-modal id="modal-jy2ycf36i0p" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-jy2ycf36i0p-label" aria-describedby="modal-jy2ycf36i0p-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jy2ycf36i0p-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jy2ycf36i0p-heading">Modal heading</p>
