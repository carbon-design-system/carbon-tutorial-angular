...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-449g9j8xi1f">Show
  modal</button>

<div data-modal id="modal-449g9j8xi1f" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-449g9j8xi1f-label" aria-describedby="modal-449g9j8xi1f-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-449g9j8xi1f-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-449g9j8xi1f-heading">Modal heading</p>
