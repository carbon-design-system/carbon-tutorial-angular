...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-wlfrbgah34r">Show
  modal</button>

<div data-modal id="modal-wlfrbgah34r" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-wlfrbgah34r-label" aria-describedby="modal-wlfrbgah34r-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-wlfrbgah34r-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-wlfrbgah34r-heading">Modal heading</p>
