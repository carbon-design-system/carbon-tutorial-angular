...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-bxneb3h4xg">Show
  modal</button>

<div data-modal id="modal-bxneb3h4xg" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-bxneb3h4xg-label" aria-describedby="modal-bxneb3h4xg-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-bxneb3h4xg-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-bxneb3h4xg-heading">Modal heading</p>
