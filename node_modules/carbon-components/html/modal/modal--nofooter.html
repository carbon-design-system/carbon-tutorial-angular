...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-vs3xjy6vq4o">Show
  modal</button>

<div data-modal id="modal-vs3xjy6vq4o" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-vs3xjy6vq4o-label" aria-describedby="modal-vs3xjy6vq4o-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-vs3xjy6vq4o-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-vs3xjy6vq4o-heading">Modal heading</p>
