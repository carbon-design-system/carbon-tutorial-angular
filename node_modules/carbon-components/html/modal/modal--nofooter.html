...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-lw5cx8zeuab">Show
  modal</button>

<div data-modal id="modal-lw5cx8zeuab" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-lw5cx8zeuab-label" aria-describedby="modal-lw5cx8zeuab-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-lw5cx8zeuab-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-lw5cx8zeuab-heading">Modal heading</p>
