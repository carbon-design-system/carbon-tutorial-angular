...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-nlsttrs5pir">Show
  modal</button>

<div data-modal id="modal-nlsttrs5pir" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-nlsttrs5pir-label" aria-describedby="modal-nlsttrs5pir-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nlsttrs5pir-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nlsttrs5pir-heading">Modal heading</p>
