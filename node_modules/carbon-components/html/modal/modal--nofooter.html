...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-c2ty9hq3mg">Show
  modal</button>

<div data-modal id="modal-c2ty9hq3mg" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-c2ty9hq3mg-label" aria-describedby="modal-c2ty9hq3mg-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-c2ty9hq3mg-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-c2ty9hq3mg-heading">Modal heading</p>
