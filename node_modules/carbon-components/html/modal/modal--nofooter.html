...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-e3hm2a3mnuo">Show
  modal</button>

<div data-modal id="modal-e3hm2a3mnuo" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-e3hm2a3mnuo-label" aria-describedby="modal-e3hm2a3mnuo-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-e3hm2a3mnuo-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-e3hm2a3mnuo-heading">Modal heading</p>
