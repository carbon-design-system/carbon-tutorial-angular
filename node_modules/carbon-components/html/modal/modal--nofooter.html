...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-akp1kd3xrj">Show
  modal</button>

<div data-modal id="modal-akp1kd3xrj" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-akp1kd3xrj-label" aria-describedby="modal-akp1kd3xrj-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-akp1kd3xrj-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-akp1kd3xrj-heading">Modal heading</p>
