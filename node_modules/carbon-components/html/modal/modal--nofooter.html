...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-qg8fcfiatcg">Show
  modal</button>

<div data-modal id="modal-qg8fcfiatcg" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-qg8fcfiatcg-label" aria-describedby="modal-qg8fcfiatcg-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-qg8fcfiatcg-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-qg8fcfiatcg-heading">Modal heading</p>
