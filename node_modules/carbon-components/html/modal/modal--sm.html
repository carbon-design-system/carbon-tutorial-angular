...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-tgktlrxo26s">Show
  modal</button>

<div data-modal id="modal-tgktlrxo26s" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-tgktlrxo26s-label" aria-describedby="modal-tgktlrxo26s-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-tgktlrxo26s-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-tgktlrxo26s-heading">Modal heading</p>
