...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-34uvf8nqcgr">Show
  modal</button>

<div data-modal id="modal-34uvf8nqcgr" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-34uvf8nqcgr-label" aria-describedby="modal-34uvf8nqcgr-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-34uvf8nqcgr-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-34uvf8nqcgr-heading">Modal heading</p>
