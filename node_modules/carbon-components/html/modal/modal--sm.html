...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-nc09sfbezdm">Show
  modal</button>

<div data-modal id="modal-nc09sfbezdm" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-nc09sfbezdm-label" aria-describedby="modal-nc09sfbezdm-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nc09sfbezdm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nc09sfbezdm-heading">Modal heading</p>
