...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-804x5soms3k">Show
  modal</button>

<div data-modal id="modal-804x5soms3k" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-804x5soms3k-label" aria-describedby="modal-804x5soms3k-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-804x5soms3k-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-804x5soms3k-heading">Modal heading</p>
