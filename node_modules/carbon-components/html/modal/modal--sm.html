...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-xmexbf9ipmd">Show
  modal</button>

<div data-modal id="modal-xmexbf9ipmd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-xmexbf9ipmd-label" aria-describedby="modal-xmexbf9ipmd-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-xmexbf9ipmd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-xmexbf9ipmd-heading">Modal heading</p>
