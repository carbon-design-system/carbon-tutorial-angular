...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-0cqagvf4yhi">Show
  modal</button>

<div data-modal id="modal-0cqagvf4yhi" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-0cqagvf4yhi-label" aria-describedby="modal-0cqagvf4yhi-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-0cqagvf4yhi-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-0cqagvf4yhi-heading">Modal heading</p>
