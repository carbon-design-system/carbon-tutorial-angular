...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-mamd387i6wp">Show
  modal</button>

<div data-modal id="modal-mamd387i6wp" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-mamd387i6wp-label" aria-describedby="modal-mamd387i6wp-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mamd387i6wp-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mamd387i6wp-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
