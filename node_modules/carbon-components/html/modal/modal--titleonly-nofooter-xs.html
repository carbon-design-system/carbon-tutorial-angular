...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-93tos2w671b">Show
  modal</button>

<div data-modal id="modal-93tos2w671b" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-93tos2w671b-label" aria-describedby="modal-93tos2w671b-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-93tos2w671b-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-93tos2w671b-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
