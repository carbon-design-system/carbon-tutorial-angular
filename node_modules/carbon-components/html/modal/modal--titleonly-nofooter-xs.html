...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-vrzkn4xna1f">Show
  modal</button>

<div data-modal id="modal-vrzkn4xna1f" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-vrzkn4xna1f-label" aria-describedby="modal-vrzkn4xna1f-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-vrzkn4xna1f-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-vrzkn4xna1f-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
