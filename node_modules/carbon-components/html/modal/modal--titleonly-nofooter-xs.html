...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-cl1mlcp6xwn">Show
  modal</button>

<div data-modal id="modal-cl1mlcp6xwn" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-cl1mlcp6xwn-label" aria-describedby="modal-cl1mlcp6xwn-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-cl1mlcp6xwn-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-cl1mlcp6xwn-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
