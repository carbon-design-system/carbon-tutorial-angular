...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-xrbppb5igln">Show
  modal</button>

<div data-modal id="modal-xrbppb5igln" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-xrbppb5igln-label" aria-describedby="modal-xrbppb5igln-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-xrbppb5igln-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-xrbppb5igln-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
