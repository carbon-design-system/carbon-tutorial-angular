...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-6hzvl2q1hn">Show
  modal</button>

<div data-modal id="modal-6hzvl2q1hn" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-6hzvl2q1hn-label" aria-describedby="modal-6hzvl2q1hn-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-6hzvl2q1hn-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-6hzvl2q1hn-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
