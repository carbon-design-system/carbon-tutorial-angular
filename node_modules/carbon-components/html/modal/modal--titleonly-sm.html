...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-a3znbtz09e">Show
  modal</button>

<div data-modal id="modal-a3znbtz09e" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-a3znbtz09e-label" aria-describedby="modal-a3znbtz09e-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-a3znbtz09e-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-a3znbtz09e-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
