...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-yjf7koasw6n">Show
  modal</button>

<div data-modal id="modal-yjf7koasw6n" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-yjf7koasw6n-label" aria-describedby="modal-yjf7koasw6n-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-yjf7koasw6n-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-yjf7koasw6n-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
