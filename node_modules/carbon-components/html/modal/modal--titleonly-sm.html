...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-2ft1bgtox5o">Show
  modal</button>

<div data-modal id="modal-2ft1bgtox5o" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-2ft1bgtox5o-label" aria-describedby="modal-2ft1bgtox5o-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-2ft1bgtox5o-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-2ft1bgtox5o-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
