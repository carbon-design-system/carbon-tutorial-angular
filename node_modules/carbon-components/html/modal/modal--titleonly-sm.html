...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-82h3gr3cy2n">Show
  modal</button>

<div data-modal id="modal-82h3gr3cy2n" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-82h3gr3cy2n-label" aria-describedby="modal-82h3gr3cy2n-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-82h3gr3cy2n-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-82h3gr3cy2n-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
