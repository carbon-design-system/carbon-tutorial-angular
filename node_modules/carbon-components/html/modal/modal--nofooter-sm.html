...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rwvotq82x9e">Show
  modal</button>

<div data-modal id="modal-rwvotq82x9e" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rwvotq82x9e-label" aria-describedby="modal-rwvotq82x9e-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rwvotq82x9e-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rwvotq82x9e-heading">Modal heading</p>
