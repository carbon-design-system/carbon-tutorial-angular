...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-iw1fpll02ts">Show
  modal</button>

<div data-modal id="modal-iw1fpll02ts" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-iw1fpll02ts-label" aria-describedby="modal-iw1fpll02ts-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-iw1fpll02ts-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-iw1fpll02ts-heading">Modal heading</p>
