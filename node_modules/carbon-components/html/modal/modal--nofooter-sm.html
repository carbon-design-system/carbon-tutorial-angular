...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-uco1klbj7o">Show
  modal</button>

<div data-modal id="modal-uco1klbj7o" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-uco1klbj7o-label" aria-describedby="modal-uco1klbj7o-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-uco1klbj7o-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-uco1klbj7o-heading">Modal heading</p>
