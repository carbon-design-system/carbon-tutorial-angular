...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-9fos6wq6sf">Show
  modal</button>

<div data-modal id="modal-9fos6wq6sf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-9fos6wq6sf-label" aria-describedby="modal-9fos6wq6sf-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-9fos6wq6sf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-9fos6wq6sf-heading">Modal heading</p>
