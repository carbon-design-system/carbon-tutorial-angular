...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-qnxgfeles7h">Show
  modal</button>

<div data-modal id="modal-qnxgfeles7h" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-qnxgfeles7h-label" aria-describedby="modal-qnxgfeles7h-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-qnxgfeles7h-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-qnxgfeles7h-heading">Modal heading</p>
