...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-2g3ho45jptu">Show
  modal</button>

<div data-modal id="modal-2g3ho45jptu" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-2g3ho45jptu-label" aria-describedby="modal-2g3ho45jptu-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-2g3ho45jptu-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-2g3ho45jptu-heading">Modal heading</p>
