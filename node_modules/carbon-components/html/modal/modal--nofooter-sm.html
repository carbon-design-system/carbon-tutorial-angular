...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ywecawfc9g">Show
  modal</button>

<div data-modal id="modal-ywecawfc9g" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ywecawfc9g-label" aria-describedby="modal-ywecawfc9g-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ywecawfc9g-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ywecawfc9g-heading">Modal heading</p>
