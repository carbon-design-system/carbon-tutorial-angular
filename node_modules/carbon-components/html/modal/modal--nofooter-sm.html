...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-t5kzawv914s">Show
  modal</button>

<div data-modal id="modal-t5kzawv914s" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-t5kzawv914s-label" aria-describedby="modal-t5kzawv914s-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-t5kzawv914s-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-t5kzawv914s-heading">Modal heading</p>
