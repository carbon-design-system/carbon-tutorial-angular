...
<header class="bx--header" role="banner" aria-label="IBM Platform Name" data-header>
  ...
  <button class="bx--header__menu-trigger bx--header__action" aria-label="Open menu" title="Open menu"
    ...
    data-navigation-menu-target="#navigation-menu-aaqr0uj2l">
  ...
  <div class="bx--header__global">
    <button class="bx--header__menu-trigger bx--header__action" aria-label="Action 1"
      ...
      data-navigation-menu-panel-label-collapse="Close menu" data-product-switcher-target="#switcher-g1bnk2iqmxd">
...
<aside class="bx--panel--overlay" id="switcher-g1bnk2iqmxd" data-product-switcher>
...
<div class="bx--navigation" id="navigation-menu-aaqr0uj2l"
