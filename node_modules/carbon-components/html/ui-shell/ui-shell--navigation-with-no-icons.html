...
<header class="bx--header" role="banner" aria-label="IBM Platform Name" data-header>
  ...
  <button class="bx--header__menu-trigger bx--header__action" aria-label="Open menu" title="Open menu"
    ...
    data-navigation-menu-target="#navigation-menu-b1ja4pfmk8a">
  ...
  <div class="bx--header__global">
    <button class="bx--header__menu-trigger bx--header__action" aria-label="Action 1"
      ...
      data-navigation-menu-panel-label-collapse="Close menu" data-product-switcher-target="#switcher-ousjmysm85c">
...
<aside class="bx--panel--overlay" id="switcher-ousjmysm85c" data-product-switcher>
...
<div class="bx--navigation" id="navigation-menu-b1ja4pfmk8a"
