...
.bx--toggle:active + .bx--toggle__label .bx--toggle__appearance:before {
  -webkit-box-shadow: 0 0 0 1px #ffffff, 0 0 0 3px #0062ff;
          box-shadow: 0 0 0 1px #ffffff, 0 0 0 3px #0062ff;
}
...
.bx--tooltip:focus {
  -webkit-box-shadow: inset 0 0 0 1px #3d3d3d, inset 0 0 0 2px #ffffff;
          box-shadow: inset 0 0 0 1px #3d3d3d, inset 0 0 0 2px #ffffff;
  outline: 0;
}
...
.bx--tooltip .bx--tooltip__caret {
  ...
  border-bottom: 0.42969rem solid #3d3d3d;
  position: absolute;
  left: 0;
